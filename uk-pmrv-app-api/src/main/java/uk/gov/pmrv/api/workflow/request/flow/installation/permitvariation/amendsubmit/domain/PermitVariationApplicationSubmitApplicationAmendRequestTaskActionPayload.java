...
@AllArgsConstructor
@SuperBuilder
public class PermitVariationApplicationSubmitApplicationAmendRequestTaskActionPayload extends RequestTaskActionPayload {

    /**
     * When the operator re-submits the amended permit application, permitSectionsCompleted map
