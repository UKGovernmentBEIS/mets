...
@Service
public class WithholdingOfAllowancesWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return WithholdingOfAllowancesApplicationPeerReviewRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.WITHHOLDING_OF_ALLOWANCES_WAIT_FOR_PEER_REVIEW_PAYLOAD)
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.WITHHOLDING_OF_ALLOWANCES_WAIT_FOR_PEER_REVIEW);
    }
}
