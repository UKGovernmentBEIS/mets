...
public class WithholdingOfAllowancesPeerDecisionActionHandler implements
    ...
    public void process(final Long requestTaskId,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                RequestActionPayloadType.WITHHOLDING_OF_ALLOWANCES_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        final RequestActionType type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            RequestActionType.WITHHOLDING_OF_ALLOWANCES_APPLICATION_PEER_REVIEWER_ACCEPTED :
            RequestActionType.WITHHOLDING_OF_ALLOWANCES_APPLICATION_PEER_REVIEWER_REJECTED;
