package uk.gov.pmrv.api.mireport.system.installation.userreportentry;
...
@Service
public class InstallationUserReportEntryGeneratorHandler extends UserReportEntryGeneratorHandler
        implements InstallationMiReportGeneratorHandler<EmptyMiReportSystemParams> {

    public InstallationUserReportEntryGeneratorHandler(UserAuthService userAuthService, UserReportEntryRepository userReportEntryRepository, AuthorityRepository authorityRepository) {
    ...
    public MiReportSystemResult generateMiReport(EntityManager entityManager, EmptyMiReportSystemParams reportParams) {
        List<UserReportEntry> payload = generate(entityManager, AccountType.INSTALLATION);
