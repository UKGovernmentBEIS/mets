...
@Log4j2
public class RequestNoteMigrationService extends MigrationBaseService {
    ...
    public RequestNoteMigrationService(@Nullable @Qualifier("migrationJdbcTemplate") JdbcTemplate migrationJdbcTemplate,
