package uk.gov.pmrv.api.migration.permit.monitoringapproaches.calculationpfc.details;
...
public class PFCMonitoringApproachesDetailsMigrationService implements PermitSectionMigrationService<CalculationOfPFCMonitoringApproach> {

    private final JdbcTemplate migrationJdbcTemplate;

    public PFCMonitoringApproachesDetailsMigrationService(@Nullable @Qualifier("migrationJdbcTemplate") JdbcTemplate migrationJdbcTemplate) {
    ...
    public void populateSection(Map<String, Account> accountsToMigratePermit,
        ...
        sections.forEach((etsAccId, section) -> {
            ...
            CalculationOfPFCMonitoringApproach pfcMonitoringApproach =
    ...
    public Map<String, CalculationOfPFCMonitoringApproach> queryEtsSection(List<String> accountIds) {
        ...
        etsPFCMonitoringApproachDetailsMap.forEach((etsAccountId, etsPFCMonitoringApproachDetails) -> {
            ...
            pfcMonitoringApproaches.put(etsAccountId,
                    CalculationOfPFCMonitoringApproach.builder()
