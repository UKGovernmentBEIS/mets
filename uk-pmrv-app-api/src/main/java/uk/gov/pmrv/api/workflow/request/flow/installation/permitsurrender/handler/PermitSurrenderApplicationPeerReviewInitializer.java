...
@Service
public class PermitSurrenderApplicationPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        return PERMIT_SURRENDER_MAPPER.toApplicationReviewRequestTaskPayload(
            ...
            RequestTaskPayloadType.PERMIT_SURRENDER_APPLICATION_PEER_REVIEW_PAYLOAD
        );
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_SURRENDER_APPLICATION_PEER_REVIEW);
    }
}
