...
public class WasteQDRFirstReminderDateReachedHandlerFlowable implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        wasteQDRSendReminderNotificationService.sendFirstReminderNotification(requestId, expirationDate);
    }
}
