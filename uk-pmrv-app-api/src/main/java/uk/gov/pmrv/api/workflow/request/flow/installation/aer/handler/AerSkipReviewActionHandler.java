...
public class AerSkipReviewActionHandler implements RequestTaskActionHandler<AerApplicationSkipReviewRequestTaskActionPayload> {
    ...
    private final AerReviewService aerService;
    private final WorkflowService workflowService;

    @Override
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, AerApplicationSkipReviewRequestTaskActionPayload payload) {
        final RequestTask requestTask = requestTaskService.findTaskById(requestTaskId);

        // update request payload
        aerService.updateRequestPayloadWithSkipReviewOutcome(requestTask, payload, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.AER_SKIP_REVIEW);
    }
}
