...
@Service
public class NerAuthorityResponseRejectedRequestActionCustomMapper implements RequestActionCustomMapper {
    ...
    public RequestActionDTO toRequestActionDTO(final RequestAction requestAction) {
        ...
        final NerApplicationRejectedRequestActionPayload entityPayload =
            (NerApplicationRejectedRequestActionPayload) requestAction.getPayload();

        final RequestActionDTO requestActionDTO = REQUEST_ACTION_MAPPER.toRequestActionDTOIgnorePayload(requestAction);

        final NerApplicationRejectedRequestActionPayload dtoPayload =
            NER_MAPPER.toNerApplicationRejectedIgnoreComments(entityPayload);
    ...
    public RequestActionType getRequestActionType() {
        return RequestActionType.NER_APPLICATION_REJECTED;
    }
}
