...
public class N2OMonitoringApproachesMigrationService {
    ...
    private final N2OMonitoringApproachesEmissionPointCategoryMigrationService n2OMonitoringApproachesEmissionPointCategoryMigrationService;
    ...
    public void populateSection(Map<String, Account> accountsToMigratePermit,
        ...
        n2OMonitoringApproachesEmissionPointCategoryMigrationService.populateSection(accountsToMigratePermit, permits);
    }
}
