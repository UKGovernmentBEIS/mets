...
import uk.gov.pmrv.api.migration.permit.consolidationnumber.PermitConsolidationNumberMigrationService;
...
import uk.gov.pmrv.api.migration.permit.monitoringapproaches.calculationco2.CalculationMonitoringApproachesMigrationService;
import uk.gov.pmrv.api.migration.permit.monitoringapproaches.calculationpfc.PFCMonitoringApproachesMigrationService;
import uk.gov.pmrv.api.migration.permit.monitoringapproaches.fallback.FallbackMonitoringApproachesMigrationService;
import uk.gov.pmrv.api.migration.permit.monitoringapproaches.measurementco2.MeasMonitoringApproachesMigrationService;
import uk.gov.pmrv.api.migration.permit.monitoringapproaches.measurementn2o.N2OMonitoringApproachesMigrationService;
...
class PermitBuilderService {
    ...
    private final PermitConsolidationNumberMigrationService permitConsolidationNumberMigrationService;
    private final InstallationAccountToInstallationOperatorDetailsMapper installationOperatorDetailsMapper;

    public Map<Long, PermitMigrationContainer> buildPermits(List<String> etsAccountIds, List<String> failedEntries) {
        Map<String, Account> migratedAccountsToMigratePermit = findMigratedAccountsToMigratePermits(etsAccountIds,
            failedEntries);
        ...
        //emissions summaries migration should run after regulatedActivities, sourceStreams, emissionSources and
        // emissionPoints
        ...
        //populate permit consolidation number version
        permitConsolidationNumberMigrationService.populateConsolidationNumber(migratedAccountsToMigratePermit, permits);
    ...
    private Map<String, Account> findMigratedAccountsToMigratePermits(List<String> etsAccountIdsToMigrate,
