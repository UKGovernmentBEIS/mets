...
@Component
public class HSETIApplicationSubmitToRegulatorRequestTaskActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {

    private final RequestTaskService requestTaskService;
    private final HSETISubmitService hsetiSubmitService;
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, RequestTaskActionEmptyPayload payload) {
        ...
        hsetiSubmitService.submitToRegulator(requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.HSE_TI_SUBMIT_TO_REGULATOR);
    }
