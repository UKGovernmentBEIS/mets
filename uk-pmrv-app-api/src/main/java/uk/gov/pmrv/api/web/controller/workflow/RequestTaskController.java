...
public class RequestTaskController {
    ...
    public ResponseEntity<RequestTaskItemDTO> getTaskItemInfoById(@Parameter(hidden = true) PmrvUser pmrvUser,
    ...
    public ResponseEntity<Void> processRequestTaskAction(@Parameter(hidden = true) PmrvUser pmrvUser,
