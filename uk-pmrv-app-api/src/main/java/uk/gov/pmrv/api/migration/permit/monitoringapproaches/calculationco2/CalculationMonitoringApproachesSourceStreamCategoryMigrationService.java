...
import uk.gov.pmrv.api.permit.domain.monitoringapproaches.calculationco2.CalculationBiomassFractionStandardReferenceSource;
...
import uk.gov.pmrv.api.permit.domain.monitoringapproaches.calculationco2.CalculationCarbonContentStandardReferenceSource;
...
import uk.gov.pmrv.api.permit.domain.monitoringapproaches.calculationco2.CalculationConversionFactorStandardReferenceSource;
...
import uk.gov.pmrv.api.permit.domain.monitoringapproaches.calculationco2.CalculationOxidationFactorStandardReferenceSource;
...
public class CalculationMonitoringApproachesSourceStreamCategoryMigrationService implements PermitSectionMigrationService<CalculationOfCO2MonitoringApproach> {
    ...
    public void populateSection(final Map<String, Account> accountsToMigratePermit,
        ...
        final Map<String, CalculationOfCO2MonitoringApproach> sections = this.queryEtsSection(accountIds);
        ...
        sections.forEach((etsAccId, section) -> {
            ...
            final CalculationOfCO2MonitoringApproach calculationMonitoringApproach =
    ...
    @Override
    public Map<String, CalculationOfCO2MonitoringApproach> queryEtsSection(final List<String> accountIds) {
        ...
        final Map<String, CalculationOfCO2MonitoringApproach> calculationMonitoringApproaches = new HashMap<>();
        allCalculationSourceStreamCategories.forEach((etsAccountId, sourceStreams) -> {
            ...
            final CalculationOfCO2MonitoringApproach monitoringApproach = CalculationOfCO2MonitoringApproach.builder()
    ...
    private void replaceReferencesWithIds(final Map<String, CalculationOfCO2MonitoringApproach> sections,
                                          final Map<Long, PermitMigrationContainer> permits,
