...
public class AviationReportableEmissionsSendToRegistryProducer {

    private final String topicName;

    public AviationReportableEmissionsSendToRegistryProducer(
            @Value("${kafka.aviation.account-emissions-updated-request.topic}") String topicName) {
