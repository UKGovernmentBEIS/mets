...
public class PermitVariationReviewPeerDecisionActionHandler implements
    ...
    public void process(final Long requestTaskId, 
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                RequestActionPayloadType.PERMIT_VARIATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.PERMIT_VARIATION_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
