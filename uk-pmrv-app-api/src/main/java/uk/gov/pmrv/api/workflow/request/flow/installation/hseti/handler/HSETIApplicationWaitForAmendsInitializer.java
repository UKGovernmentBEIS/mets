...
public class HSETIApplicationWaitForAmendsInitializer implements InitializeRequestTaskHandler  {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return HSETI_MAPPER.toHSETIApplicationRegulatorReviewSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.HSE_TI_WAIT_FOR_AMENDS_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.HSE_TI_WAIT_FOR_AMENDS);
    }
}
