...
public class AlrGenerateAuthorityResponseOfficialNoticeHandlerFlowable implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        alrOfficialNoticeService.generateAndSaveAuthorityResponseOfficialNotice(requestId);
    }
}
