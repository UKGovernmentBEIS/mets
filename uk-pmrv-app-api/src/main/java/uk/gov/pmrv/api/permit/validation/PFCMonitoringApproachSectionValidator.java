...
public class PFCMonitoringApproachSectionValidator
    implements PermitSectionContextValidator<CalculationOfPFCMonitoringApproach>, PermitContextValidator, PermitGrantedContextValidator {
    ...
    public PermitValidationResult validate(final PermitContainer permitContainer) {
        ...
        if (monitoringApproaches.containsKey(MonitoringApproachType.CALCULATION_PFC)) {
            return validate((CalculationOfPFCMonitoringApproach) monitoringApproaches.get(MonitoringApproachType.CALCULATION_PFC),
                permitContainer);
        }
    ...
    @Override
    public PermitValidationResult validate(final CalculationOfPFCMonitoringApproach permitSection,
        ...
        List<PermitViolation> permitViolations = permitSection.getSourceStreamCategoryAppliedTiers().stream()
            .map(appliedTier -> Stream.of(
                ...
                return new PermitViolation(CalculationOfPFCMonitoringApproach.class.getSimpleName(),
                    p.getLeft(),
                    data);
