...
public class HSETIApplicationRegulatorReviewSubmitInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return HSE_TI_MAPPER.toHSETIApplicationRegulatorReviewSubmitRequestTaskPayload(
        		requestPayload,
                RequestTaskPayloadType.HSE_TI_APPLICATION_REGULATOR_REVIEW_SUBMIT_PAYLOAD
        );
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.HSE_TI_APPLICATION_REGULATOR_REVIEW_SUBMIT);
    }
}
