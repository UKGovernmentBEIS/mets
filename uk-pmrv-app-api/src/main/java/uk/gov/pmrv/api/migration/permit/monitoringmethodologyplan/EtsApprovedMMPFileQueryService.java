...
public class EtsApprovedMMPFileQueryService {
    ...
    public EtsApprovedMMPFileQueryService(@Nullable @Qualifier("migrationJdbcTemplate") JdbcTemplate migrationJdbcTemplate, EtsFileAttachmentRowMapper fileAttachmentRowMapper) {
