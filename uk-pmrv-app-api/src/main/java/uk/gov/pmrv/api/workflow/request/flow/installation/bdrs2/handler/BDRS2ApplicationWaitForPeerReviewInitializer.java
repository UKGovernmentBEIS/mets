...
public class BDRS2ApplicationWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return BDRS2_MAPPER.toBDRS2ApplicationRegulatorReviewSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.BDRS2_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.BDRS2_WAIT_FOR_PEER_REVIEW);
    }
}
