...
public class NERApplicationPeerReviewActionHandler implements RequestTaskActionHandler<PeerReviewRequestTaskActionPayload> {

    private final RequestTaskService requestTaskService;
    private final RequestService requestService;
    private final NerApplyService nerApplyService;
    private final NERRequestPeerReviewValidator nerRequestPeerReviewValidator;
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, PeerReviewRequestTaskActionPayload taskActionPayload) {
        ...
        nerRequestPeerReviewValidator.validate(requestTask, taskActionPayload, appUser);

        nerApplyService.requestPeerReview(requestTask, peerReviewer, appUser);
