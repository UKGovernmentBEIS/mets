...
@Component
public class PermitTransferBRequestRecallActionHandler extends RequestRecallActionHandler {

    public PermitTransferBRequestRecallActionHandler(RequestTaskService requestTaskService, RequestService requestService,
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.PERMIT_TRANSFER_B_RECALL_FROM_AMENDS);
    }

    @Override
    public RequestActionType getRequestActionType() {
        return RequestActionType.PERMIT_TRANSFER_B_RECALLED_FROM_AMENDS;
    }
}
