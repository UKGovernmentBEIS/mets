...
public class N2OMonitoringApproachesDetailsMigrationService implements PermitSectionMigrationService<MeasurementOfN2OMonitoringApproach> {

    private final JdbcTemplate migrationJdbcTemplate;

    public N2OMonitoringApproachesDetailsMigrationService(@Nullable @Qualifier("migrationJdbcTemplate") JdbcTemplate migrationJdbcTemplate) {
    ...
    public void populateSection(Map<String, Account> accountsToMigratePermit,
        ...
        Map<String, MeasurementOfN2OMonitoringApproach> sections = queryEtsSection(accountIds);
    ...
    @Override
    public Map<String, MeasurementOfN2OMonitoringApproach> queryEtsSection(List<String> accountIds) {
        ...
        Map<String, MeasurementOfN2OMonitoringApproach> n2oMonitoringApproaches = new HashMap<>();
        etsN2OMonitoringApproachDetailsMap.forEach((etsAccountId, etsN2OMonitoringApproachDetails) -> {
            ...
            n2oMonitoringApproaches.put(etsAccountId,
                    MeasurementOfN2OMonitoringApproach.builder()
