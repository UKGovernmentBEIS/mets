...
@Component
public class NERApplicationSubmitToVerifierActionHandler implements RequestTaskActionHandler<NERApplicationSubmitToVerifierRequestTaskActionPayload> {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.NER_APPLICATION_SUBMIT_TO_VERIFIER);
    }
}
