...
@Service
public class EmpIssuanceUkEtsDeemedWithdrawnOfficialLetterPreviewHandler
        extends EmpIssuanceOfficialLetterPreviewHandler {

    private final DocumentFileGeneratorService documentFileGeneratorService;

    public EmpIssuanceUkEtsDeemedWithdrawnOfficialLetterPreviewHandler(final RequestTaskService requestTaskService,
    ...
    public List<DocumentTemplateType> getTypes() {
        return List.of(DocumentTemplateType.EMP_ISSUANCE_UKETS_DEEMED_WITHDRAWN);
    }
