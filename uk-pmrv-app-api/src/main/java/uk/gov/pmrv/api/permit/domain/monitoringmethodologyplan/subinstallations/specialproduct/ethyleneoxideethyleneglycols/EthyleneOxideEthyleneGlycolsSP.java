...
@AllArgsConstructor
@NoArgsConstructor
public class EthyleneOxideEthyleneGlycolsSP extends SpecialProduct {

    @Builder.Default
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @Size(min =1, max = 6)
    private List<@Valid @NotNull EthyleneOxideEthyleneGlycolsDataSource> dataSources = new ArrayList<>();
