...
public class MigrationRegulatorUserService extends MigrationBaseService {
    ...
    private List<String> migrateUsers(List<EtsRegulatorUser> etsRegulatorUsers, ExecutionMode mode,
                                      List<String> failedEntries) {
        Map<CompetentAuthorityEnum, PmrvUser> invitersPerCA = new HashMap<>();
    ...
    private void migrateUser(EtsRegulatorUser etsRegulatorUser,
                             Map<CompetentAuthorityEnum, PmrvUser> invitersPerCA,
                             ExecutionMode mode,
                             List<String> failedEntries) {
    ...
    private PmrvUser resolveInviter(EtsRegulatorUser etsRegulatorUser, Map<CompetentAuthorityEnum, PmrvUser> invitersPerCA,
                                    List<String> failedEntries) {
        CompetentAuthorityEnum compAuth = MigrationHelper.resolveCompAuth(etsRegulatorUser.getCompAuth());
        if (compAuth == null) {
    ...
    private PmrvUser getMigrationProcessUser(CompetentAuthorityEnum compAuth) {
