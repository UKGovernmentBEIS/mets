...
public enum RequestActionPayloadType {
    ...
    INSTALLATION_REPORTABLE_EMISSIONS_SENT_TO_REGISTRY_PAYLOAD,
    ...
    PERMIT_ISSUANCE_REGISTRY_INTEGRATION_ACCOUNT_CREATED_PAYLOAD,
    ...
    NON_COMPLIANCE_DETAILS_AMENDED_PAYLOAD,
    
    NER_APPLICATION_SUBMITTED_PAYLOAD,
    NER_APPLICATION_VERIFICATION_SUBMITTED_PAYLOAD,
    ...
    NER_APPLICATION_AMENDS_SUBMITTED_PAYLOAD,
    NER_APPLICATION_COMPLETED_PAYLOAD,
    NER_APPLICATION_DEEM_WITHDRAWN_PAYLOAD,
    ...
    //hseti
    HSE_TI_APPLICATION_SUBMITTED_PAYLOAD,
    HSE_TI_REGULATOR_REVIEW_RETURNED_FOR_AMENDS_PAYLOAD,
    HSE_TI_APPLICATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD,
    HSE_TI_COMPLETED_PAYLOAD,
    ...
    BDRS2_APPLICATION_SUBMITTED_PAYLOAD,
    BDRS2_APPLICATION_VERIFICATION_SUBMITTED_PAYLOAD,
    BDRS2_VERIFICATION_RETURNED_TO_OPERATOR_PAYLOAD,
    BDRS2_APPLICATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD,
    BDRS2_REGULATOR_REVIEW_RETURNED_FOR_AMENDS_PAYLOAD,
    BDRS2_APPLICATION_AMENDS_SUBMITTED_PAYLOAD,
    BDRS2_APPLICATION_COMPLETED_PAYLOAD,
    ...
    ALR_REGULATOR_REVIEW_RETURNED_FOR_AMENDS_PAYLOAD,
    ALR_APPLICATION_PROCEEDED_TO_AUTHORITY_PAYLOAD,
    ALR_APPLICATION_CLOSED_PAYLOAD,
    ALR_APPLICATION_AMENDS_SUBMITTED_PAYLOAD,
    ALR_APPLICATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD,
    ALR_APPLICATION_ACCEPTED_PAYLOAD,
    ALR_APPLICATION_ACCEPTED_WITH_CORRECTIONS_PAYLOAD,
    ALR_APPLICATION_REJECTED_PAYLOAD,
    ALR_APPLICATION_MARK_NOT_REQUIRED_PAYLOAD,

    WASTE_QDR_APPLICATION_SUBMITTED_PAYLOAD,
    WASTE_QDR_APPLICATION_COMPLETED_PAYLOAD,
    WASTE_QDR_REGULATOR_REVIEW_RETURNED_FOR_AMENDS_PAYLOAD,
    WASTE_QDR_APPLICATION_AMENDS_SUBMITTED_PAYLOAD,


    //aviation related request action payload types
    ...
    NOTIFICATION_REGISTRY_INTEGRATION_PAYLOAD
}
