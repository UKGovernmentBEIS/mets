...
public class PermitTransferAUploadAttachmentService {
    ...
    public void uploadAttachment(final Long requestTaskId,
        ...
        final PermitTransferAApplicationRequestTaskPayload requestTaskPayload =
            (PermitTransferAApplicationRequestTaskPayload) requestTask.getPayload();

        requestTaskPayload.getTransferAttachments().put(UUID.fromString(attachmentUuid), filename);
    }
}
