...
public class EmpIssuanceCorsiaGrantedGenerateDocumentsService {

    private final RequestService requestService;

    private final EmpIssuanceCorsiaCreateEmpDocumentService empIssuanceCreateEmpDocumentService;
    ...
    public void generateDocuments(String requestId) {
        ...
        try {
            ...
            final EmissionsMonitoringPlanCorsiaDTO empDto = emissionsMonitoringPlanQueryService.getEmissionsMonitoringPlanCorsiaDTOByAccountId(request.getAccountId())
