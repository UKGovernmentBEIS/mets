...
public class HSETIApplicationWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return HSE_TI_MAPPER.toHSETIApplicationRegulatorReviewSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.HSE_TI_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.HSE_TI_WAIT_FOR_PEER_REVIEW);
    }
}
