...
public class NERRegulatorReviewSaveGroupDecisionActionHandler implements RequestTaskActionHandler<NERSaveRegulatorReviewGroupDecisionRequestTaskActionPayload> {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.NER_SAVE_REGULATOR_REVIEW_GROUP_DECISION);
    }
