...
public class AlrApplicationAddAcceptedRequestActionHandlerFlowable implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        alrAuthorityResponseService.addSubmittedRequestAction(requestId, RequestActionType.ALR_APPLICATION_ACCEPTED);
    }
}
