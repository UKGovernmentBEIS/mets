...
public class EmpVariationUkEtsApplicationPeerReviewRegulatorLedRequestTaskInitializer implements InitializeRequestTaskHandler {
	...
	public RequestTaskPayload initializePayload(Request request) {
        ...
        return MAPPER.toEmpVariationUkEtsApplicationSubmitRegulatorLedRequestTaskPayload(
                requestPayload, accountInfo, RequestTaskPayloadType.EMP_VARIATION_UKETS_APPLICATION_PEER_REVIEW_REGULATOR_LED_PAYLOAD
            );
	}

	@Override
	public Set<RequestTaskType> getRequestTaskTypes() {
		return Set.of(RequestTaskType.EMP_VARIATION_UKETS_REGULATOR_LED_APPLICATION_PEER_REVIEW);
	}
