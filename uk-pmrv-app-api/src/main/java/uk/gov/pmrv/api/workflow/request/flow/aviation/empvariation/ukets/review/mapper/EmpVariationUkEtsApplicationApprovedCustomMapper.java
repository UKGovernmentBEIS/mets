...
@Service
public class EmpVariationUkEtsApplicationApprovedCustomMapper implements RequestActionCustomMapper {
    ...
    public RequestActionDTO toRequestActionDTO(RequestAction requestAction) {
        EmpVariationUkEtsApplicationApprovedRequestActionPayload requestActionPayload =
            (EmpVariationUkEtsApplicationApprovedRequestActionPayload) requestAction.getPayload();
    ...
    public RequestActionType getRequestActionType() {
        return RequestActionType.EMP_VARIATION_UKETS_APPLICATION_APPROVED;
    }
