...
public interface ItemAssignedToMeService {
    ...
    ItemDTOResponse getItemsAssignedToMe(AppUser appUser, AccountType accountType, PagingRequest paging, ItemOrderBy orderBy, RequestType requestType, String accountSearchTerm);
