...
@Component
public class PermanentCessationApplySaveActionHandler
    implements RequestTaskActionHandler<PermanentCessationSaveApplicationRequestTaskActionPayload> {
    ...
    public void process(final Long requestTaskId,
                        ...
                        final PermanentCessationSaveApplicationRequestTaskActionPayload actionPayload) {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.PERMANENT_CESSATION_SAVE_APPLICATION);
    }
}
