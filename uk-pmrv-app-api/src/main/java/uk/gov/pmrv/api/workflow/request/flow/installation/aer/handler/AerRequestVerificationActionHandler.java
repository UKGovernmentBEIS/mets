...
@Component
public class AerRequestVerificationActionHandler implements RequestTaskActionHandler<AerApplicationRequestVerificationRequestTaskActionPayload> {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.AER_REQUEST_VERIFICATION);
    }
}