...
public class AviationDoECorsiaWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return DOE_MAPPER
                .toAviationDoECorsiaApplicationSubmitRequestTaskPayload(
                        requestPayload, RequestTaskPayloadType.AVIATION_DOE_CORSIA_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.AVIATION_DOE_CORSIA_WAIT_FOR_PEER_REVIEW);
    }
}
