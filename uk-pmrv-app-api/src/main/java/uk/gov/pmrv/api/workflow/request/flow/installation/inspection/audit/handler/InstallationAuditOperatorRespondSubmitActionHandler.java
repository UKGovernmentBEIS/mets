...
@Component
public class InstallationAuditOperatorRespondSubmitActionHandler
    ...
    public void process(final Long requestTaskId,
        ...
        installationAuditOperatorRespondService.applySubmitAction(requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.INSTALLATION_AUDIT_OPERATOR_RESPOND_SUBMIT);
    }
}
