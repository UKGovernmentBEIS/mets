...
public class InstallationPermitGrantedSendToRegistryProducerConfig {

    private final NetzKafkaProducerFactory<String, InstallationAccountCreatedRegistryDTO> netzKafkaProducerFactory;
    private final InstallationProducerConfigProperties installationProducerConfigProperties;

    @Bean
    KafkaTemplate<String, InstallationAccountCreatedRegistryDTO> installationAccountCreatedKafkaTemplate(
            KafkaCorrelationHeaderProducerInterceptor<String, InstallationAccountCreatedRegistryDTO> correlationHeaderInterceptor,
            KafkaCorrelationParentHeaderProducerInterceptor<String, InstallationAccountCreatedRegistryDTO> correlationParentHeaderInterceptor) {
