...
public class ReturnOfAllowancesPeerDecisionActionHandler implements
    ...
    public void process(final Long requestTaskId,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                RequestActionPayloadType.RETURN_OF_ALLOWANCES_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        final RequestActionType type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            RequestActionType.RETURN_OF_ALLOWANCES_APPLICATION_PEER_REVIEWER_ACCEPTED :
            RequestActionType.RETURN_OF_ALLOWANCES_APPLICATION_PEER_REVIEWER_REJECTED;
