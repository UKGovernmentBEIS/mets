...
import static uk.gov.pmrv.api.workflow.request.core.domain.enumeration.RequestTaskPayloadType.PERMIT_ISSUANCE_WAIT_FOR_REVIEW_PAYLOAD;


@Service
@RequiredArgsConstructor
public class PermitIssuanceWaitForReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        PermitIssuanceApplicationWaitForReviewRequestTaskPayload permitIssuanceApplicationReviewRequestTaskPayload =
                permitReviewMapper.toPermitIssuanceApplicationWaitForReviewRequestTaskPayload((PermitIssuanceRequestPayload) request.getPayload(),
                        PERMIT_ISSUANCE_WAIT_FOR_REVIEW_PAYLOAD);
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_ISSUANCE_WAIT_FOR_REVIEW);
    }
}