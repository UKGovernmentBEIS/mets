...
public class PermitTransferBWaitForAmendsInitializer implements InitializeRequestTaskHandler {
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_TRANSFER_B_WAIT_FOR_AMENDS);
    }
}
