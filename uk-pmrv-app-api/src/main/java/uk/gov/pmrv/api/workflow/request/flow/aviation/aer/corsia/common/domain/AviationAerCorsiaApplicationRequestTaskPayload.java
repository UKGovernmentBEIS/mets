...
@AllArgsConstructor
@SuperBuilder
public class AviationAerCorsiaApplicationRequestTaskPayload extends AviationAerApplicationRequestTaskPayload {
    ...
    public Set<UUID> getReferencedAttachmentIds() {
        ...
        final Set<UUID> attachments = new HashSet<>(super.getReferencedAttachmentIds());
