...
@AllArgsConstructor
@SuperBuilder
public class PermitIssuanceApplicationDeemedWithdrawnRequestActionPayload extends RequestActionPayload {
    ...
    @Valid
    @NotNull
    private PermitIssuanceDeemedWithdrawnDetermination determination;
