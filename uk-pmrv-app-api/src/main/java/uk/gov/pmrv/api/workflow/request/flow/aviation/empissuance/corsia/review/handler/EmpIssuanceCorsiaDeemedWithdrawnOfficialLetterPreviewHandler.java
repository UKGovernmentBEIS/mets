...
@Service
public class EmpIssuanceCorsiaDeemedWithdrawnOfficialLetterPreviewHandler
        extends EmpIssuanceOfficialLetterPreviewHandler {

    private final DocumentFileGeneratorService documentFileGeneratorService;

    public EmpIssuanceCorsiaDeemedWithdrawnOfficialLetterPreviewHandler(final RequestTaskService requestTaskService,
    ...
    public List<DocumentTemplateType> getTypes() {
        return List.of(DocumentTemplateType.EMP_ISSUANCE_CORSIA_DEEMED_WITHDRAWN);
    }

    @Override
    protected List<RequestTaskType> getTaskTypes() {
        return List.of(RequestTaskType.EMP_ISSUANCE_CORSIA_APPLICATION_REVIEW,
    ...
    protected String getOperatorNameFromRequestTaskPayload(RequestTaskPayload requestTaskPayload) {
        return ((EmpIssuanceCorsiaApplicationReviewRequestTaskPayload) (requestTaskPayload))
