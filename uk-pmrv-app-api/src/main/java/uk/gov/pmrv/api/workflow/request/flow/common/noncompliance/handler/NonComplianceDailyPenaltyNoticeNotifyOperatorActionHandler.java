...
public class NonComplianceDailyPenaltyNoticeNotifyOperatorActionHandler
    ...
    public void process(final Long requestTaskId,
        ...
        // validate
        validator.validateDailyPenalty(taskPayload);
        ...
        final NonComplianceDailyPenaltyNoticeApplicationSubmittedRequestActionPayload actionPayload =
            NON_COMPLIANCE_MAPPER.toDailyPenaltyNoticeSubmittedRequestAction(taskPayload, decisionNotification, usersInfo);
        ...
        // send email
        officialNoticeServiceDelegator.sendOfficialNotice(taskPayload.getDailyPenaltyNotice(), request, decisionNotification);
    }

    @Override
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_NOTIFY_OPERATOR);
    }
}
