...
@Component
public class ALRSubmitApplicationCloseActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {

    private final RequestTaskService requestTaskService;
    private final ALRCloseValidator alrCloseValidator;
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser,
        ...
        // Validate
        alrCloseValidator.validate(requestTask);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.ALR_CLOSE_APPLICATION);
    }
