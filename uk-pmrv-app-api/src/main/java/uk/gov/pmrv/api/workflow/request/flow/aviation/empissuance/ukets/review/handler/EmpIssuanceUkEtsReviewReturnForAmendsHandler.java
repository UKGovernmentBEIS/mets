...
public class EmpIssuanceUkEtsReviewReturnForAmendsHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {

	private final RequestTaskService requestTaskService;
    private final RequestService requestService;
    private final RequestEmpUkEtsReviewService requestEmpUkEtsReviewService;
    private final EmpIssuanceUkEtsReviewReturnForAmendsValidatorService empIssuanceUkEtsReviewReturnForAmendsValidatorService;
    private final WorkflowService workflowService;
    private static final EmpUkEtsReviewMapper empUkEtsReviewMapper = Mappers.getMapper(EmpUkEtsReviewMapper.class);
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, PmrvUser pmrvUser, RequestTaskActionEmptyPayload payload) {
        ...
        empIssuanceUkEtsReviewReturnForAmendsValidatorService.validate(
    ...
    private void createRequestAction(Request request, PmrvUser pmrvUser, EmpIssuanceUkEtsApplicationReviewRequestTaskPayload taskPayload) {
        EmpIssuanceUkEtsApplicationReturnedForAmendsRequestActionPayload requestActionPayload = empUkEtsReviewMapper
                .toEmpIssuanceUkEtsApplicationReturnedForAmendsRequestActionPayload(
                    taskPayload, 
                    RequestActionPayloadType.EMP_ISSUANCE_UKETS_APPLICATION_RETURNED_FOR_AMENDS_PAYLOAD
                );
