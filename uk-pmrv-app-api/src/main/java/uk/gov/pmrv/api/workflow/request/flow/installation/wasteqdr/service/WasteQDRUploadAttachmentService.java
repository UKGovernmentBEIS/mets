...
public class WasteQDRUploadAttachmentService {
    ...
    public void uploadAttachment(final Long requestTaskId,
        ...
        final WasteQDRApplicationSubmitRequestTaskPayload requestTaskPayload =
                (WasteQDRApplicationSubmitRequestTaskPayload) requestTask.getPayload();

        requestTaskPayload.getWasteQDRAttachments().put(UUID.fromString(attachmentUuid), filename);
    }
}
