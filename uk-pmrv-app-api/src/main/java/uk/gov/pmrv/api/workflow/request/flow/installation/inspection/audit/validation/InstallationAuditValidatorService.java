...
@Service
@Validated
public class InstallationAuditValidatorService extends InstallationInspectionValidatorService {
    ...
    public void validateInstallationInspection(@NotNull @Valid  InstallationInspection installationInspection) {
        ...
        if (installationInspection.getDetails().getOfficerNames().size() < 2) {
            throw new BusinessException(ErrorCode.FORM_VALIDATION);
        }
