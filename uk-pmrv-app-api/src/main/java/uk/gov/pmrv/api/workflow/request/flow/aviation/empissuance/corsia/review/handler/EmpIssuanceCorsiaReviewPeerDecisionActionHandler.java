...
public class EmpIssuanceCorsiaReviewPeerDecisionActionHandler
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType,
        ...
        PeerReviewDecisionSubmittedRequestActionPayload requestActionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                payload,
                RequestActionPayloadType.EMP_ISSUANCE_CORSIA_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        RequestActionType type = payload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            RequestActionType.EMP_ISSUANCE_CORSIA_APPLICATION_PEER_REVIEWER_ACCEPTED :
            RequestActionType.EMP_ISSUANCE_CORSIA_APPLICATION_PEER_REVIEWER_REJECTED;
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.EMP_ISSUANCE_CORSIA_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
