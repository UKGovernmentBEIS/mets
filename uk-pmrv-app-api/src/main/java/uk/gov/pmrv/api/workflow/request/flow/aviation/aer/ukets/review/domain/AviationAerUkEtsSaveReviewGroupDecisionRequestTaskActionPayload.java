...
@AllArgsConstructor
@SuperBuilder
public class AviationAerUkEtsSaveReviewGroupDecisionRequestTaskActionPayload extends RequestTaskActionPayload {

    @NotNull
    private AviationAerUkEtsReviewGroup group;
