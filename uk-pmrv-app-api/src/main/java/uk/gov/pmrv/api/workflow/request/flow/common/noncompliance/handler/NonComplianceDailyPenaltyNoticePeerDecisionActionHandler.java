...
public class NonComplianceDailyPenaltyNoticePeerDecisionActionHandler
    ...
    public void process(final Long requestTaskId,
        ...
        final RequestActionType type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            ...
            RequestActionType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_PEER_REVIEWER_REJECTED;
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_SUBMIT_PEER_REVIEW_DECISION);
    }
}
