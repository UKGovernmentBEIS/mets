...
@Service
public class PermitVariationPeerReviewPreviewPermitDocumentService extends PermitVariationPreviewPermitDocumentService implements PermitPreviewDocumentService  {
    public PermitVariationPeerReviewPreviewPermitDocumentService(RequestTaskService requestTaskService, PermitQueryService permitQueryService, DateService dateService, PermitVariationRequestQueryService permitVariationRequestQueryService, PermitPreviewCreatePermitDocumentService permitPreviewCreatePermitDocumentService) {
    ...
    public RequestTaskType getType() {
        return RequestTaskType.PERMIT_VARIATION_APPLICATION_PEER_REVIEW;
    }
}
