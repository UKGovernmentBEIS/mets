...
public class NonComplianceNoticeOfIntentNotifyOperatorActionHandler
    ...
    public void process(final Long requestTaskId,
        ...
        final NonComplianceNoticeOfIntentApplicationSubmittedRequestActionPayload actionPayload =
            NON_COMPLIANCE_MAPPER.toNoticeOfIntentSubmittedRequestAction(taskPayload, decisionNotification, usersInfo);
        ...
        // send email
        officialNoticeServiceDelegator.sendOfficialNotice(taskPayload.getNoticeOfIntent(), request, decisionNotification);
    }

    @Override
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_NOTIFY_OPERATOR);
    }
}
