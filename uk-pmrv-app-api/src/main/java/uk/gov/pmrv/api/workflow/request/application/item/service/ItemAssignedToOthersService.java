...
public interface ItemAssignedToOthersService {
    ...
    ItemDTOResponse getItemsAssignedToOthers(AppUser appUser, AccountType accountType, PagingRequest paging, ItemOrderBy orderBy, RequestType requestType, String accountSearchTerm);
