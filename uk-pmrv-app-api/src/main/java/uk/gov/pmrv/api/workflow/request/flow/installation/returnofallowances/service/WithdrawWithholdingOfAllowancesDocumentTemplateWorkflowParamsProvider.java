...
@Component
public class WithdrawWithholdingOfAllowancesDocumentTemplateWorkflowParamsProvider implements DocumentTemplateWorkflowParamsProvider<WithholdingOfAllowancesRequestPayload> {

    @Override
    public DocumentTemplateGenerationContextActionType getContextActionType() {
        return DocumentTemplateGenerationContextActionType.WITHHOLDING_OF_ALLOWANCES_WITHDRAWN;
    }
