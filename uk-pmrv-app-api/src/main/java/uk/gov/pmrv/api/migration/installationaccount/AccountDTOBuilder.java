...
class AccountDTOBuilder {
    ...
    public InstallationAccountDTO constructInstallationAccountDTO(Emitter emitter) {
        String accountId = emitter.getId();
        InstallationAccountDTO account = new InstallationAccountDTO();
        ...
        account.setApplicationType(ApplicationType.NEW_PERMIT);
        account.setSopId(emitter.getSopId());
        account.setApplicationType(emitter.isTransferee() ? ApplicationType.TRANSFER : ApplicationType.NEW_PERMIT);
        account.setTransferCode(emitter.getTransfereeCode());
