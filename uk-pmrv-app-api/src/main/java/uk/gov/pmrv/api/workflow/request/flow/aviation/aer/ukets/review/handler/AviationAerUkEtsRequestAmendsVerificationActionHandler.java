...
@Component
public class AviationAerUkEtsRequestAmendsVerificationActionHandler
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, PmrvUser pmrvUser,
        ...
        requestAviationAerUkEtsReviewService.sendAmendedAerToVerifier(taskActionPayload, requestTask, pmrvUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.AVIATION_AER_UKETS_REQUEST_AMENDS_VERIFICATION);
    }
}
