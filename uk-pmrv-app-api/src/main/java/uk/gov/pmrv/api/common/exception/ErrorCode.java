...
public enum ErrorCode {
    ...
    ACCOUNT_HOLDING_COMPANY_NOT_INITIALIZED("ACCOUNT1011", HttpStatus.BAD_REQUEST, "Account holding company is not initialized yet"),
    ...
    ACCOUNT_CONTACT_TYPE_PRIMARY_CONTACT_NOT_EMITTER_CONTACT("ACCOUNT_CONTACT1005", HttpStatus.BAD_REQUEST, "You cannot assign an Emitter Contact as primary contact on your account"),
    ACCOUNT_CONTACT_TYPE_SECONDARY_CONTACT_NOT_EMITTER_CONTACT("ACCOUNT_CONTACT1006", HttpStatus.BAD_REQUEST, "You cannot assign an Emitter Contact as secondary contact on your account"),
