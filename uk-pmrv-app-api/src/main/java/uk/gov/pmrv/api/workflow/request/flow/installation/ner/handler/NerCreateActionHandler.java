...
public class NerCreateActionHandler implements RequestAccountCreateActionHandler<RequestCreateActionEmptyPayload> {
    ...
    public String process(final Long accountId,
            ...
            processVars.put(BpmnProcessConstants.NER_INITIATION_TYPE, NERInitiationType.INITIATED);
            ...
            final RequestParams requestParams = RequestParams.builder()
                    ...
                    .requestPayload(NerRequestPayload.builder()
                            ...
                            .build())
                    .requestMetadata(NERRequestMetadata.builder()
                            .type(RequestMetadataType.NER)
                            .nerInitiationType(NERInitiationType.INITIATED)
                            .build())
