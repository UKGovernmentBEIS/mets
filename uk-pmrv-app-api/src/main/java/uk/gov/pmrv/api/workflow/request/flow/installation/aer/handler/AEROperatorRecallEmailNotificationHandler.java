...
@Component
public class AEROperatorRecallEmailNotificationHandler extends OperatorRecallEmailNotificationHandler {

    private static final String AER_APPLICATION_RECALLED_BY_OPERATOR = "AER APPLICATION RECALLED BY OPERATOR";

    public AEROperatorRecallEmailNotificationHandler(UserAuthService userAuthService, AccountQueryService accountQueryService,
    ...
    public String getType() {
        return AER_APPLICATION_RECALLED_BY_OPERATOR;
    }
