...
public class AviationAerCorsiaAnnualOffsetingApplicationPeerReviewInitializer
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.AVIATION_AER_CORSIA_ANNUAL_OFFSETTING_APPLICATION_PEER_REVIEW);
    }


    private RequestTaskPayloadType getRequestTaskPayloadType() {
        return RequestTaskPayloadType.AVIATION_AER_CORSIA_ANNUAL_OFFSETTING_PEER_REVIEW_PAYLOAD;
    }
}
