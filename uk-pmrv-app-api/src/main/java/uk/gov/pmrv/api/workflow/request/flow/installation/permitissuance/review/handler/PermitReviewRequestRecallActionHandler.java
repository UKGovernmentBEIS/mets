...
@Component
public class PermitReviewRequestRecallActionHandler extends RequestRecallActionHandler {

    public PermitReviewRequestRecallActionHandler(RequestTaskService requestTaskService, RequestService requestService,
    ...
    public RequestActionType getRequestActionType() {
        return RequestActionType.PERMIT_ISSUANCE_RECALLED_FROM_AMENDS;
    }
}
