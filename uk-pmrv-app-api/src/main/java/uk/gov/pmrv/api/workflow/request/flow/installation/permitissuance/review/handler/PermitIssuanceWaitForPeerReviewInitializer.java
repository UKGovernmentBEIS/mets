...
public class PermitIssuanceWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        PermitIssuanceApplicationReviewRequestTaskPayload permitIssuanceApplicationReviewRequestTaskPayload =
            PERMIT_REVIEW_MAPPER.toPermitIssuanceApplicationReviewRequestTaskPayload((PermitIssuanceRequestPayload) request.getPayload(),
                RequestTaskPayloadType.PERMIT_ISSUANCE_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_ISSUANCE_WAIT_FOR_PEER_REVIEW);
    }
}
