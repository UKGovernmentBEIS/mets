...
public class NonComplianceDailyPenaltyNoticeRequestPeerReviewActionHandler
    ...
    public void process(final Long requestTaskId,
        ...
        nonCompliancePeerReviewValidator.validateDailyPenaltyNoticePeerReview(
            taskPayload,
        ...
        final String context = requestTask.getRequest().getType() == RequestType.NON_COMPLIANCE ?
            ...
            RequestCustomContext.AVIATION_NON_COMPLIANCE_DAILY_PENALTY_NOTICE.getCode();
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_REQUEST_PEER_REVIEW);
    }
}
