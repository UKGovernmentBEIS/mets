...
@Component
public class BDRS2ApplicationSubmitToVerifierActionHandler implements RequestTaskActionHandler<BDRS2ApplicationSubmitToVerifierRequestTaskActionPayload> {
    ...
    public void process(Long requestTaskId,
                        ...
                        AppUser appUser,
                        BDRS2ApplicationSubmitToVerifierRequestTaskActionPayload payload) {
        final RequestTask requestTask = requestTaskService.findTaskById(requestTaskId);
        bdrs2SubmitService.submitToVerifier(payload, requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.BDRS2_SUBMIT_TO_VERIFIER);
    }
}
