...
public class InstallationAuditApplicationWaitForPeerReviewInitializer
        extends InstallationInspectionApplicationPeerReviewInitializer {

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.INSTALLATION_AUDIT_WAIT_FOR_PEER_REVIEW);
    }

    @Override
    protected RequestTaskPayloadType getRequestTaskPayloadType() {
        return RequestTaskPayloadType.INSTALLATION_AUDIT_WAIT_FOR_PEER_REVIEW_PAYLOAD;
    }
}
