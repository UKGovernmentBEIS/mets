...
public class AerVerificationReturnToOperatorActionHandler
    ...
    @Override
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, AerVerificationReturnToOperatorRequestTaskActionPayload payload) {
        ...
        requestService.addActionToRequest(request,
            actionPayload,
            RequestActionType.AER_VERIFICATION_RETURNED_TO_OPERATOR,
            appUser.getUserId());
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.AER_VERIFICATION_RETURN_TO_OPERATOR);
    }
}
