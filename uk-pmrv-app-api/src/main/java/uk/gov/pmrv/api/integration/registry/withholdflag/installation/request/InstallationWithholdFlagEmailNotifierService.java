...
public class InstallationWithholdFlagEmailNotifierService {
    ...
    public void registryIdNonExistenceNotifyRegulator(InstallationAccountDTO accountDTO) {
        ...
        EmailData<PmrvEmailNotificationTemplateData> emailData = EmailData.<PmrvEmailNotificationTemplateData>builder()
                .notificationTemplateData(PmrvEmailNotificationTemplateData.builder()
                        ...
                        .templateName(PmrvNotificationTemplateName.REGISTRY_INTEGRATION_WITHHOLD_FLAG_MISSING_REGISTRY_ID.getName())
