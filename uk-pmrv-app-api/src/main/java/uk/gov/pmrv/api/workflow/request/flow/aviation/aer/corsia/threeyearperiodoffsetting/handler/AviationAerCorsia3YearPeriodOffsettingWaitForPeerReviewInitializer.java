...
public class AviationAerCorsia3YearPeriodOffsettingWaitForPeerReviewInitializer
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return AER_AVIATION_CORSIA_3YEAR_PERIOD_OFFSETTING_MAPPER
                .toAviationAerCorsia3YearPeriodOffsettingApplicationSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.AVIATION_AER_CORSIA_3YEAR_PERIOD_OFFSETTING_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.AVIATION_AER_CORSIA_3YEAR_PERIOD_OFFSETTING_WAIT_FOR_PEER_REVIEW);
    }
}
