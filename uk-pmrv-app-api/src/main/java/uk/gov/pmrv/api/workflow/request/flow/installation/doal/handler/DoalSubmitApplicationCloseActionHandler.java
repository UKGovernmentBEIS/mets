...
@Component
public class DoalSubmitApplicationCloseActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {

    private final RequestTaskService requestTaskService;
    private final DoalCloseValidator doalCloseValidator;
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser,
        ...
        // Validate
        doalCloseValidator.validate(requestTask);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.DOAL_CLOSE_APPLICATION);
    }
}
