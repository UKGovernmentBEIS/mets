...
@NoArgsConstructor
@AllArgsConstructor
public class PermitVariationApplicationGrantedRequestActionPayload
		extends PermitVariationApplicationSubmittedRequestActionPayload {
	
	private PermitContainer originalPermitContainer;

	@Builder.Default
	private Map<PermitReviewGroup, PermitVariationReviewDecision> reviewGroupDecisions = new EnumMap<>(
			PermitReviewGroup.class);
    ...
    @NotNull
    private PermitVariationGrantDetermination determination;
