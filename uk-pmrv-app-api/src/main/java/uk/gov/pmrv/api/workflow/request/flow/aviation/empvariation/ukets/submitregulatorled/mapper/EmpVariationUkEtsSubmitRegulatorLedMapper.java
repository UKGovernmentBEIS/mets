...
public interface EmpVariationUkEtsSubmitRegulatorLedMapper extends EmpVariationUkEtsOperatorDetailsMapper {

	@Mapping(target = "payloadType", expression = "java(uk.gov.pmrv.api.workflow.request.core.domain.enumeration.RequestActionPayloadType.EMP_VARIATION_UKETS_APPLICATION_REGULATOR_LED_APPROVED_PAYLOAD)")
	...
	EmpVariationUkEtsApplicationRegulatorLedApprovedRequestActionPayload toEmpVariationApplicationRegulatorLedApprovedRequestActionPayload(
	...
	EmpVariationUkEtsApplicationRegulatorLedApprovedRequestActionPayload cloneRegulatorLedApprovedPayloadIgnoreDecisionNotes(
			EmpVariationUkEtsApplicationRegulatorLedApprovedRequestActionPayload payload);
    
    @Named("reviewGroupDecisionsWithoutNotes")
    default Map<EmpUkEtsReviewGroup, EmpAcceptedVariationDecisionDetails> setReviewGroupDecisionsWithoutNotes(
            Map<EmpUkEtsReviewGroup, EmpAcceptedVariationDecisionDetails> reviewGroupDecisions) {
    ...
    @Mapping(target = "reviewGroupDecisions", source = "requestPayload.reviewGroupDecisionsRegulatorLed")
    EmpVariationUkEtsApplicationSubmitRegulatorLedRequestTaskPayload toEmpVariationUkEtsApplicationSubmitRegulatorLedRequestTaskPayload(
            EmpVariationUkEtsRequestPayload requestPayload, RequestAviationAccountInfo accountInfo, 
