...
@Component
public class ALRApplicationSubmitToVerifierActionHandler implements RequestTaskActionHandler<ALRApplicationSubmitToVerifierRequestTaskActionPayload> {
    ...
    @Override
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, ALRApplicationSubmitToVerifierRequestTaskActionPayload payload) {
        final RequestTask requestTask = requestTaskService.findTaskById(requestTaskId);
        alrSubmitService.submitToVerifier(payload, requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.ALR_SUBMIT_TO_VERIFIER);
    }
}
