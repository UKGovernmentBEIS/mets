...
public class AviationMiReportGeneratorService implements MiReportGeneratorService, InitializingBean {
    ...
    private final List<AviationMiReportGeneratorHandler> aviationMiReportGeneratorHandlers;
    ...
    public MiReportResult generateReport(CompetentAuthorityEnum competentAuthority, MiReportParams reportParams) {
        return aviationMiReportGeneratorHandlers.stream()
    ...
    private boolean isReportTypeFound(MiReportType miReportType, AviationMiReportGeneratorHandler<MiReportParams> generator) {
