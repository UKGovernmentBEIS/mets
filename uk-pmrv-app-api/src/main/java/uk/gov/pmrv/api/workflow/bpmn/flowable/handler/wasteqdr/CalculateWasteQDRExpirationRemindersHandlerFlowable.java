...
public class CalculateWasteQDRExpirationRemindersHandlerFlowable implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        execution.setVariables(requestExpirationVarsBuilder.buildExpirationVars(RequestExpirationType.WASTEQDR, expirationDate));
    }
}
