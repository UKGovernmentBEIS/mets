...
public class PermitTransferBApplicationPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        return PERMIT_TRANSFER_MAPPER.toPermitTransferBApplicationReviewRequestTaskPayload(
            ...
            RequestTaskPayloadType.PERMIT_TRANSFER_B_APPLICATION_PEER_REVIEW_PAYLOAD
        );
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_TRANSFER_B_APPLICATION_PEER_REVIEW);
    }
}
