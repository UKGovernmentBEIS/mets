...
@Component
public class BDRApplicationSubmitToVerifierActionHandler  implements RequestTaskActionHandler<BDRApplicationSubmitToVerifierRequestTaskActionPayload> {
    ...
    public void process(Long requestTaskId,
                        ...
                        AppUser appUser,
                        BDRApplicationSubmitToVerifierRequestTaskActionPayload payload) {
        final RequestTask requestTask = requestTaskService.findTaskById(requestTaskId);
        bdrSubmitService.submitToVerifier(payload, requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.BDR_SUBMIT_TO_VERIFIER);
    }
}
