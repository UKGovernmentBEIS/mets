...
@SpELExpression(expression = "{(#samplingFrequency == 'OTHER') == (#samplingFrequencyOtherDetails != null)}", 
    message = "permit.measurementMonitoringApproach.tier.common.analysisMethod.samplingFrequencyOtherDetails")
@SpELExpression(expression = "{!#frequencyMeetsMinRequirements == (#reducedSamplingFrequencyJustification != null)}",
    message = "permit.measurementMonitoringApproach.tier.common.frequencyMeetsMinRequirements_false.reducedSamplingFrequencyJustification")
public class MeasurementAnalysisMethod {
    ...
    @NotNull
    private MeasurementSamplingFrequency samplingFrequency;
    ...
    @Valid
    @JsonUnwrapped
    private MeasurementLaboratory laboratory;
