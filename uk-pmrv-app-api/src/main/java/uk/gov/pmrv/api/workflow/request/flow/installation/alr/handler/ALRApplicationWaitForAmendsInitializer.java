...
public class ALRApplicationWaitForAmendsInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return ALR_MAPPER.toALRApplicationRegulatorReviewSubmitRequestTaskPayload(requestPayload,
                RequestTaskPayloadType.ALR_WAIT_FOR_AMENDS_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.ALR_WAIT_FOR_AMENDS);
    }
}
