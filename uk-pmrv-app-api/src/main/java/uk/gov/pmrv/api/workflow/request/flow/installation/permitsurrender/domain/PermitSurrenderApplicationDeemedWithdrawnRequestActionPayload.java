...
@AllArgsConstructor
@SuperBuilder
public class PermitSurrenderApplicationDeemedWithdrawnRequestActionPayload extends RequestActionPayload {
    
    @Valid
    @NotNull
    private PermitSurrenderReviewDeterminationDeemWithdraw reviewDetermination;
