...
public class NerApplicationAddAcceptedWithCorrectionsRequestActionService {
    ...
    public void acceptWithCorrections(final String requestId) {
        ...
        final NerApplicationAcceptedRequestActionPayload actionPayload =
            NER_MAPPER.toNerApplicationAccepted(requestPayload);
