...
@Service
public class EmpVariationCorsiaApprovedOfficialLetterPreviewHandler extends PreviewDocumentAbstractHandler {

    private final AviationPreviewOfficialNoticeService previewOfficialNoticeService;
    private final DocumentFileGeneratorService documentFileGeneratorService;
    private final EmissionsMonitoringPlanQueryService emissionsMonitoringPlanQueryService;
    
    public EmpVariationCorsiaApprovedOfficialLetterPreviewHandler(final RequestTaskService requestTaskService,
    ...
    public List<DocumentTemplateType> getTypes() {
        return List.of(DocumentTemplateType.EMP_VARIATION_CORSIA_ACCEPTED);
    }
    ...
    private Map<String, Object> constructParams(final EmpVariationCorsiaApplicationReviewRequestTaskPayload taskPayload,
        ...
        final TreeMap<EmpCorsiaReviewGroup, EmpVariationReviewDecision> sortedDecisions = 
