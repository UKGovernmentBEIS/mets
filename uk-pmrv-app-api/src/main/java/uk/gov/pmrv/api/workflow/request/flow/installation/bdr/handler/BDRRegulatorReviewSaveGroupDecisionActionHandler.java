...
public class BDRRegulatorReviewSaveGroupDecisionActionHandler
        implements RequestTaskActionHandler<BDRSaveRegulatorReviewGroupDecisionRequestTaskActionPayload> {
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser,
                        BDRSaveRegulatorReviewGroupDecisionRequestTaskActionPayload payload) {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.BDR_SAVE_REGULATOR_REVIEW_GROUP_DECISION);
    }
}
