...
@Component
public class BDRS2ApplicationSubmitToRegulatorActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {
    ...
    public void process(Long requestTaskId,
        ...
        bdrs2SubmitService.submitToRegulator(requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.BDRS2_SUBMIT_TO_REGULATOR);
    }
