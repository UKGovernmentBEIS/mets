...
public class BDRApplicationPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return BDR_MAPPER.toBDRApplicationRegulatorReviewSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.BDR_APPLICATION_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.BDR_APPLICATION_PEER_REVIEW);
    }
}
