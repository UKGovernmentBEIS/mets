...
public class AirReviewUploadAttachmentHandler extends RequestTaskUploadAttachmentActionHandler {

    private final AirReviewUploadAttachmentService service;
    ...
    public RequestTaskActionType getType() {
        return RequestTaskActionType.AIR_REVIEW_UPLOAD_ATTACHMENT;
    }
}
