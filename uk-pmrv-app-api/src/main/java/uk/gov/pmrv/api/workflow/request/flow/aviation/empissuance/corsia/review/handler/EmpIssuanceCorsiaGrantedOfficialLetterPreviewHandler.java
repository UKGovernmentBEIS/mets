...
@Service
public class EmpIssuanceCorsiaGrantedOfficialLetterPreviewHandler
        extends EmpIssuanceOfficialLetterPreviewHandler {

    private final DocumentFileGeneratorService documentFileGeneratorService;

    public EmpIssuanceCorsiaGrantedOfficialLetterPreviewHandler(final RequestTaskService requestTaskService,
    ...
    public List<DocumentTemplateType> getTypes() {
        return List.of(DocumentTemplateType.EMP_ISSUANCE_CORSIA_GRANTED);
    }
