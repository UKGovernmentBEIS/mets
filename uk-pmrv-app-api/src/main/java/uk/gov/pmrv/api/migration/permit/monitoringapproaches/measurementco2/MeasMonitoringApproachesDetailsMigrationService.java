...
public class MeasMonitoringApproachesDetailsMigrationService implements PermitSectionMigrationService<MeasurementOfCO2MonitoringApproach> {
    ...
    public void populateSection(Map<String, Account> accountsToMigratePermit, Map<Long, PermitMigrationContainer> permits) {
        ...
        Map<String, MeasurementOfCO2MonitoringApproach> sections = queryEtsSection(accountIds);
    ...
    @Override
    public Map<String, MeasurementOfCO2MonitoringApproach> queryEtsSection(List<String> accountIds) {
        ...
        Map<String, MeasurementOfCO2MonitoringApproach> measMonitoringApproaches = new HashMap<>();
        etsMeasMonitoringApproachDetailsMap.forEach((etsAccountId, etsMeasMonitoringApproachDetails) -> {
            ...
            measMonitoringApproaches.put(etsAccountId,
                    MeasurementOfCO2MonitoringApproach.builder()
