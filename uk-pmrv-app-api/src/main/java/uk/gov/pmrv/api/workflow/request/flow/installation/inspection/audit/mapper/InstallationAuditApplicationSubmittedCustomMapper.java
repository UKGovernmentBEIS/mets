...
@Service
public class InstallationAuditApplicationSubmittedCustomMapper implements RequestActionCustomMapper {
    ...
    public RequestActionDTO toRequestActionDTO(RequestAction requestAction) {
        ...
        entityPayload.setInspectionAttachments(
                ...
                !entityPayload
                        .getInstallationInspection().getDetails().getRegulatorExtraFiles().contains(entry.getKey()))
