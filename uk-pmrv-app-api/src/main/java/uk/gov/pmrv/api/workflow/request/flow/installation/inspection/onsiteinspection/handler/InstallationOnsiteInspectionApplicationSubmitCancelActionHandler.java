...
@Component
public class InstallationOnsiteInspectionApplicationSubmitCancelActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, RequestTaskActionEmptyPayload payload) {
        ...
        workflowService.completeTask(
                ...
                Map.of(BpmnProcessConstants.INSTALLATION_ONSITE_INSPECTION_SUBMIT_OUTCOME,
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.INSTALLATION_ONSITE_INSPECTION_CANCEL_APPLICATION);
    }
}
