...
@AllArgsConstructor
@SuperBuilder
public class HSETIApplicationAmendsSubmitRequestTaskActionPayload extends RequestTaskActionPayload {

    /**
     * When the operator re-submits the amended hseti application, hsetiSectionsCompleted map
