...
public class EmpVariationUkEtsPeerReviewDecisionRegulatorLedActionHandler implements RequestTaskActionHandler<PeerReviewDecisionRequestTaskActionPayload> {
	...
	public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                payload,
                RequestActionPayloadType.EMP_VARIATION_UKETS_PEER_REVIEW_DECISION_REGULATOR_LED_SUBMITTED_PAYLOAD
            );
	...
	public List<RequestTaskActionType> getTypes() {
		return List.of(RequestTaskActionType.EMP_VARIATION_UKETS_REVIEW_SUBMIT_PEER_REVIEW_DECISION_REGULATOR_LED);
	}
