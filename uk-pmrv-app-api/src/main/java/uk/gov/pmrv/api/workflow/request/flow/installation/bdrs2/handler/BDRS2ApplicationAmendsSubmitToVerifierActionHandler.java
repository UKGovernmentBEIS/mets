...
@Component
public class BDRS2ApplicationAmendsSubmitToVerifierActionHandler
        implements RequestTaskActionHandler<BDRS2ApplicationAmendsSubmitToVerifierRequestTaskActionPayload> {
    ...
    public void process(Long requestTaskId,
                        ...
                        AppUser appUser,
                        BDRS2ApplicationAmendsSubmitToVerifierRequestTaskActionPayload payload) {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.BDRS2_APPLICATION_AMENDS_SUBMIT_TO_VERIFIER);
    }
}
