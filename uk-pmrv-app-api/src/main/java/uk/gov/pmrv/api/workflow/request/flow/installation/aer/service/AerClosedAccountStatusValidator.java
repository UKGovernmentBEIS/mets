...
@Service
public class AerClosedAccountStatusValidator extends RequestCreateAerRelatedValidator {

    public AerClosedAccountStatusValidator(final RequestCreateValidatorService requestCreateValidatorService,
    ...
    protected Set<AccountStatus> getApplicableAccountStatuses() {
        return Set.of(InstallationAccountStatus.SURRENDERED,
