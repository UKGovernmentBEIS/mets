...
public class PermitVariationAddRegulatorLedApprovedRequestActionService {

	private final RequestService requestService;
    private final RequestActionUserInfoResolver requestActionUserInfoResolver;
    private final InstallationOperatorDetailsQueryService installationOperatorDetailsQueryService;
	private static final PermitVariationRegulatorLedMapper permitVariationRegulatorLedMapper = Mappers
	...
	public void add(final String requestId) {
		...
		final PermitVariationApplicationRegulatorLedApprovedRequestActionPayload actionPayload = permitVariationRegulatorLedMapper
				.toPermitVariationApplicationRegulatorLedApprovedRequestActionPayload(requestPayload);
		...
		requestService.addActionToRequest(request, 
				actionPayload, 
				RequestActionType.PERMIT_VARIATION_APPLICATION_REGULATOR_LED_APPROVED,
