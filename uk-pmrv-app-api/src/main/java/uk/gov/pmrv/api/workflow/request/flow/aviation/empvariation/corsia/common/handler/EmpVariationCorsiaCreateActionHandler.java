...
public class EmpVariationCorsiaCreateActionHandler implements RequestAccountCreateActionHandler<RequestCreateActionEmptyPayload> {
    ...
    public String process(Long accountId, RequestCreateActionEmptyPayload payload,
    	...
    	final EmissionsMonitoringPlanCorsiaContainer empContainer = 
    			empQueryService.getEmissionsMonitoringPlanCorsiaDTOByAccountId(accountId)
