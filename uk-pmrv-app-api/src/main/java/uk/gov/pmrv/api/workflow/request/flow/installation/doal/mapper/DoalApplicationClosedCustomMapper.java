...
@Service
public class DoalApplicationClosedCustomMapper implements RequestActionCustomMapper {
    ...
    public RequestActionDTO toRequestActionDTO(RequestAction requestAction) {
        ...
        final DoalApplicationClosedRequestActionPayload entityPayload =
            (DoalApplicationClosedRequestActionPayload) requestAction.getPayload();

        final RequestActionDTO requestActionDTO = REQUEST_ACTION_MAPPER.toRequestActionDTOIgnorePayload(requestAction);
        final DoalApplicationClosedRequestActionPayload dtoPayload =
    ...
    public RequestActionType getRequestActionType() {
        return RequestActionType.DOAL_APPLICATION_CLOSED;
    }
