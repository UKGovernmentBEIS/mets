...
@Service
public class InstallationAuditOfficialNoticeService extends InstallationInspectionOfficialNoticeService {

    private final String fileName = "INSTALLATION_AUDIT_notice.pdf";

    private final RequestService requestService;
    private final RequestAccountContactQueryService requestAccountContactQueryService;
    private final DecisionNotificationUsersService decisionNotificationUsersService;

    public InstallationAuditOfficialNoticeService(RequestService requestService,
    ...
    @Transactional
    public void generateInstallationAuditSubmittedOfficialNotice(String requestId) {
        ...
        final FileInfoDTO officialNotice = doGenerateOfficialNotice(request,
                ...
                ccRecipientsEmails,
                DocumentTemplateGenerationContextActionType.INSTALLATION_AUDIT_SUBMITTED,
