...
@AllArgsConstructor
@SuperBuilder
public class BDRApplicationAmendsSubmitRequestTaskActionPayload extends RequestTaskActionPayload {
        /**
     * When the operator re-submits the amended bdr application, bdrSectionsCompleted map
