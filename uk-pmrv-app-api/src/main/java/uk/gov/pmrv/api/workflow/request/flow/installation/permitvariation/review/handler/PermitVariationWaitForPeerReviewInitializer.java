...
public class PermitVariationWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        final PermitVariationApplicationReviewRequestTaskPayload taskPayload =
            PERMIT_VARIATION_MAPPER.toPermitVariationApplicationReviewRequestTaskPayload(
                requestPayload, RequestTaskPayloadType.PERMIT_VARIATION_WAIT_FOR_PEER_REVIEW_PAYLOAD
            );
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_VARIATION_WAIT_FOR_PEER_REVIEW);
    }
}
