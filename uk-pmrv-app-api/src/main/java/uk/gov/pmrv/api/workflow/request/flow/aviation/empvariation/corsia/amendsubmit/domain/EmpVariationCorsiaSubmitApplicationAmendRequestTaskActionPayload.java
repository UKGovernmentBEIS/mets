...
@AllArgsConstructor
@SuperBuilder
public class EmpVariationCorsiaSubmitApplicationAmendRequestTaskActionPayload extends RequestTaskActionPayload {

	/**
     * When the operator re-submits the amended emp application, empSectionsCompleted map
