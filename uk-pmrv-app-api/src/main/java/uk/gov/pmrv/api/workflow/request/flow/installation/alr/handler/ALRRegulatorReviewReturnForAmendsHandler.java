...
public class ALRRegulatorReviewReturnForAmendsHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.ALR_REGULATOR_REVIEW_RETURN_FOR_AMENDS);
    }
}
