...
public class AerApplicationWaitForAmendsInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return aerMapper.toAerApplicationReviewRequestTaskPayload(aerRequestPayload,
            ...
            RequestTaskPayloadType.AER_WAIT_FOR_AMENDS_PAYLOAD, aerRequestMetadata.getYear());
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.AER_WAIT_FOR_AMENDS);
    }
}
