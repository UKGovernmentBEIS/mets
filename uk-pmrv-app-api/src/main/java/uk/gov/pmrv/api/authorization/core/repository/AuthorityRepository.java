...
public interface AuthorityRepository extends JpaRepository<Authority, Long>, AuthorityCustomRepository {
    ...
    @Query(name= Authority.NAMED_QUERY_FIND_USERS_BY_CA_ASSIGNED_WITH_PMRV_SUPER_USER_ROLE_PERMISSIONS)
    List<Authority> findByCompetentAuthorityAndPmrvSuperUserRolePermissions(CompetentAuthorityEnum competentAuthority);
