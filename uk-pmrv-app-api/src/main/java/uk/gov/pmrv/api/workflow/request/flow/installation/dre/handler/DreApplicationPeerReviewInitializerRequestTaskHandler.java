...
public class DreApplicationPeerReviewInitializerRequestTaskHandler implements InitializeRequestTaskHandler {
	...
	public RequestTaskPayload initializePayload(Request request) {
		...
		final DreApplicationSubmitRequestTaskPayload taskPayload = DRE_MAPPER.toDreApplicationSubmitRequestTaskPayload(
				requestPayload, RequestTaskPayloadType.DRE_APPLICATION_PEER_REVIEW_PAYLOAD);
		return taskPayload;
	}

	@Override
	public Set<RequestTaskType> getRequestTaskTypes() {
		return Set.of(RequestTaskType.DRE_APPLICATION_PEER_REVIEW);
	}
