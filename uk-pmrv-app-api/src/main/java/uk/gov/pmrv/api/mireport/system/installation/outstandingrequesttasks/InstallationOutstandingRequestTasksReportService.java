...
import uk.gov.pmrv.api.mireport.system.common.outstandingrequesttasks.RequestTaskTypeFilter;
...
public class InstallationOutstandingRequestTasksReportService implements OutstandingRequestTasksReportService {
    ...
    public Set<String> getRequestTaskTypesByRoleType(String roleType) {
        return getRequestTaskTypesByRoleTypeAndAccountType(roleType, AccountType.INSTALLATION)
                .stream()
                .map(Enum::name)
                .collect(Collectors.toSet());
    }
