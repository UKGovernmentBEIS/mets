...
public class ALRApplicationPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return ALR_MAPPER.toALRApplicationRegulatorReviewSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.ALR_APPLICATION_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.ALR_APPLICATION_PEER_REVIEW);
    }
