...
public class PermanentCessationApplicationWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return PERMANENT_CESSATION_MAPPER.toPermanentCessationApplicationSubmitRequestTaskPayload(requestPayload, RequestTaskPayloadType.PERMANENT_CESSATION_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {return Set.of(RequestTaskType.PERMANENT_CESSATION_WAIT_FOR_PEER_REVIEW);}
}
