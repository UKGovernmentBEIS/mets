...
public class PermitVariationGrantedGenerateDocumentsService {
	
	private final RequestService requestService;
	private final PermitService permitService;
	private final PermitQueryService permitQueryService;
	private final PermitVariationCreatePermitDocumentService permitVariationCreatePermitDocumentService;
	private final PermitVariationOfficialNoticeService permitVariationOfficialNoticeService;
	...
	public void generateDocuments(String requestId, boolean regulatorLed) {
		...
		try {
			permitDocumentFuture = permitVariationCreatePermitDocumentService.create(requestId);
			officialNoticeFuture = regulatorLed ? 
					permitVariationOfficialNoticeService.generateRegulatorLedApprovedOfficialNotice(requestId) :
                	permitVariationOfficialNoticeService.generateGrantedOfficialNotice(requestId);
