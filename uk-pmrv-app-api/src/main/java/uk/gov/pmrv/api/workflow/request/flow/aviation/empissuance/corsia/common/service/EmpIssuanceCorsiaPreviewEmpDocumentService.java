...
import uk.gov.pmrv.api.workflow.request.flow.aviation.empissuance.corsia.common.domain.EmpIssuanceCorsiaApplicationRequestTaskPayload;
...
@Service
public class EmpIssuanceCorsiaPreviewEmpDocumentService implements EmpPreviewDocumentService {
    ...
    public FileDTO create(final Long taskId, final DecisionNotification decisionNotification) {
        ...
        final EmpIssuanceCorsiaApplicationRequestTaskPayload taskPayload =
            (EmpIssuanceCorsiaApplicationRequestTaskPayload) requestTask.getPayload();
