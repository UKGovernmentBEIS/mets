...
public class PaymentSecondReminderDateReachedHandler implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        paymentSendReminderNotificationService.sendSecondReminderNotification(requestId, expirationDate);
    }
}
