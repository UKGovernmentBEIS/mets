...
@Service
public class EmpVariationCorsiaRegulatorLedPeerReviewPreviewEmpDocumentService extends EmpVariationCorsiaPreviewEmpDocumentService {

    public EmpVariationCorsiaRegulatorLedPeerReviewPreviewEmpDocumentService(RequestTaskService requestTaskService,
    ...
    public List<RequestTaskType> getTypes() {
        return List.of(RequestTaskType.EMP_VARIATION_CORSIA_REGULATOR_LED_APPLICATION_PEER_REVIEW);
    }
}
