...
public class WithholdingOfAllowancesWithdrawalUploadAttachmentService {
    ...
    public void uploadAttachment(final Long requestTaskId,
        ...
        final WithholdingOfAllowancesWithdrawalApplicationSubmitRequestTaskPayload requestTaskPayload =
            (WithholdingOfAllowancesWithdrawalApplicationSubmitRequestTaskPayload) requestTask.getPayload();
        requestTaskPayload.getWithholdingWithdrawalAttachments().put(UUID.fromString(attachmentUuid), filename);
    }
}
