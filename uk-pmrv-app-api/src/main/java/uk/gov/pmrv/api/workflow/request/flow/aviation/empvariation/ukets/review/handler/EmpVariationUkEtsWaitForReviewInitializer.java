...
public class EmpVariationUkEtsWaitForReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.EMP_VARIATION_UKETS_WAIT_FOR_REVIEW);
    }
}
