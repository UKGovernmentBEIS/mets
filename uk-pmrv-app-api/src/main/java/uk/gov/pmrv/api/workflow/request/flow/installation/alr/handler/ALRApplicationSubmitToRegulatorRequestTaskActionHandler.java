...
@Component
public class ALRApplicationSubmitToRegulatorRequestTaskActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, RequestTaskActionEmptyPayload payload) {
        ...
        alrSubmitService.submitToRegulator(requestTask, appUser);
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.ALR_SUBMIT_TO_REGULATOR);
    }
}
