...
@Service
public class DoalApplicationPeerReviewInitializerRequestTaskHandler implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return DOAL_MAPPER.toDoalApplicationSubmitRequestTaskPayload(
                requestPayload, RequestTaskPayloadType.DOAL_APPLICATION_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.DOAL_APPLICATION_PEER_REVIEW);
    }
}
