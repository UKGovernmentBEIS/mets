...
public class AviationDoECorsiaPeerReviewInitializer  implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return DOE_MAPPER
                .toAviationDoECorsiaApplicationSubmitRequestTaskPayload(
                        requestPayload, RequestTaskPayloadType.AVIATION_DOE_CORSIA_PEER_REVIEW_PAYLOAD);
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.AVIATION_DOE_CORSIA_APPLICATION_PEER_REVIEW);
    }
}
