...
public class PermitTransferBWaitForReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(final Request request) {
        ...
        return PERMIT_TRANSFER_MAPPER.toPermitTransferBWaitForReviewRequestTaskPayload(
                requestPayload,
    ...
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.PERMIT_TRANSFER_B_WAIT_FOR_REVIEW);
    }
}
