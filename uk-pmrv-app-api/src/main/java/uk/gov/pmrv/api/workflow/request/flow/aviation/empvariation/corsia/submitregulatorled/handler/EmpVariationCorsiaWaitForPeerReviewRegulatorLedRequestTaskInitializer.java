...
public class EmpVariationCorsiaWaitForPeerReviewRegulatorLedRequestTaskInitializer implements InitializeRequestTaskHandler {
	...
	public RequestTaskPayload initializePayload(final Request request) {
        ...
        return MAPPER.toEmpVariationCorsiaApplicationSubmitRegulatorLedRequestTaskPayload(
                requestPayload, accountInfo, RequestTaskPayloadType.EMP_VARIATION_CORSIA_WAIT_FOR_PEER_REVIEW_REGULATOR_LED_PAYLOAD
            );
	}

	@Override
	public Set<RequestTaskType> getRequestTaskTypes() {
		return Set.of(RequestTaskType.EMP_VARIATION_CORSIA_REGULATOR_LED_WAIT_FOR_PEER_REVIEW);
	}
