...
public class VirRespondSetTaskDueDateHandler implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        final LocalDate expirationDate = ((Date) execution
                .getVariable(BpmnProcessConstants.VIR_EXPIRATION_DATE)).toInstant()
                .atZone(ZoneId.systemDefault()).toLocalDate();

        requestTaskTimeManagementService.setDueDateToTasks(requestId, RequestExpirationType.VIR, expirationDate);
    }
}
