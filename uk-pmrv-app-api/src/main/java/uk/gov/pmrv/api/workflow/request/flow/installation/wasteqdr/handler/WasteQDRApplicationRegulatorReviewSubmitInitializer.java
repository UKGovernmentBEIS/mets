...
public class WasteQDRApplicationRegulatorReviewSubmitInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return WASTE_QDR_MAPPER.toWasteQDRApplicationRegulatorReviewSubmitRequestTaskPayload(
                requestPayload,
                RequestTaskPayloadType.WASTE_QDR_APPLICATION_REGULATOR_REVIEW_SUBMIT_PAYLOAD
        );
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.WASTE_QDR_APPLICATION_REGULATOR_REVIEW_SUBMIT);
    }
}
