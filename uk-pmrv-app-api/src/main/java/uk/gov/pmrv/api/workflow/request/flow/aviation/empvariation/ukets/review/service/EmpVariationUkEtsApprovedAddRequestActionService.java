...
public class EmpVariationUkEtsApprovedAddRequestActionService {
    ...
    public void addRequestAction(final String requestId) {
        ...
        EmpVariationUkEtsApplicationApprovedRequestActionPayload requestActionPayload =
        		EMP_VARIATION_MAPPER.toEmpVariationUkEtsApplicationApprovedRequestActionPayload(requestPayload, accountInfo,
        				usersInfo, RequestActionPayloadType.EMP_VARIATION_UKETS_APPLICATION_APPROVED_PAYLOAD);
