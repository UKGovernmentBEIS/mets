...
public class BDRS2ApplicationRegulatorReviewSubmitInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return BDRS2_MAPPER.toBDRS2ApplicationRegulatorReviewSubmitRequestTaskPayload(
                requestPayload,
                RequestTaskPayloadType.BDRS2_APPLICATION_REGULATOR_REVIEW_SUBMIT_PAYLOAD
        );
    }

    @Override
    public Set<RequestTaskType> getRequestTaskTypes() {
        return Set.of(RequestTaskType.BDRS2_APPLICATION_REGULATOR_REVIEW_SUBMIT);
    }
}
