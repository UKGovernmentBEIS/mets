...
public class PermitRevocationPeerDecisionActionHandler implements
    ...
    public void process(final Long requestTaskId,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                RequestActionPayloadType.PERMIT_REVOCATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        final RequestActionType type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            RequestActionType.PERMIT_REVOCATION_APPLICATION_PEER_REVIEWER_ACCEPTED :
            RequestActionType.PERMIT_REVOCATION_APPLICATION_PEER_REVIEWER_REJECTED;
