...
@Component
public class PermanentCessationApplicationSubmitCancelActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, RequestTaskActionEmptyPayload payload) {
        ...
        workflowService.completeTask(
                ...
                Map.of(BpmnProcessConstants.PERMANENT_CESSATION_SUBMIT_OUTCOME,
                        PermanentCessationSubmitOutcome.CANCELLED)
        );
    }

    @Override
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.PERMANENT_CESSATION_CANCEL_APPLICATION);
    }
}
