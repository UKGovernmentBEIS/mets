...
@Component
public class ALRApplicationAmendsSubmitToVerifierActionHandler implements RequestTaskActionHandler<ALRApplicationAmendsSubmitToVerifierRequestTaskActionPayload> {
    ...
    @Override
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, ALRApplicationAmendsSubmitToVerifierRequestTaskActionPayload payload) {
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.ALR_APPLICATION_AMENDS_SUBMIT_TO_VERIFIER);
    }
}
