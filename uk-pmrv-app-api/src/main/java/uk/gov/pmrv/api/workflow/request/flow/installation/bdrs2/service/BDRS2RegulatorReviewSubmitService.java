...
public class BDRS2RegulatorReviewSubmitService {
    ...
    private void incrementBdrs2FileVersionAndUpdateFile(UUID taskFile, BDRS2RequestPayload requestPayload) {
        ...
        if (!Objects.equals(requestFile, taskFile)) {
            ...
            requestPayload.getBdrs2().getBdrs2Files().setFile(taskFile);
        }
    }
}
