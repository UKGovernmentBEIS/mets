...
public class PermitTransferBReviewPeerDecisionActionHandler implements
    ...
    public void process(final Long requestTaskId,
        ...
        final PeerReviewDecisionSubmittedRequestActionPayload actionPayload =
            PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                taskActionPayload,
                RequestActionPayloadType.PERMIT_TRANSFER_B_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD
            );

        final RequestActionType type = actionPayload.getDecision().getType() == PeerReviewDecisionType.AGREE ?
            RequestActionType.PERMIT_TRANSFER_B_APPLICATION_PEER_REVIEWER_ACCEPTED :
            RequestActionType.PERMIT_TRANSFER_B_APPLICATION_PEER_REVIEWER_REJECTED;
    ...
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.PERMIT_TRANSFER_B_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
