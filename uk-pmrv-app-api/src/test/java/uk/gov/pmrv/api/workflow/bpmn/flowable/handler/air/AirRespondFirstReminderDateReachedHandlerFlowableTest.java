...
class AirRespondFirstReminderDateReachedHandlerFlowableTest {
    ...
    @InjectMocks
    private AirRespondFirstReminderDateReachedHandlerFlowable handler;

    @Test
    void execute_callsSendRespondFirstReminderNotification() {
        ...
        verify(service).sendRespondFirstReminderNotification(requestId, expirationDate);
    }
}
