...
import uk.gov.pmrv.api.workflow.request.flow.installation.permitissuance.review.handler.PermitIssuanceWaitForPeerReviewInitializer;

import static org.assertj.core.api.Assertions.assertThat;

@ExtendWith(MockitoExtension.class)
class PermitIssuanceWaitForPeerReviewInitializerTest {

    @InjectMocks
    private PermitIssuanceWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.PERMIT_ISSUANCE_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
            .containsExactly(RequestTaskType.PERMIT_ISSUANCE_WAIT_FOR_PEER_REVIEW);
    }
}
