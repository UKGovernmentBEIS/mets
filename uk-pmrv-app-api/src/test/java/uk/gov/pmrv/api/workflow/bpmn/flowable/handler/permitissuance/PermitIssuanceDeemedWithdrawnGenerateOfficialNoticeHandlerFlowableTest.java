...
class PermitIssuanceDeemedWithdrawnGenerateOfficialNoticeHandlerFlowableTest {

    @InjectMocks
    private PermitIssuanceDeemedWithdrawnGenerateOfficialNoticeHandlerFlowable handler;
