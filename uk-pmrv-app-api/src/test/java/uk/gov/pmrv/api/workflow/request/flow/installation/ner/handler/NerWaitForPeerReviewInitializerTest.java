...
class NerWaitForPeerReviewInitializerTest {

    @InjectMocks
    private NerWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NerApplicationReviewRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.NER_WAIT_FOR_PEER_REVIEW_PAYLOAD)
            .build());
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.NER_WAIT_FOR_PEER_REVIEW);
    }
}
