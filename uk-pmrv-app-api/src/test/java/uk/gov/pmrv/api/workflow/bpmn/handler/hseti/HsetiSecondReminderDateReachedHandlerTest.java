...
public class HsetiSecondReminderDateReachedHandlerTest {

    @InjectMocks
    private HsetiSecondReminderDateReachedHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(hsetiSendReminderNotificationService).sendSecondReminderNotification(requestId, expirationDate);
    }
}
