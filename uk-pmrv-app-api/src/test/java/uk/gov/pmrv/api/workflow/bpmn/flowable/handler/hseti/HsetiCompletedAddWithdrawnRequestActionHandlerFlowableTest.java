...
class HsetiCompletedAddWithdrawnRequestActionHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiCompletedAddWithdrawnRequestActionHandlerFlowable handler;
    ...
    void execute_shouldCallCompleteService() {
        ...
        verify(completeService).addWithdrawnRequestAction("REQ-1");
