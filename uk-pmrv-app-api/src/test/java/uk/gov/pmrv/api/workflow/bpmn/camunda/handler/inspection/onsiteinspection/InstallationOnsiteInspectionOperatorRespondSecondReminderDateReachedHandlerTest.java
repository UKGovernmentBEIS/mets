package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.inspection.onsiteinspection;
...
public class InstallationOnsiteInspectionOperatorRespondSecondReminderDateReachedHandlerTest {

    @InjectMocks
    private InstallationOnsiteInspectionOperatorRespondSecondReminderDateReachedHandler handler;
    ...
    void execute() throws Exception {
        ...
        final String requestId = "INS00045-202";
