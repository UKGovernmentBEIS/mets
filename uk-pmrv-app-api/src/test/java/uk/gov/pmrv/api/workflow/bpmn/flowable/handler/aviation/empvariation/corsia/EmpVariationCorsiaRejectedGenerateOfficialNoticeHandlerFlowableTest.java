...
class EmpVariationCorsiaRejectedGenerateOfficialNoticeHandlerFlowableTest {
    ...
    @InjectMocks
    private EmpVariationCorsiaRejectedGenerateOfficialNoticeHandlerFlowable handler;

    @Test
    void execute_callsServiceGenerateAndSaveRejectedOfficialNotice_withRequestId() {
