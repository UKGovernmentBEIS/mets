...
class ReturnOfAllowancesPeerDecisionActionHandlerTest {

    @InjectMocks
    private ReturnOfAllowancesPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        final PeerReviewDecisionRequestTaskActionPayload payload =
            PeerReviewDecisionRequestTaskActionPayload.builder()
                .payloadType(RequestTaskActionPayloadType.RETURN_OF_ALLOWANCES_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                .decision(decision)
                .build();
        ...
        handler.process(requestTask.getId(),
            RequestTaskActionType.RETURN_OF_ALLOWANCES_SUBMIT_PEER_REVIEW_DECISION,
            appUser,
            payload);
        ...
        verify(requestService, times(1)).addActionToRequest(
            ...
            eq(RequestActionType.RETURN_OF_ALLOWANCES_APPLICATION_PEER_REVIEWER_REJECTED),
            eq(userId));
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.RETURN_OF_ALLOWANCES_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.RETURN_OF_ALLOWANCES_SUBMIT_PEER_REVIEW_DECISION);
    }
