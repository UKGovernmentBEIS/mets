...
class PermitVariationWaitForPeerReviewInitializerTest {

	@InjectMocks
    private PermitVariationWaitForPeerReviewInitializer handler;
	...
	void initializePayload() {
		...
		assertThat(variationTaskPayloadResult.getPayloadType()).isEqualTo(RequestTaskPayloadType.PERMIT_VARIATION_WAIT_FOR_PEER_REVIEW_PAYLOAD);
