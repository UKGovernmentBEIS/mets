...
class PermitNotificationRejectedOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private PermitNotificationRejectedOfficialLetterPreviewHandler handler;
    ...
    void generateDocument() {
        ...
        final String filename = "Permit Notification Refusal Letter.pdf";
