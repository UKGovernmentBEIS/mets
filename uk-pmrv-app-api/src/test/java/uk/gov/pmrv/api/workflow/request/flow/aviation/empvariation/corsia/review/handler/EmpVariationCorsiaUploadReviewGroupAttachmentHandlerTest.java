...
class EmpVariationCorsiaUploadReviewGroupAttachmentHandlerTest {

	@InjectMocks
    private EmpVariationCorsiaUploadReviewGroupAttachmentHandler handler;

    @Mock
    private EmpVariationCorsiaReviewUploadAttachmentService uploadAttachmentService;
    ...
    @Test
    void getTypes() {
        assertThat(handler.getType()).isEqualTo(RequestTaskActionType.EMP_VARIATION_CORSIA_UPLOAD_REVIEW_GROUP_DECISION_ATTACHMENT);
    }
}
