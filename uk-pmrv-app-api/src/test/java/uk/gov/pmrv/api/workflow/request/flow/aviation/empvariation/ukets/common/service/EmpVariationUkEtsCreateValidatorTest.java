...
class EmpVariationUkEtsCreateValidatorTest {

	@InjectMocks
    private EmpVariationUkEtsCreateValidator validator;
    ...
    void validateAction_whenValid_thenOk() {
        ...
        Set<RequestType> mutuallyExclusiveRequests = Set.of(RequestType.EMP_VARIATION_UKETS);
    ...
    @Test
    void type() {
        assertThat(validator.getType()).isEqualTo(RequestCreateActionType.EMP_VARIATION_UKETS);
    }
}
