...
class EmpVariationCorsiaReviewSaveActionHandlerTest {

	@InjectMocks
    private EmpVariationCorsiaReviewSaveActionHandler handler;
	...
	@Test
	void getTypes() {
		assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.EMP_VARIATION_CORSIA_SAVE_APPLICATION_REVIEW);
	}
	
	@Test
	void process() {
		Long requestTaskId = 1L;
		RequestTaskActionType requestTaskActionType = RequestTaskActionType.EMP_VARIATION_CORSIA_SAVE_APPLICATION_REVIEW;
		AppUser appUser = AppUser.builder().build();
		EmpVariationCorsiaSaveApplicationReviewRequestTaskActionPayload payload = 
				EmpVariationCorsiaSaveApplicationReviewRequestTaskActionPayload.builder().build();
        ...
        verify(empVariationCorsiaReviewService, times(1)).saveEmpVariation(payload, requestTask);
	}
}
