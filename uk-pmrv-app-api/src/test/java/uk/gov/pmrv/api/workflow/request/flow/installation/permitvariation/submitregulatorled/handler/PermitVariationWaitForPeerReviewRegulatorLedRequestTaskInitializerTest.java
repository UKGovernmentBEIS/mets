...
import uk.gov.pmrv.api.workflow.request.flow.installation.permitvariation.submitregulatorled.handler.PermitVariationWaitForPeerReviewRegulatorLedRequestTaskInitializer;

@ExtendWith(MockitoExtension.class)
class PermitVariationWaitForPeerReviewRegulatorLedRequestTaskInitializerTest {

	@InjectMocks
    private PermitVariationWaitForPeerReviewRegulatorLedRequestTaskInitializer handler;
	...
	void initializePayload() {
		...
		assertThat(variationTaskPayloadResult.getPayloadType()).isEqualTo(RequestTaskPayloadType.PERMIT_VARIATION_WAIT_FOR_PEER_REVIEW_REGULATOR_LED_PAYLOAD);
