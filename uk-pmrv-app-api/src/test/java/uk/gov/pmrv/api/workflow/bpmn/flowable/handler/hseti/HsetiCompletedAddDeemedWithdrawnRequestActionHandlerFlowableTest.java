...
class HsetiCompletedAddDeemedWithdrawnRequestActionHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiCompletedAddDeemedWithdrawnRequestActionHandlerFlowable handler;
    ...
    void execute_shouldCallCompleteService() {
        ...
        verify(completeService).addDeemedWithdrawnRequestAction("REQ-1");
