...
import uk.gov.pmrv.api.integration.registry.accountcreated.installation.request.InstallationAccountCreatedRegistryDTO;
import uk.gov.pmrv.api.integration.registry.accountcreated.installation.request.InstallationAccountCreatedRegistryDetails;
import uk.gov.pmrv.api.integration.registry.accountcreated.installation.request.InstallationPermitGrantedSendToRegistryProducer;
...
public class InstallationPermitGrantedSendToRegistryProducerTest {

    @InjectMocks
    private InstallationPermitGrantedSendToRegistryProducer producer;

    private static final String TOPIC = "account-created-topic";

    @Mock
    private KafkaTemplate<String, InstallationAccountCreatedRegistryDTO> accountCreatedKafkaTemplate;
    ...
    public void produce() {
        ...
        InstallationAccountCreatedRegistryDTO dto = mock(InstallationAccountCreatedRegistryDTO.class);
        InstallationAccountCreatedRegistryDetails details = mock(InstallationAccountCreatedRegistryDetails.class);
        ...
        ArgumentCaptor<InstallationAccountCreatedRegistryDTO> valueCaptor = ArgumentCaptor.forClass(InstallationAccountCreatedRegistryDTO.class);
    ...
    void produce_wrapsKafkaErrorsInBusinessException() {
        ...
        doThrow(new RuntimeException("broker down"))
                ...
                .send(anyString(), anyString(), any(InstallationAccountCreatedRegistryDTO.class));
