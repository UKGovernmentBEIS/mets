...
class EmpVariationCorsiaApprovedAddRequestActionServiceTest {

	@InjectMocks
    private EmpVariationCorsiaApprovedAddRequestActionService addRequestActionService;
    ...
    void addRequestAction() {
        ...
        EmissionsMonitoringPlanCorsia emp = EmissionsMonitoringPlanCorsia.builder()
            ...
            .build();
        EmpVariationDetermination determination = 
        		EmpVariationDetermination.builder().type(EmpVariationDeterminationType.APPROVED).build();
        ...
        EmpVariationCorsiaApplicationApprovedRequestActionPayload requestActionPayload = 
        		EmpVariationCorsiaApplicationApprovedRequestActionPayload.builder()
	                .payloadType(RequestActionPayloadType.EMP_VARIATION_CORSIA_APPLICATION_APPROVED_PAYLOAD)
	                .emissionsMonitoringPlan(emp)
	                .empVariationDetails(EmpVariationCorsiaDetails.builder().reason("test reason").build())
	                .determination(determination)
	                .decisionNotification(decisionNotification)
        ...
        verify(requestService, times(1)).addActionToRequest(
        		request, requestActionPayload,  RequestActionType.EMP_VARIATION_CORSIA_APPLICATION_APPROVED, regulatorUser);
    }
}
