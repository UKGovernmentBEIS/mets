...
class DoalSendOfficialNoticeEmailHandlerFlowableTest {
    ...
    @InjectMocks
    private DoalSendOfficialNoticeEmailHandlerFlowable handler;
    ...
    void execute_shouldSendOfficialNotice() {
        ...
        verify(doalOfficialNoticeService).sendOfficialNotice(requestId);
