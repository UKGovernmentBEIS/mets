...
class EmpVariationUkEtsDeemedWithdrawnOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private EmpVariationUkEtsDeemedWithdrawnOfficialLetterPreviewHandler handler;
    ...
    void generateDocument() {
        ...
        when(documentFileGeneratorService.generateFileDocument(
            ...
            "emp_variation_withdrawn.pdf")).thenReturn(fileDTO);
