...
class InstallationAuditRequestPeerReviewValidatorTest {

    @InjectMocks
    private InstallationAuditRequestPeerReviewValidator validator;
    ...
    @Test
    void getRequestType(){
        assertThat(validator.getRequestType()).isEqualTo(RequestType.INSTALLATION_AUDIT);
    }
}
