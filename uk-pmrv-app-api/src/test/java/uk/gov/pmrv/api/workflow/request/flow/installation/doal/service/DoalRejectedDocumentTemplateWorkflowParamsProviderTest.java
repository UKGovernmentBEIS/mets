...
class DoalRejectedDocumentTemplateWorkflowParamsProviderTest {

    @InjectMocks
    private DoalRejectedDocumentTemplateWorkflowParamsProvider provider;

    @Test
    void getContextActionType() {
        assertThat(provider.getContextActionType()).isEqualTo(DocumentTemplateGenerationContextActionType.DOAL_REJECTED);
    }
    ...
    void constructParams() {
        ...
        final Doal doal = Doal.builder()
                .determination(DoalProceedToAuthorityDetermination.builder()
                        ...
                        .build())
                .build();
        final DoalRejectAuthorityResponse authorityResponse = DoalRejectAuthorityResponse.builder()
