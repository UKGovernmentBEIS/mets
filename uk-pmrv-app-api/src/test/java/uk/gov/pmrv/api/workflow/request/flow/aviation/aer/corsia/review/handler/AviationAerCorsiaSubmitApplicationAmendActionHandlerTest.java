...
class AviationAerCorsiaSubmitApplicationAmendActionHandlerTest {

    @InjectMocks
    private AviationAerCorsiaSubmitApplicationAmendActionHandler submitApplicationAmendActionHandler;
    ...
    void process() {
        ...
        RequestTaskActionType requestTaskActionType = RequestTaskActionType.AVIATION_AER_CORSIA_SUBMIT_APPLICATION_AMEND;
    ...
    @Test
    void getTypes() {
        assertThat(submitApplicationAmendActionHandler.getTypes()).containsOnly(RequestTaskActionType.AVIATION_AER_CORSIA_SUBMIT_APPLICATION_AMEND);
    }
}
