...
import uk.gov.pmrv.api.workflow.request.flow.installation.permitvariation.submitregulatorled.handler.PermitVariationSaveRegulatorLedActionHandler;
...
class PermitVariationSaveRegulatorLedActionHandlerTest {

	@InjectMocks
    private PermitVariationSaveRegulatorLedActionHandler cut;
	
	@Mock
    private RequestTaskService requestTaskService;
	
	@Mock
    private PermitVariationSubmitRegulatorLedService permitVariationSubmitRegulatorLedService;
	...
	void getTypes() {
		assertThat(cut.getTypes())
				.containsExactlyInAnyOrder(RequestTaskActionType.PERMIT_VARIATION_SAVE_APPLICATION_REGULATOR_LED);
	}
}
