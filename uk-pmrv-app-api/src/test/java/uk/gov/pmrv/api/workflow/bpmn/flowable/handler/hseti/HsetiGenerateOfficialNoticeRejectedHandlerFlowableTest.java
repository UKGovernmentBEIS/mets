...
class HsetiGenerateOfficialNoticeRejectedHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiGenerateOfficialNoticeRejectedHandlerFlowable handler;
    ...
    void execute_shouldCallOfficialNoticeService() {
        ...
        verify(officialNoticeService).generateOfficialNoticeRejected("REQ-1");
