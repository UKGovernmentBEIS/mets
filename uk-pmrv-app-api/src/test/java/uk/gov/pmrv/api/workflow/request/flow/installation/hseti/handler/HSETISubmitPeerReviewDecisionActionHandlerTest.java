...
public class HSETISubmitPeerReviewDecisionActionHandlerTest {

    @InjectMocks
    private HSETISubmitPeerReviewDecisionActionHandler handler;
    ...
    void process() {
        ...
        PeerReviewDecisionRequestTaskActionPayload payload =
                PeerReviewDecisionRequestTaskActionPayload.builder()
                        .payloadType(RequestTaskActionPayloadType.HSE_TI_PEER_REVIEW_DECISION_PAYLOAD)
                        .decision(decision)
                        .build();
        ...
        verify(requestService, times(1)).addActionToRequest(
                ...
                eq(RequestActionType.HSE_TI_APPLICATION_PEER_REVIEW_REJECTED),
                eq(userId));
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.HSE_TI_APPLICATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.HSE_TI_SUBMIT_PEER_REVIEW_DECISION);
    }
}
