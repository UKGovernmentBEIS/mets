...
public class InstallationOnsiteInspectionCreateValidatorTest {

    @InjectMocks
    private InstallationOnsiteInspectionCreateValidator validator;
    ...
    @Test
    void getType() {
        assertThat(validator.getType()).isEqualTo(RequestCreateActionType.INSTALLATION_ONSITE_INSPECTION);
    }
