...
class NonComplianceNoticeOfIntentRequestPeerReviewActionHandlerTest {

    @InjectMocks
    private NonComplianceNoticeOfIntentRequestPeerReviewActionHandler handler;
    ...
    void process() {
        ...
        final NonComplianceNoticeOfIntentRequestTaskPayload taskPayload =
            NonComplianceNoticeOfIntentRequestTaskPayload.builder()
                .payloadType(RequestTaskPayloadType.NON_COMPLIANCE_NOTICE_OF_INTENT_APPLICATION_PEER_REVIEW_PAYLOAD)
                .build();
