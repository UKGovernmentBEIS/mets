...
public class NERRegulatorWithdrawApplicationTaskActionHandlerTest {
    ...
    @InjectMocks
    private NERRegulatorWithdrawApplicationTaskActionHandler handler;
    ...
    void process() {
        ...
        verify(reviewSubmitService).deemWithdrawn(requestTask, appUser);
    ...
    void getTypes() {
        assertEquals(
                List.of(RequestTaskActionType.NER_WITHDRAW_APPLICATION),
                handler.getTypes()
        );
    }
}
