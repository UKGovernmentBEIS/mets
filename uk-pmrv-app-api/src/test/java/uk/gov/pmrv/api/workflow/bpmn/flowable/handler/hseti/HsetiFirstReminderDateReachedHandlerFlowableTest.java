...
class HsetiFirstReminderDateReachedHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiFirstReminderDateReachedHandlerFlowable handler;
    ...
    void execute_shouldSendReminderNotification() {
        ...
        verify(hsetiSendReminderNotificationService).sendFirstReminderNotification("REQ-1", expirationDate);
