...
public class PermitGrantedNotifyRegistryServiceTest {

    @Mock
    private InstallationAccountPermitQueryOrchestrator accountQueryService;

    @Mock
    private InstallationPermitGrantedSendToRegistryProducer registryProducer;
    ...
    void notifyRegistry() {
        ...
        PermitGrantedEvent event = buildPermitGrantedEvent();
        ...
        verify(registryProducer).produce(any(InstallationAccountCreatedRegistryDTO.class));
        ...
        ArgumentCaptor<InstallationAccountCreatedRegistryDTO> captor =
                ArgumentCaptor.forClass(InstallationAccountCreatedRegistryDTO.class);
        verify(registryProducer).produce(captor.capture());
        AccountCreatedRegistryDTO data = captor.getValue();
        assertNotNull(data);
    }
    ...
    void notifyRegistry_registry_id_exists() {
        ...
        permitGrantedNotifyRegistryService.notifyRegistry(buildPermitGrantedEvent());
    ...
    private PermitGrantedEvent buildPermitGrantedEvent() {
        return PermitGrantedEvent.builder()
                .accountId(1L)
                .requestId("requestId")
                .build();
    }
