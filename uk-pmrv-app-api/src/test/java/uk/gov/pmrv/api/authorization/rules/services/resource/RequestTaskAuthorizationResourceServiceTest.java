...
class RequestTaskAuthorizationResourceServiceTest {
    ...
    @Test
    void hasUserExecuteScopeOnRequestTaskType_operator() {
    ...
    @Test
    void hasUserAssignScopeOnRequestTasks_operator() {
        RoleType roleType = RoleType.OPERATOR;
        PmrvUser authUser = PmrvUser.builder().roleType(roleType).build();
        Long accountId = 1L;
        Long verificationBodyId = 2L;
    ...
    @Test
    void hasUserAssignScopeOnRequestTasks_verifier() {
        RoleType roleType = RoleType.VERIFIER;
        PmrvUser authUser = PmrvUser.builder().roleType(roleType).build();
        Long accountId = 1L;
        Long verificationBodyId = 2L;
    ...
    void findRequestTaskTypesByRoleType() {
        ...
        when(resourceScopePermissionService.findByResourceTypeAndRoleType(ResourceType.REQUEST_TASK, roleType))
            .thenReturn(
                Set.of(
                    ResourceScopePermission.builder().resourceSubType(RequestTaskType.PERMIT_ISSUANCE_TRACK_PAYMENT.toString()).build(),
                    ResourceScopePermission.builder().resourceSubType(RequestTaskType.PERMIT_ISSUANCE_WAIT_FOR_AMENDS.toString()).build(),
        ...
        assertThat(actualRequestTaskTypes).containsAll(Set.of(RequestTaskType.PERMIT_ISSUANCE_TRACK_PAYMENT.toString(),
