...
class EmpUkEtsSectionUploadAttachmentServiceTest {

    @InjectMocks
    private EmpUkEtsSectionUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(EmpIssuanceUkEtsApplicationSubmitRequestTaskPayload.builder().build())
            .build();
