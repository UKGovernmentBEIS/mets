...
class PermitTransferBAcceptedDocumentTemplateWorkflowParamsProviderTest {

    @InjectMocks
    private PermitTransferBAcceptedDocumentTemplateWorkflowParamsProvider provider;
    ...
    void constructParams() {
        ...
        provider.constructParams(PermitTransferBRequestPayload.builder().relatedRequestId(transfererRequestId).build(), requestId);
