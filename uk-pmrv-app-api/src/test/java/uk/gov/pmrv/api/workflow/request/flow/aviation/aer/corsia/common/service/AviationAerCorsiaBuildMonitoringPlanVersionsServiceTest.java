...
class AviationAerCorsiaBuildMonitoringPlanVersionsServiceTest {

	@InjectMocks
    private AviationAerCorsiaBuildMonitoringPlanVersionsService cut;
    ...
    void build_emp_exists() {
		...
		verify(aerRequestQueryService, times(1)).findEndDateOfApprovedEmpIssuanceByAccountId(accountId, RequestType.EMP_ISSUANCE_CORSIA);
    }
