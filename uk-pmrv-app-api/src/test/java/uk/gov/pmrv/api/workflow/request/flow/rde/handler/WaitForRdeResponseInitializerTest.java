...
class WaitForRdeResponseInitializerTest {
    ...
    void getRequestTaskTypes() {
        assertEquals(initializer.getRequestTaskTypes(), Set.of(
            RequestTaskType.PERMIT_ISSUANCE_WAIT_FOR_RDE_RESPONSE,
            RequestTaskType.PERMIT_SURRENDER_WAIT_FOR_RDE_RESPONSE, 
            RequestTaskType.PERMIT_VARIATION_WAIT_FOR_RDE_RESPONSE,
            RequestTaskType.PERMIT_TRANSFER_B_WAIT_FOR_RDE_RESPONSE,
            RequestTaskType.EMP_ISSUANCE_UKETS_WAIT_FOR_RDE_RESPONSE,
            RequestTaskType.EMP_VARIATION_UKETS_WAIT_FOR_RDE_RESPONSE,
            RequestTaskType.EMP_ISSUANCE_CORSIA_WAIT_FOR_RDE_RESPONSE,
            RequestTaskType.EMP_VARIATION_CORSIA_WAIT_FOR_RDE_RESPONSE
        ));
    }
}
