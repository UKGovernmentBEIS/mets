...
class AviationVirUploadAttachmentServiceTest {

    @InjectMocks
    private AviationVirUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(AviationVirApplicationSubmitRequestTaskPayload.builder().build())
            .build();
