...
class PermitIssuanceWaitForReviewInitializerTest {

    @InjectMocks
    private PermitIssuanceWaitForReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.PERMIT_ISSUANCE_WAIT_FOR_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(PermitIssuanceApplicationWaitForReviewRequestTaskPayload.class);

        PermitIssuanceApplicationWaitForReviewRequestTaskPayload waitForReviewPayload =
                (PermitIssuanceApplicationWaitForReviewRequestTaskPayload) requestTaskPayload;
    ...
    void getRequestTaskTypes() {
        assertEquals(initializer.getRequestTaskTypes(), Set.of(RequestTaskType.PERMIT_ISSUANCE_WAIT_FOR_REVIEW));
    }
}