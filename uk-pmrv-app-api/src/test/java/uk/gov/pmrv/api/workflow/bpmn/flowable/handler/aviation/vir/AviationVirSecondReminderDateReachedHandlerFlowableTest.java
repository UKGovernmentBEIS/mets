...
class AviationVirSecondReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private AviationVirSecondReminderDateReachedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(virSendReminderNotificationService, times(1)).sendSecondReminderNotification(requestId, date);
    }
}
