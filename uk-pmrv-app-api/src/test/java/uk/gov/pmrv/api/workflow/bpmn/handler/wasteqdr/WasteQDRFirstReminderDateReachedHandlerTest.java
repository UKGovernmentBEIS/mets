...
public class WasteQDRFirstReminderDateReachedHandlerTest {

    @Mock
    private WasteQDRSendReminderNotificationService wasteQDRSendReminderNotificationService;

    @InjectMocks
    private WasteQDRFirstReminderDateReachedHandler wasteQDRFirstReminderDateReachedHandler;
    ...
    public void execute() throws Exception {
        ...
        wasteQDRFirstReminderDateReachedHandler.execute(execution);

        verify(wasteQDRSendReminderNotificationService).sendFirstReminderNotification(requestId, expirationDate);
    }
}
