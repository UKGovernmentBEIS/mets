...
public class ALRAuthorityResponseUploadAttachmentServiceTest {

    @InjectMocks
    private ALRAuthorityResponseUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
                .id(requestTaskId)
                .payload(ALRAuthorityResponseSubmitRequestTaskPayload.builder().build())
                .build();
