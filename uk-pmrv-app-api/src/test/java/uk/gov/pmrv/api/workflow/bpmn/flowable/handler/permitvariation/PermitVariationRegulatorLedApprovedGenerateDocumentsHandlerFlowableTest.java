...
class PermitVariationRegulatorLedApprovedGenerateDocumentsHandlerFlowableTest {
    ...
    @InjectMocks
    private PermitVariationRegulatorLedApprovedGenerateDocumentsHandlerFlowable handler;
