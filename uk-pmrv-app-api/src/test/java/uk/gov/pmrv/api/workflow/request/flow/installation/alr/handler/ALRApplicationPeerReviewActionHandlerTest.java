...
public class ALRApplicationPeerReviewActionHandlerTest {

    @InjectMocks
    private ALRApplicationPeerReviewActionHandler handler;
    ...
    void process() {
        ...
        final PeerReviewRequestTaskActionPayload taskActionPayload = PeerReviewRequestTaskActionPayload.builder()
                ...
                .payloadType(RequestTaskActionPayloadType.ALR_REQUEST_PEER_REVIEW_PAYLOAD)
                .build();
        ...
        verify(requestService).addActionToRequest(request, null, RequestActionType.ALR_APPLICATION_PEER_REVIEW_REQUESTED, appUser.getUserId());
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.ALR_REQUEST_PEER_REVIEW);
    }
}
