package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.applicationreview;
...
class ApplicationReviewFirstReminderDateReachedHandlerTest {

    @InjectMocks
    private ApplicationReviewFirstReminderDateReachedHandler handler;
