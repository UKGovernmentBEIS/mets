...
class InstallationItemResponseCreationServiceTest {

    @InjectMocks
    private InstallationItemResponseCreationService installationItemResponseCreationService;
    ...
    @Test
    void getAccountType() {
        assertEquals(AccountType.INSTALLATION, installationItemResponseCreationService.getAccountType());
    }
    ...
    void toItemDTOResponse_operator_same_assignee() {
        ...
        ItemDTOResponse actualItemDTOResponse =
            installationItemResponseCreationService.toItemDTOResponse(itemPage, operatorUser);
    ...
    void toItemDTOResponse_regulator_same_assignee() {
        ...
        // Invoke
        ItemDTOResponse actualItemDTOResponse =
            installationItemResponseCreationService.toItemDTOResponse(itemPage, regulatorUser);
    ...
    void toItemDTOResponse_regulator_oneItemWithSameAssignee_oneUnassigned() {
        ...
        verify(userRoleTypeService, times(1)).getUserRoleTypeByUserId("reg1Id");
        verify(userAuthService, never()).getUsers(anyList());
        verify(accountQueryService, times(1)).getAccountsInfoByIds(List.of(item1.getAccountId(), item2.getAccountId()));
        verify(permitQueryService, times(1)).getPermitIdByAccountId(1L);
    }
    ...
    void toItemDTOResponse_verifier_same_assignee() {
        ...
        // Invoke
        ItemDTOResponse actualItemDTOResponse =
            installationItemResponseCreationService.toItemDTOResponse(itemPage, verifierUser);
    ...
    private ItemDTO buildItemDTO(Item item, UserInfoDTO taskAssignee, RoleType roleType, String permitReferenceId) {
        return ItemDTO.builder()
            ...
            .account(ItemAccountDTO.builder()
                ...
                .leName("leName")
                .build())
            .permitReferenceId(permitReferenceId)
            .build();
    }
