...
class PaymentCancelHandlerTest {
    ...
    void process() {
        ...
        paymentCancelHandler.process(requestTaskId, PAYMENT_CANCEL, appUser, paymentCancelRequestTaskActionPayload);

        verify(requestTaskService, times(1)).findTaskById(requestTaskId);
        verify(paymentCompleteService, times(1)).cancel(requestTask, cancellationReason);
