...
class AviationDreUploadAttachmentServiceTest {

    @InjectMocks
    private AviationDreUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(AviationDreUkEtsApplicationSubmitRequestTaskPayload.builder().build())
            .build();
