...
public class AviationAerCorsia3YearPeriodOffsettingPeerReviewInitializerTest {

    @InjectMocks
    private AviationAerCorsia3YearPeriodOffsettingPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(result.getPayloadType()).isEqualTo(RequestTaskPayloadType.AVIATION_AER_CORSIA_3YEAR_PERIOD_OFFSETTING_PEER_REVIEW_PAYLOAD);
        ...
        assertThat(result).isEqualTo(AviationAerCorsia3YearPeriodOffsettingApplicationSubmitRequestTaskPayload.builder()
                .payloadType(RequestTaskPayloadType.AVIATION_AER_CORSIA_3YEAR_PERIOD_OFFSETTING_PEER_REVIEW_PAYLOAD).aviationAerCorsia3YearPeriodOffsetting(aviationAerCorsia3YearPeriodOffsetting).build());
    }


    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.AVIATION_AER_CORSIA_3YEAR_PERIOD_OFFSETTING_APPLICATION_PEER_REVIEW);
    }
