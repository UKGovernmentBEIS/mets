...
public class RequestTypeRegulatorMapperServiceTest {


    @InjectMocks
    private RequestTypeRegulatorMapperService service;

    @Mock
    private UserLoginDomainService userLoginDomainService;

    @Test
    public void getRequestTypes_installation() {
        AppUser appUser = AppUser.builder().userId("test").roleType(RoleTypeConstants.REGULATOR).build();
    ...
    @Test
    public void getRequestTypes_aviation() {
        AppUser appUser = AppUser.builder().userId("test").roleType(RoleTypeConstants.REGULATOR).build();

        when(userLoginDomainService.getUserLastLoginDomain("test")).thenReturn(AccountType.AVIATION);
    ...
    public void getRoleType() {
        assertThat(service.getRoleType()).isEqualTo(RoleTypeConstants.REGULATOR);
    }
