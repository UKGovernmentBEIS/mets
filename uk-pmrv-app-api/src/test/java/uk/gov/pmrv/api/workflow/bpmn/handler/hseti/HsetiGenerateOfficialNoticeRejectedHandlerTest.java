...
public class HsetiGenerateOfficialNoticeRejectedHandlerTest {

    @InjectMocks
    private HsetiGenerateOfficialNoticeRejectedHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(officialNoticeService, times(1))
                .generateOfficialNoticeRejected(requestId);
    }
}
