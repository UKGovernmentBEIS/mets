...
class NonComplianceCivilPenaltyWaitForPeerReviewInitializerTest {

    @InjectMocks
    private NonComplianceCivilPenaltyWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NonComplianceCivilPenaltyRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW_PAYLOAD)
            .build());
    }
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactlyInAnyOrder(
            RequestTaskType.NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW,
            RequestTaskType.AVIATION_NON_COMPLIANCE_CIVIL_PENALTY_WAIT_FOR_PEER_REVIEW);
    }
