...
class AEROperatorRecallEmailNotificationHandlerTest {
    ...
    private AEROperatorRecallEmailNotificationHandler handler;

    @BeforeEach
    void setUp() {
        handler = new AEROperatorRecallEmailNotificationHandler(
                userAuthService,
                accountQueryService,
    ...
    void getType() {
        assertThat(handler.getType())
                .isEqualTo("AER APPLICATION RECALLED BY OPERATOR");
    }
}
