...
class AviationAerCorsiaCompleteActionHandlerTest {

    @InjectMocks
    private AviationAerCorsiaCompleteActionHandler completeActionHandler;
    ...
    void process() {
        ...
        completeActionHandler.process(requestTaskId, RequestTaskActionType.AVIATION_AER_CORSIA_COMPLETE_REVIEW, user, taskActionEmptyPayload);

        verify(requestTaskService, times(1)).findTaskById(requestTaskId);
        verify(aerCorsiaReviewValidatorService, times(1)).validateAllReviewGroupsExistAndAccepted(requestTaskPayload, false);
    ...
    @Test
    void getTypes() {
        assertThat(completeActionHandler.getTypes()).containsOnly(RequestTaskActionType.AVIATION_AER_CORSIA_COMPLETE_REVIEW);
    }
}