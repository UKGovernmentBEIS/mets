...
class NerSubmitPeerDecisionActionHandlerTest {

    @InjectMocks
    private NerSubmitPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        final PeerReviewDecisionRequestTaskActionPayload payload =
            PeerReviewDecisionRequestTaskActionPayload.builder()
                .payloadType(RequestTaskActionPayloadType.NER_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                .decision(decision)
                .build();
        ...
        verify(requestService, times(1)).addActionToRequest(
            ...
            eq(RequestActionType.NER_PEER_REVIEWER_ACCEPTED),
            eq(userId));
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.NER_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.NER_SUBMIT_PEER_REVIEW_DECISION);
    }
}
