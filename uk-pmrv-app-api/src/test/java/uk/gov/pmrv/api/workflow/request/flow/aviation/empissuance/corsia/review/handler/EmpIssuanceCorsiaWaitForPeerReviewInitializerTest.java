...
class EmpIssuanceCorsiaWaitForPeerReviewInitializerTest {

    @InjectMocks
    private EmpIssuanceCorsiaWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.EMP_ISSUANCE_CORSIA_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpIssuanceCorsiaApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_ISSUANCE_CORSIA_WAIT_FOR_PEER_REVIEW);
    }

    @Test
    void getRequestTaskPayloadType() {
        assertEquals(RequestTaskPayloadType.EMP_ISSUANCE_CORSIA_WAIT_FOR_PEER_REVIEW_PAYLOAD, initializer.getRequestTaskPayloadType());
    }
}