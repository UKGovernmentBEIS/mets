...
class NerSaveApplicationAmendActionHandlerTest {

    @InjectMocks
    private NerSaveApplicationAmendActionHandler handler;
    ...
    void doProcess() {
        ...
        final NerSaveApplicationAmendRequestTaskActionPayload taskActionPayload =
            NerSaveApplicationAmendRequestTaskActionPayload.builder()
                .payloadType(RequestTaskActionPayloadType.NER_SAVE_APPLICATION_AMEND_PAYLOAD)
                .build();
        ...
        verify(applyService, times(1)).amend(taskActionPayload, requestTask);
    }
    
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).isEqualTo(List.of(RequestTaskActionType.NER_SAVE_APPLICATION_AMEND));
    }
}
