...
public class ALRApplicationSentToRegulatorVerificationReportOpinionStatementNotesMapperTest {

    @InjectMocks
    private ALRApplicationSentToRegulatorVerificationReportOpinionStatementNotesMapper mapper;
    ...
    public void getRequestActionType() {
        ...
        assertThat(requestActionType).isEqualTo(RequestActionType.ALR_APPLICATION_SENT_TO_REGULATOR);
    }
