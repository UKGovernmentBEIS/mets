...
public class ALRRegulatorReviewUploadAttachmentServiceTest {

    @InjectMocks
    private ALRRegulatorReviewUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        ALRApplicationRegulatorReviewSubmitRequestTaskPayload taskPayload =
                ALRApplicationRegulatorReviewSubmitRequestTaskPayload.builder()
                        .build();
