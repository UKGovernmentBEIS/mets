...
class Bdrs2CompletedAddRequestActionHandlerFlowableTest {

    @InjectMocks
    private Bdrs2CompletedAddRequestActionHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(bdrs2CompleteService, times(1)).addRequestAction(requestId);
    }
}
