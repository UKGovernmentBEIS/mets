...
public class HsetiCompletedAddRejectedRequestActionHandlerTest {

    @InjectMocks
    private HsetiCompletedAddRejectedRequestActionHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(completeService, times(1)).addRejectedRequestAction(requestId);
    }
}
