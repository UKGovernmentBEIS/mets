package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.aviation.emp.corsia;
...
class EmpIssuanceCorsiaSendOfficialNoticeEmailHandlerTest {

    @InjectMocks
    private EmpIssuanceCorsiaSendOfficialNoticeEmailHandler handler;
