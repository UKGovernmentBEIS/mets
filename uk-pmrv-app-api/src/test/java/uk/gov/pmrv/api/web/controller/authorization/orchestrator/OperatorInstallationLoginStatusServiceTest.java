...
class OperatorInstallationLoginStatusServiceTest {

    @InjectMocks
    private OperatorInstallationLoginStatusService service;

    @Mock
    private AccountQueryService accountQueryService;

    @Test
    void getLoginStatus_no_authorities_for_installation_then_no_authority() {
