...
public class InstallationInspectionOperatorRespondUploadAttachmentServiceTest {


    @InjectMocks
    private InstallationInspectionOperatorRespondUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
                .id(requestTaskId)
                .payload(InstallationInspectionOperatorRespondRequestTaskPayload.builder().build())
                .build();
