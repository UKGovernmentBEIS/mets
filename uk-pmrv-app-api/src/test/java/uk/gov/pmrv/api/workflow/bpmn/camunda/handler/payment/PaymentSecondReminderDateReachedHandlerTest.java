package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.payment;
...
public class PaymentSecondReminderDateReachedHandlerTest {

    @InjectMocks
    private PaymentSecondReminderDateReachedHandler handler;
    ...
    void execute() {
        ...
        verify(paymentSendReminderNotificationService, times(1)).sendSecondReminderNotification(requestId, expirationDate);
    }
}