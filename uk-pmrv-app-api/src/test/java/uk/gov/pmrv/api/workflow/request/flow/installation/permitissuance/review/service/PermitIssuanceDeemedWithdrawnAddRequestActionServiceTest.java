...
class PermitIssuanceDeemedWithdrawnAddRequestActionServiceTest {
    ...
    void execute() {
        ...
        final Permit permit = Permit.builder()
            ...
            .build();
        final PermitIssuanceDeemedWithdrawnDetermination
            determination = PermitIssuanceDeemedWithdrawnDetermination.builder().type(DeterminationType.DEEMED_WITHDRAWN).build();
