...
public class ALROfficialNoticeServiceTest {

    @InjectMocks
    private ALROfficialNoticeService service;
    ...
    void generateAndSaveProceededToAuthorityOfficialNotice() {
        ...
        final DocumentTemplateParamsSourceData paramsSourceData = DocumentTemplateParamsSourceData.builder()
                .contextActionType(DocumentTemplateGenerationContextActionType.ALR_SUBMITTED)
                .request(request)
                .signatory(signatory)
        ...
        // Verify
        assertThat(request.getPayload()).isInstanceOf(ALRRequestPayload.class);
        assertThat(((ALRRequestPayload) request.getPayload()).getOfficialNotice()).isEqualTo(officialNotice);
