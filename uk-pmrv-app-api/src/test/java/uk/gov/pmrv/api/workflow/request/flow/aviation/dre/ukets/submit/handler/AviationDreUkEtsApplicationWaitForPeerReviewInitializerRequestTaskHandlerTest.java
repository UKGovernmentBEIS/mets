...
class AviationDreUkEtsApplicationWaitForPeerReviewInitializerRequestTaskHandlerTest {

    @InjectMocks
    private AviationDreUkEtsApplicationWaitForPeerReviewInitializerRequestTaskHandler cut;
    ...
    void initializePayload() {
        ...
        assertThat(result.getPayloadType()).isEqualTo(RequestTaskPayloadType.AVIATION_DRE_UKETS_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        ...
        assertThat(result).isEqualTo(AviationDreUkEtsApplicationSubmitRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.AVIATION_DRE_UKETS_WAIT_FOR_PEER_REVIEW_PAYLOAD).dre(dre).build());
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(cut.getRequestTaskTypes()).containsExactlyInAnyOrder(
            RequestTaskType.AVIATION_DRE_UKETS_WAIT_FOR_PEER_REVIEW);
    }
}
