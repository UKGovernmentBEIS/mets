...
class ReturnOfAllowancesCancelApplicationActionHandlerTest {
    ...
    @InjectMocks
    private ReturnOfAllowancesCancelApplicationActionHandler handler;
    ...
    void getTypes() {
        List<RequestTaskActionType> expectedTypes =
            List.of(RequestTaskActionType.RETURN_OF_ALLOWANCES_CANCEL_APPLICATION);
