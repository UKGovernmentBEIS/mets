...
class PermitTransferACreateValidatorTest {

    @InjectMocks
    private PermitTransferACreateValidator validator;
    ...
    void type() {
        ...
        final RequestCreateActionType actionType = validator.getType();
        assertThat(actionType).isEqualTo(RequestCreateActionType.PERMIT_TRANSFER_A);
    }
}
