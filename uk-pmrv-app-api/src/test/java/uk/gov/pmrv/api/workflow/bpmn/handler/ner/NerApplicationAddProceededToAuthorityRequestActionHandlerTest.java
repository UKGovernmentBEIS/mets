...
class NerApplicationAddProceededToAuthorityRequestActionHandlerTest {

    @InjectMocks
    private NerApplicationAddProceededToAuthorityRequestActionHandler handler;
    ...
    void execute() {
        ...
        verify(service, times(1)).proceedToAuthority(requestId);
    }
}
