...
public class AviationDoECorsiaPeerReviewInitializerTest {

    @InjectMocks
    private AviationDoECorsiaPeerReviewInitializer handler;
    ...
    void initializePayload() {
        ...
        assertThat(result.getPayloadType()).isEqualTo(RequestTaskPayloadType.AVIATION_DOE_CORSIA_PEER_REVIEW_PAYLOAD);
        ...
        assertThat(result).isEqualTo(AviationDoECorsiaApplicationSubmitRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.AVIATION_DOE_CORSIA_PEER_REVIEW_PAYLOAD).doe(doe).build());
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(handler.getRequestTaskTypes()).containsExactlyInAnyOrder(
            RequestTaskType.AVIATION_DOE_CORSIA_APPLICATION_PEER_REVIEW);
    }
}
