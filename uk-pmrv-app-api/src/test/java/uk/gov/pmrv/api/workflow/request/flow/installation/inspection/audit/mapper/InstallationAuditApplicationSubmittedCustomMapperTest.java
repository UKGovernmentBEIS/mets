package uk.gov.pmrv.api.workflow.request.flow.installation.inspection.audit.mapper;
...
public class InstallationAuditApplicationSubmittedCustomMapperTest {

    @InjectMocks
    private InstallationAuditApplicationSubmittedCustomMapper mapper;
    ...
    void toRequestActionDTO(){
        ...
        RequestAction requestAction = RequestAction.builder()
    			.type(RequestActionType.INSTALLATION_AUDIT_APPLICATION_SUBMITTED)
