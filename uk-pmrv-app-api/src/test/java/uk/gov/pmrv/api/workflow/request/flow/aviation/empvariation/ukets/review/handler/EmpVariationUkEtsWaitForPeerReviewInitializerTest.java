...
class EmpVariationUkEtsWaitForPeerReviewInitializerTest {

	@InjectMocks
    private EmpVariationUkEtsWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.EMP_VARIATION_UKETS_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpVariationUkEtsApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_VARIATION_UKETS_WAIT_FOR_PEER_REVIEW);
    }
}
