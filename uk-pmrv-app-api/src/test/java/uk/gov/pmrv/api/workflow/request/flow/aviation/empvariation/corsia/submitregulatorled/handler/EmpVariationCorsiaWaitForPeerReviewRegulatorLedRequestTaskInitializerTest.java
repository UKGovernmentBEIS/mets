...
class EmpVariationCorsiaWaitForPeerReviewRegulatorLedRequestTaskInitializerTest {

	@InjectMocks
    private EmpVariationCorsiaWaitForPeerReviewRegulatorLedRequestTaskInitializer cut;
	...
	void getRequestTaskTypes() {
		assertThat(cut.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_VARIATION_CORSIA_REGULATOR_LED_WAIT_FOR_PEER_REVIEW);
	}
	...
	void initializePayload() {
		...
		assertThat(result).isInstanceOf(EmpVariationCorsiaApplicationSubmitRegulatorLedRequestTaskPayload.class)
			.isEqualTo(EmpVariationCorsiaApplicationSubmitRegulatorLedRequestTaskPayload.builder()
				.payloadType(RequestTaskPayloadType.EMP_VARIATION_CORSIA_WAIT_FOR_PEER_REVIEW_REGULATOR_LED_PAYLOAD)
				.emissionsMonitoringPlan(EmissionsMonitoringPlanCorsia.builder()
						.abbreviations(EmpAbbreviations.builder()
								.exist(false)
								.build())
