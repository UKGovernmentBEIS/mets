...
import uk.gov.pmrv.api.workflow.request.flow.installation.permitnotification.handler.PermitNotificationWaitForPeerReviewInitializer;

@ExtendWith(MockitoExtension.class)
class PermitNotificationWaitForPeerReviewInitializerTest {

    @InjectMocks
    private PermitNotificationWaitForPeerReviewInitializer initializer;
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(
                RequestTaskType.PERMIT_NOTIFICATION_WAIT_FOR_PEER_REVIEW);
    }
}
