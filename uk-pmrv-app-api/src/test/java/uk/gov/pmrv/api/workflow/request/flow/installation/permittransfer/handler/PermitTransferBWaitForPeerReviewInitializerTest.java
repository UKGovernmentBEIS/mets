...
import uk.gov.pmrv.api.workflow.request.flow.installation.permittransfer.handler.PermitTransferBWaitForPeerReviewInitializer;

@ExtendWith(MockitoExtension.class)
class PermitTransferBWaitForPeerReviewInitializerTest {

    @InjectMocks
    private PermitTransferBWaitForPeerReviewInitializer initializer;
    ...
    void getRequestTaskTypes() {
        assertEquals(initializer.getRequestTaskTypes(), Set.of(RequestTaskType.PERMIT_TRANSFER_B_WAIT_FOR_PEER_REVIEW));
    }
}
