...
class AviationItemResponseCreationServiceTest {
    ...
    void toItemDTOResponse_regulator_same_assignee() {
        ...
        when(userRoleTypeService.getUserRoleTypeByUserId("reg1Id")).thenReturn(UserRoleTypeDTO.builder().roleType(RoleTypeConstants.REGULATOR).build());
        when(empQueryService.getEmpIdByAccountId(accountId)).thenReturn(Optional.empty());
    ...
    private ItemDTO buildItemDTO(Item item, UserInfoDTO taskAssignee, String roleType, String empId) {
