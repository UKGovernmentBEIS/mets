...
class PermitVariationPreviewPermitDocumentServiceTest {

    @InjectMocks
    private PermitVariationPreviewPermitDocumentService service;
    ...
    @ParameterizedTest
    @EnumSource(value= RequestTaskType.class, names={"PERMIT_VARIATION_APPLICATION_PEER_REVIEW","PERMIT_VARIATION_APPLICATION_REVIEW"})
    void createPermitForVariation(RequestTaskType requestTaskType) {
