...
class AirSecondReminderDateReachedHandlerFlowableTest {
    ...
    @InjectMocks
    private AirSecondReminderDateReachedHandlerFlowable handler;

    @Test
    void execute_callsSendSecondReminderNotification() {
        ...
        verify(service).sendSecondReminderNotification(requestId, expirationDate);
    }
}
