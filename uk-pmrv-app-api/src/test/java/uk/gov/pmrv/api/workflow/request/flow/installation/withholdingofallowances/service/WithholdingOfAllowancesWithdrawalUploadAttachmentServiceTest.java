...
class WithholdingOfAllowancesWithdrawalUploadAttachmentServiceTest {

    @InjectMocks
    private WithholdingOfAllowancesWithdrawalUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(WithholdingOfAllowancesWithdrawalApplicationSubmitRequestTaskPayload.builder().build())
            .build();
        ...
        assertThat(((WithholdingOfAllowancesWithdrawalApplicationSubmitRequestTaskPayload) requestTask.getPayload())
            .getWithholdingWithdrawalAttachments())
