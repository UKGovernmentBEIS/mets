...
class InstallationMiReportGeneratorServiceTest {

    @InjectMocks
    private InstallationMiReportGeneratorService service;

    @Mock
    private MiReportRepository miReportRepository;

    @Spy
    private ArrayList<InstallationMiReportGeneratorHandler> handlers;

    @Mock
    private InstallationMiReportGeneratorHandler<MiReportParams> installationMiReportGeneratorHandler;

    @BeforeEach
    void setup() {
        handlers.add(installationMiReportGeneratorHandler);
    }
