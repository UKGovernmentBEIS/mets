...
class NerApplicationAddAcceptedRequestActionHandlerTest {

    @InjectMocks
    private NerApplicationAddAcceptedRequestActionHandler handler;
    ...
    void execute() {
        ...
        verify(service, times(1)).accept(requestId);
    }
}
