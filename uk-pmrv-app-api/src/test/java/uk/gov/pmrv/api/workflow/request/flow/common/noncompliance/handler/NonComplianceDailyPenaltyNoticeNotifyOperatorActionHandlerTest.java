...
class NonComplianceDailyPenaltyNoticeNotifyOperatorActionHandlerTest {

    @InjectMocks
    private NonComplianceDailyPenaltyNoticeNotifyOperatorActionHandler handler;
    ...
    void process() {
        ...
        final NonComplianceDailyPenaltyNoticeApplicationSubmittedRequestActionPayload actionPayload =
            NonComplianceDailyPenaltyNoticeApplicationSubmittedRequestActionPayload.builder()
        ...
        verify(requestService, times(1)).addActionToRequest(
            request,
            actionPayload,
            RequestActionType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_APPLICATION_SUBMITTED,
            "userId"
        );
        ...
        verify(officialNoticeServiceDelegator, times(1)).sendOfficialNotice(
            dailyPenaltyNotice, request, decisionNotification
        );
    }

    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_NOTIFY_OPERATOR);
    }
}
