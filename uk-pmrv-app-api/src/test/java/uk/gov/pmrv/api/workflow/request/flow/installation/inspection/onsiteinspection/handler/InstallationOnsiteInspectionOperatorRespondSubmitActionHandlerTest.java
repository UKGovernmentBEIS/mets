...
public class InstallationOnsiteInspectionOperatorRespondSubmitActionHandlerTest {

    @InjectMocks
    private InstallationOnsiteInspectionOperatorRespondSubmitActionHandler handler;
    ...
    @Mock
    private InstallationOnsiteInspectionOperatorRespondService installationOnsiteInspectionOperatorRespondService;
    ...
    void process() {
        ...
        handler.process(requestTask.getId(), RequestTaskActionType.INSTALLATION_ONSITE_INSPECTION_OPERATOR_RESPOND_SUBMIT, appUser, taskActionPayload);

        verify(installationOnsiteInspectionOperatorRespondService, times(1)).applySubmitAction(requestTask,appUser);
    ...
    void getTypes(){
        assertThat(handler.getTypes())
                .containsExactlyInAnyOrder(RequestTaskActionType.INSTALLATION_ONSITE_INSPECTION_OPERATOR_RESPOND_SUBMIT);
    }
}
