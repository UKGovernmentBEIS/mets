...
public class HSETIApplicationWaitForPeerReviewInitializerTest {

    @InjectMocks
    private HSETIApplicationWaitForPeerReviewInitializer handler;
    ...
    void initializePayload() {
        ...
        assertThat(result.getPayloadType()).isEqualTo(RequestTaskPayloadType.HSE_TI_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        ...
        assertThat(result).isEqualTo(HSETIApplicationRegulatorReviewSubmitRequestTaskPayload.builder()
                .payloadType(RequestTaskPayloadType.HSE_TI_WAIT_FOR_PEER_REVIEW_PAYLOAD).hseti(hseti).build());
    }
}
