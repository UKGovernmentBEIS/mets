...
class WithdrawnWithholdingOfAllowancesHandlerFlowableTest {
    ...
    @InjectMocks
    private WithdrawnWithholdingOfAllowancesHandlerFlowable handler;

    @Test
    void execute_callsServiceWithdraw_withRequestId() {
