...
class PermitVariationRequestIdGeneratorIT extends AbstractContainerBaseTest {
    ...
    void shouldGenerateRequestId() {
        ...
        assertThat(requestId).isEqualTo("AEMV00001-1");
        
        RequestSequence seq =
            repository.findByBusinessIdentifierAndType(String.valueOf(accountId), RequestType.PERMIT_VARIATION).get();
        assertThat(seq.getVersion()).isZero();
        assertThat(seq.getSequence()).isEqualTo(1L);
    }
