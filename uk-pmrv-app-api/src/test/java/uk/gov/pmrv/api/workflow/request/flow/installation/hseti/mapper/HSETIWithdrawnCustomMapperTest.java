...
public class HSETIWithdrawnCustomMapperTest {

    @InjectMocks
    private HSETIWithdrawnCustomMapper mapper;
    ...
    public void getRequestActionType() {
        ...
        assertThat(requestActionType).isEqualTo(RequestActionType.HSE_TI_WITHDRAWN);
    }
