...
class InstallationPmrvMiReportGeneratorServiceTest {
    ...
    private final InstallationMiReportGeneratorHandler<EmptyMiReportSystemParams> installationMiReportGeneratorHandler = mock(InstallationMiReportGeneratorHandler.class);
    private final List<InstallationMiReportGeneratorHandler<EmptyMiReportSystemParams>> handlers = Collections.singletonList(installationMiReportGeneratorHandler);

    private final InstallationPmrvMiReportGeneratorService<EmptyMiReportSystemParams> service = new InstallationPmrvMiReportGeneratorService<>(miReportSystemGeneratorDelegator, handlers);
