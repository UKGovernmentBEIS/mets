...
class AlrApplicationAddRejectedRequestActionHandlerFlowableTest {
    ...
    @InjectMocks
    private AlrApplicationAddRejectedRequestActionHandlerFlowable handler;

    @Test
    void execute_shouldAddRejectedRequestAction() {
    ...
    void execute_shouldPassNullRequestId_whenExecutionVariableMissing() {
        ...
        handler.execute(execution);
        verify(alrAuthorityResponseService)
                .addSubmittedRequestAction(null, RequestActionType.ALR_APPLICATION_REJECTED);
    }
}
