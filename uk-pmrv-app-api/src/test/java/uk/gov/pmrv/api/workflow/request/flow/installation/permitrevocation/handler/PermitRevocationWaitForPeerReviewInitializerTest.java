...
import uk.gov.pmrv.api.workflow.request.flow.installation.permitrevocation.handler.PermitRevocationWaitForPeerReviewInitializer;

@ExtendWith(MockitoExtension.class)
class PermitRevocationWaitForPeerReviewInitializerTest {

    @InjectMocks
    private PermitRevocationWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(
            RequestTaskPayloadType.PERMIT_REVOCATION_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(
            RequestTaskType.PERMIT_REVOCATION_WAIT_FOR_PEER_REVIEW);
    }
}
