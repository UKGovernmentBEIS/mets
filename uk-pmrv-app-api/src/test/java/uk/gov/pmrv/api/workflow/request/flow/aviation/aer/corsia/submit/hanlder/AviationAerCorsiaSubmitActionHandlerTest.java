...
class AviationAerCorsiaSubmitActionHandlerTest {

    @InjectMocks
    private AviationAerCorsiaSubmitActionHandler aviationAerCorsiaSubmitActionHandler;
    ...
    void process() {
        ...
        // Invoke
        aviationAerCorsiaSubmitActionHandler.process(requestTaskId, RequestTaskActionType.AVIATION_AER_CORSIA_SUBMIT_APPLICATION, user, payload);
    ...
    @Test
    void getTypes() {
        assertThat(aviationAerCorsiaSubmitActionHandler.getTypes()).containsOnly(RequestTaskActionType.AVIATION_AER_CORSIA_SUBMIT_APPLICATION);
    }
}
