...
class NerReviewUploadAttachmentServiceTest {

    @InjectMocks
    private NerReviewUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(NerApplicationReviewRequestTaskPayload.builder().build())
            .build();
