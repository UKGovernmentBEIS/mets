...
class EmpIssuanceUkEtsWaitForPeerReviewInitializerTest {

    @InjectMocks
    private EmpIssuanceUkEtsWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.EMP_ISSUANCE_UKETS_WAIT_FOR_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpIssuanceUkEtsApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_ISSUANCE_UKETS_WAIT_FOR_PEER_REVIEW);
    }

    @Test
    void getRequestTaskPayloadType() {
        assertEquals(RequestTaskPayloadType.EMP_ISSUANCE_UKETS_WAIT_FOR_PEER_REVIEW_PAYLOAD, initializer.getRequestTaskPayloadType());
    }
}