...
class AviationAerUkEtsApplicationSkippedCustomMapperTest {
    
    @InjectMocks
    private AviationAerUkEtsApplicationSkippedCustomMapper mapper;
    ...
    void toRequestActionDTO() {
        ...
        RequestAction requestAction = RequestAction.builder()
            .type(RequestActionType.AVIATION_AER_UKETS_APPLICATION_REVIEW_SKIPPED)
    ...
    void getRequestActionType() {
        assertEquals(RequestActionType.AVIATION_AER_UKETS_APPLICATION_REVIEW_SKIPPED, mapper.getRequestActionType());
    }
