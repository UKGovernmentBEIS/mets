...
class EmpVariationCorsiaApprovedHandlerFlowableTest {
    ...
    @InjectMocks
    private EmpVariationCorsiaApprovedHandlerFlowable handler;
    ...
    void execute_callsServiceUpdateEmp_withRequestId() {
        ...
        verify(empVariationCorsiaUpdateEmpService).updateEmp(requestId);
        verifyNoMoreInteractions(empVariationCorsiaUpdateEmpService);
    }
}
