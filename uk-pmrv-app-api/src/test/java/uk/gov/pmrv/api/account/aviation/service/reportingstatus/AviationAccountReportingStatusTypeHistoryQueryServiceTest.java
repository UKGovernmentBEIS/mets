...
class AviationAccountReportingStatusTypeHistoryQueryServiceTest {
    ...
    void getReportingStatusHistoryListResponse() {
        Long accountId = 1L;
        AviationAccountReportingStatusType status = AviationAccountReportingStatusType.REQUIRED_TO_REPORT;
