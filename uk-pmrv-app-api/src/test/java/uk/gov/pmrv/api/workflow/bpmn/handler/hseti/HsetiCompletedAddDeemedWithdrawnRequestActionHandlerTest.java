...
public class HsetiCompletedAddDeemedWithdrawnRequestActionHandlerTest {

    @InjectMocks
    private HsetiCompletedAddDeemedWithdrawnRequestActionHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(completeService, times(1)).addDeemedWithdrawnRequestAction(requestId);
    }
}
