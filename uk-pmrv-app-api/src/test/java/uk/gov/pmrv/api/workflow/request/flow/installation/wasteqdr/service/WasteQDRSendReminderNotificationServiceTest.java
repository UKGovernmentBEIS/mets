...
public class WasteQDRSendReminderNotificationServiceTest {
    ...
    void sendFirstReminderNotification() {
        final String requestId = "WQDR-0001-Q3";
        ...
        final NotificationTemplateExpirationReminderParams params = NotificationTemplateExpirationReminderParams.builder()
                .workflowTask(NotificationTemplateWorkflowTaskType.WASTE_QDR.getDescription())
