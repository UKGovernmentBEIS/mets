...
class NonComplianceDailyPenaltyNoticeWaitForPeerReviewInitializerTest {

    @InjectMocks
    private NonComplianceDailyPenaltyNoticeWaitForPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NonComplianceDailyPenaltyNoticeRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_WAIT_FOR_PEER_REVIEW_PAYLOAD)
            .build());
    }
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactlyInAnyOrder(
            RequestTaskType.NON_COMPLIANCE_DAILY_PENALTY_NOTICE_WAIT_FOR_PEER_REVIEW,
            RequestTaskType.AVIATION_NON_COMPLIANCE_DAILY_PENALTY_NOTICE_WAIT_FOR_PEER_REVIEW);
    }
