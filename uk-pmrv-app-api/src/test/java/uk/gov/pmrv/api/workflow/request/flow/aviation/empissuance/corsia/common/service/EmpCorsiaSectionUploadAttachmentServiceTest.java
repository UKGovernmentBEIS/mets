...
class EmpCorsiaSectionUploadAttachmentServiceTest {

    @InjectMocks
    private EmpCorsiaSectionUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        RequestTask requestTask = RequestTask.builder()
            .id(requestTaskId)
            .payload(EmpIssuanceCorsiaApplicationSubmitRequestTaskPayload.builder().build())
            .build();
