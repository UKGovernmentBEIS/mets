...
class AlrGenerateOfficialNoticeHandlerFlowableTest {
    ...
    @InjectMocks
    private AlrGenerateOfficialNoticeHandlerFlowable handler;
    ...
    void execute_shouldGenerateAndSaveProceededToAuthorityOfficialNotice() {
        ...
        verify(alrOfficialNoticeService).generateAndSaveProceededToAuthorityOfficialNotice(requestId);
    }
    ...
    void execute_shouldPassNullRequestId_whenExecutionVariableMissing() {
        ...
        handler.execute(execution);
        verify(alrOfficialNoticeService).generateAndSaveProceededToAuthorityOfficialNotice(null);
    }
}
