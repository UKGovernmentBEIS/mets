package uk.gov.pmrv.api.integration.registry.accountupdated.aviation;
...
import uk.gov.pmrv.api.integration.registry.accountupdated.aviation.response.AviationAccountUpdatedResponseHandler;
...
public class AviationAccountUpdatedResponseHandlerTest {
    ...
    @InjectMocks
    private AviationAccountUpdatedResponseHandler handler;
    ...
    void test_without_registry_id() {
        ...
        when(accountQueryService.getAccountByRegistryId(Integer.valueOf(TEST_REGISTRY_ID))).thenReturn(null);
