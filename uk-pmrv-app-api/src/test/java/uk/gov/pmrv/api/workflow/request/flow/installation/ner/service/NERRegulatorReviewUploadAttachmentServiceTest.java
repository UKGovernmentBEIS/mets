...
public class NERRegulatorReviewUploadAttachmentServiceTest {

    @InjectMocks
    private NERRegulatorReviewUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
                .id(requestTaskId)
                .payload(NERApplicationRegulatorReviewSubmitRequestTaskPayload.builder().build())
                .build();
