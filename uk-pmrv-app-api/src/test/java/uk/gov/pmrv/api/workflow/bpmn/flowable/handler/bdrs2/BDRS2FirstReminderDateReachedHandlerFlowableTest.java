...
class BDRS2FirstReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private BDRS2FirstReminderDateReachedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(bdrs2SendReminderNotificationService).sendFirstReminderNotification(requestId, expirationDate);
    }
}
