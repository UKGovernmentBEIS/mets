...
class EmpIssuanceUkEtsReviewRequestPeerReviewActionHandlerTest {

    @InjectMocks
    private EmpIssuanceUkEtsReviewRequestPeerReviewActionHandler handler;
    ...
    void process() {
        ...
        RequestTaskActionType requestTaskActionType = RequestTaskActionType.EMP_ISSUANCE_UKETS_REQUEST_PEER_REVIEW;
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.EMP_ISSUANCE_UKETS_REQUEST_PEER_REVIEW);
    }
}