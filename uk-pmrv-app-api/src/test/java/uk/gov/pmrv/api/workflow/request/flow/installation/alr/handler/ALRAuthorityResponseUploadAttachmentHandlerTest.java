...
public class ALRAuthorityResponseUploadAttachmentHandlerTest {

    @InjectMocks
    private ALRAuthorityResponseUploadAttachmentHandler handler;

    @Mock
    private ALRAuthorityResponseUploadAttachmentService attachmentService;
    ...
    @Test
    void getTypes() {
        assertThat(handler.getType()).isEqualTo(RequestTaskActionType.ALR_AUTHORITY_RESPONSE_UPLOAD_ATTACHMENT);
    }
}
