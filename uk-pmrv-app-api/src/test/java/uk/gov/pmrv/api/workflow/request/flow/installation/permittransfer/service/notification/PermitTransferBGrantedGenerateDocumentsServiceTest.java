...
import uk.gov.pmrv.api.workflow.request.flow.installation.permittransfer.service.notification.PermitTransferBOfficialNoticeService;

@ExtendWith(MockitoExtension.class)
class PermitTransferBGrantedGenerateDocumentsServiceTest {

	@InjectMocks
    private PermitTransferBGrantedGenerateDocumentsService cut;
    ...
    @Mock
    private PermitTransferBOfficialNoticeService permitTransferBOfficialNoticeService;
    ...
    void generateDocuments() {
    	...
    	when(permitTransferBOfficialNoticeService.generateGrantedOfficialNotice(requestId))
    	...
    	verify(permitTransferBOfficialNoticeService, times(1)).generateGrantedOfficialNotice(requestId);
