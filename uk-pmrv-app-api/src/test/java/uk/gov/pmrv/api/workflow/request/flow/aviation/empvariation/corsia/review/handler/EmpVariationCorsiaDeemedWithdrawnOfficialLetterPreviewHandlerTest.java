...
class EmpVariationCorsiaDeemedWithdrawnOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private EmpVariationCorsiaDeemedWithdrawnOfficialLetterPreviewHandler handler;
    ...
    void generateDocument() {
        ...
        final TemplateParams templateParamsWithCustom = TemplateParams.builder()
            .accountParams(AviationAccountTemplateParams.builder().name(operatorName).build()).build();
        ...
        when(documentFileGeneratorService.generateFileDocument(
            ...
            "corsia_emp_variation_withdrawn.pdf")).thenReturn(fileDTO);
