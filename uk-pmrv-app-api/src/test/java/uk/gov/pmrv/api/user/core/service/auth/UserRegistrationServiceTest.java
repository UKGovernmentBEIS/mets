...
import static uk.gov.pmrv.api.common.exception.ErrorCode.USER_ALREADY_REGISTERED;
import static uk.gov.pmrv.api.user.core.domain.enumeration.AuthenticationStatus.DELETED;
