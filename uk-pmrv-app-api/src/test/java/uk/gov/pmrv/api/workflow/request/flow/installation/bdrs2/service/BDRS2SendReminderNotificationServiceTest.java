...
class BDRS2SendReminderNotificationServiceTest {

    @InjectMocks
    private BDRS2SendReminderNotificationService service;
    ...
    void sendFirstReminderNotification() {
        final String requestId = "BDRS2-00001-2025";
        ...
        final NotificationTemplateExpirationReminderParams params = NotificationTemplateExpirationReminderParams.builder()
                .workflowTask(NotificationTemplateWorkflowTaskType.BDRS2.getDescription())
