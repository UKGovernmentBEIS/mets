...
public class RequestTypeVerifierMapperServiceTest {

    @InjectMocks
    private RequestTypeVerifierMapperService service;
    ...
    public void getRequestTypes_installation() {
        AppUser appUser = AppUser.builder().userId("test").roleType(RoleTypeConstants.VERIFIER).build();
    ...
    public void getRoleType() {
        assertThat(service.getRoleType()).isEqualTo(RoleTypeConstants.VERIFIER);
    }
