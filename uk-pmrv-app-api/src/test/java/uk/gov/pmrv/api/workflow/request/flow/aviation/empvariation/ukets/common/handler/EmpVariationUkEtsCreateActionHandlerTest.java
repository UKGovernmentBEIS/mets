...
class EmpVariationUkEtsCreateActionHandlerTest {

	@InjectMocks
    private EmpVariationUkEtsCreateActionHandler handler;
	...
	void process_regulator() {
        ...
        EmissionsMonitoringPlanUkEtsDTO dto = createOriginalEmpData();
	...
	private EmissionsMonitoringPlanUkEtsDTO createOriginalEmpData() {
        ...
        EmissionsMonitoringPlanUkEtsDTO dto = EmissionsMonitoringPlanUkEtsDTO.builder().empContainer(originalEmpContainer).build();
