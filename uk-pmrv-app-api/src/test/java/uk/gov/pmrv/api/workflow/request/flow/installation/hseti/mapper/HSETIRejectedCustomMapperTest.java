...
public class HSETIRejectedCustomMapperTest {

    @InjectMocks
    private HSETIRejectedCustomMapper mapper;
    ...
    public void getRequestActionType() {
        ...
        assertThat(requestActionType).isEqualTo(RequestActionType.HSE_TI_REJECTED);
    }
