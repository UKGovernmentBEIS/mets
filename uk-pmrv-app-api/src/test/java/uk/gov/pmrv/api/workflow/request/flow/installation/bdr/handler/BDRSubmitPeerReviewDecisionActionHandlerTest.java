...
public class BDRSubmitPeerReviewDecisionActionHandlerTest {

    @InjectMocks
    private BDRSubmitPeerReviewDecisionActionHandler handler;
    ...
    void process() {
        ...
        PeerReviewDecisionRequestTaskActionPayload payload =
                PeerReviewDecisionRequestTaskActionPayload.builder()
                        .payloadType(RequestTaskActionPayloadType.BDR_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                        .decision(decision)
                        .build();
        ...
        verify(requestService, times(1)).addActionToRequest(
                ...
                eq(RequestActionType.BDR_APPLICATION_PEER_REVIEW_REJECTED),
                eq(userId));
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.BDR_APPLICATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.BDR_SUBMIT_PEER_REVIEW_DECISION);
    }
}
