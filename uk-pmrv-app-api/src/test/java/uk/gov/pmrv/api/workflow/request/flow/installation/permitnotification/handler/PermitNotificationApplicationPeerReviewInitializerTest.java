...
import uk.gov.pmrv.api.workflow.request.flow.installation.permitnotification.handler.PermitNotificationApplicationPeerReviewInitializer;
        ...
        final PermitNotificationReviewDecision decision = PermitNotificationReviewDecision.builder()
                ...
                .details(
                    PermitNotificationAcceptedDecisionDetails.builder()
                        .followUp(
                            FollowUp.builder()
                                .followUpResponseExpirationDate(LocalDate.now().plusDays(1))
                                .followUpResponseRequired(Boolean.TRUE)
