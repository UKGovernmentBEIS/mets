...
import uk.gov.pmrv.api.integration.registry.accountcreated.installation.response.InstallationAccountCreatedResponseEventListener;
import uk.gov.pmrv.api.integration.registry.accountcreated.installation.response.InstallationAccountCreatedResponseHandler;

import java.util.List;

class InstallationAccountCreatedEventListenerTest {
    ...
    @Mock
    private InstallationAccountCreatedResponseHandler handler;

    @InjectMocks
    private InstallationAccountCreatedResponseEventListener listener;
