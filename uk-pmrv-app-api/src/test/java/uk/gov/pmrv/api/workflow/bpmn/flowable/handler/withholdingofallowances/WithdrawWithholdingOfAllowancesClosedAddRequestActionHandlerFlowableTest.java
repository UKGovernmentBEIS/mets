...
class WithdrawWithholdingOfAllowancesClosedAddRequestActionHandlerFlowableTest {
    ...
    @InjectMocks
    private WithdrawWithholdingOfAllowancesClosedAddRequestActionHandlerFlowable handler;

    @Test
    void execute_callsServiceClose_withRequestId() {
