...
class DoalApplicationWaitForPeerReviewInitializerRequestTaskHandlerTest {

    @InjectMocks
    private DoalApplicationWaitForPeerReviewInitializerRequestTaskHandler initializer;
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, DoalApplicationSubmitRequestTaskPayload.builder()
                .payloadType(RequestTaskPayloadType.DOAL_WAIT_FOR_PEER_REVIEW_PAYLOAD)
                .doal(Doal.builder().build())
                .build());
    }
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.DOAL_WAIT_FOR_PEER_REVIEW);
    }
}
