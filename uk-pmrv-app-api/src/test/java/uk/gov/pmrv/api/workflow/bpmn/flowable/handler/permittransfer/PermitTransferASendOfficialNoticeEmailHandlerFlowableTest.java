...
class PermitTransferASendOfficialNoticeEmailHandlerFlowableTest {
    ...
    @InjectMocks
    private PermitTransferASendOfficialNoticeEmailHandlerFlowable handler;

    @Test
    void execute_callsSendOfficialNoticeWithRequestIdFromExecution() {
