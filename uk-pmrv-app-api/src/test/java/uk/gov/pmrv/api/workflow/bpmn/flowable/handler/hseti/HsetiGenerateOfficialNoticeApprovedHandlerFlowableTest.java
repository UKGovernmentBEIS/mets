...
class HsetiGenerateOfficialNoticeApprovedHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiGenerateOfficialNoticeApprovedHandlerFlowable handler;
    ...
    void execute_shouldCallOfficialNoticeService() {
        ...
        verify(officialNoticeService).generateOfficialNoticeApproved("REQ-1");
