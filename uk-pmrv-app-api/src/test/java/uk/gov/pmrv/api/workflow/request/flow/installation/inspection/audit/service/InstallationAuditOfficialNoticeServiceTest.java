...
public class InstallationAuditOfficialNoticeServiceTest {
    ...
    @Test
    void generateInstallationAuditSubmittedOfficialNotice() throws InterruptedException, ExecutionException {
        String requestId = "1";
        String fileName = "INSTALLATION_AUDIT_notice.pdf";
        ...
        DocumentTemplateParamsSourceData documentTemplateSourceParams =
                DocumentTemplateParamsSourceData.builder()
                        .contextActionType(DocumentTemplateGenerationContextActionType.INSTALLATION_AUDIT_SUBMITTED)
                        .request(request)
        ...
        when(documentFileGeneratorService.generateAndSaveFileDocument(
                DocumentTemplateType.INSTALLATION_AUDIT_SUBMITTED, templateParams, fileName))
                .thenReturn(officialDocFileInfoDTO);


        // Invoke
        service.generateInstallationAuditSubmittedOfficialNotice(requestId);
