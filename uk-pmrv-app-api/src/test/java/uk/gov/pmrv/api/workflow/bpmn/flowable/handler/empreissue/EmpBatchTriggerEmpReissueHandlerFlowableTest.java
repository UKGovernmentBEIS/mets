...
class EmpBatchTriggerEmpReissueHandlerFlowableTest {

	@InjectMocks
	private EmpBatchTriggerEmpReissueHandlerFlowable cut;

	@Mock
	private ReissueCreateRequestService reissueCreateRequestService;
	...
	void execute() {
		...
		verify(reissueCreateRequestService, times(1)).createReissueRequest(accountId, requestId, requestBusinessKey);
	}
}
