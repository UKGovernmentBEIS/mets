...
class CalculateAerExpirationRemindersHandlerFlowableTest {

    @InjectMocks
    private CalculateAerExpirationRemindersHandlerFlowable handler;
    ...
    void execute() {
        ...
        when(requestExpirationVarsBuilder.buildExpirationVars(RequestExpirationType.AER, expirationDate))
                .thenReturn(vars);
        ...
        verify(requestExpirationVarsBuilder, times(1))
                .buildExpirationVars(RequestExpirationType.AER, expirationDate);
