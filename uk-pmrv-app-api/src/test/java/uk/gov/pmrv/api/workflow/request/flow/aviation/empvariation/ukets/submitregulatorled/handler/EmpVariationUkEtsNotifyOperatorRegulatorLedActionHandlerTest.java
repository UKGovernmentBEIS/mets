...
class EmpVariationUkEtsNotifyOperatorRegulatorLedActionHandlerTest {

	@InjectMocks
    private EmpVariationUkEtsNotifyOperatorRegulatorLedActionHandler cut;
	...
	@Mock
	private EmpVariationUkEtsNotifyOperatorRegulatorLedValidator validator;
	...
	void getTypes() {
		assertThat(cut.getTypes())
				.containsExactly(RequestTaskActionType.EMP_VARIATION_UKETS_NOTIFY_OPERATOR_FOR_DECISION_REGULATOR_LED);
	}
}
