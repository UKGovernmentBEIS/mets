...
class HsetiGenerateOfficialNoticeDeemedWithdrawnHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiGenerateOfficialNoticeDeemedWithdrawnHandlerFlowable handler;
    ...
    void execute_shouldCallOfficialNoticeService() {
        ...
        verify(officialNoticeService).generateOfficialNoticeDeemedWithdrawn("REQ-1");
