...
class AviationAerUkEtsSubmitActionHandlerTest {

    @InjectMocks
    private AviationAerUkEtsSubmitActionHandler aviationAerUkSubmitActionHandler;
    ...
    void process() {
        ...
        AviationAerUkEtsSubmitApplicationRequestTaskActionPayload payload = AviationAerUkEtsSubmitApplicationRequestTaskActionPayload.builder()
        ...
        verify(requestAviationAerUkEtsSubmitService, times(1)).sendToRegulator(payload, task, user);
