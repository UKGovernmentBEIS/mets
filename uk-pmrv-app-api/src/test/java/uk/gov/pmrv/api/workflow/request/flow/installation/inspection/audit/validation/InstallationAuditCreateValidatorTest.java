...
public class InstallationAuditCreateValidatorTest {

    @InjectMocks
    private InstallationAuditCreateValidator validator;
    ...
    @Test
    void getType() {
        assertThat(validator.getType()).isEqualTo(RequestCreateActionType.INSTALLATION_AUDIT);
    }
