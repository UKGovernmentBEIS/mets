...
class PermitTransferAGrantedGenerateOfficialNoticeHandlerFlowableTest {
    ...
    @InjectMocks
    private PermitTransferAGrantedGenerateOfficialNoticeHandlerFlowable handler;

    @Test
    void execute_callsGenerateAndSaveGrantedOfficialNoticeWithRequestIdFromExecution() {
