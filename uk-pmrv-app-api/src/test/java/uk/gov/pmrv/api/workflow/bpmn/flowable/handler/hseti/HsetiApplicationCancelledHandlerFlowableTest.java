...
class HsetiApplicationCancelledHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiApplicationCancelledHandlerFlowable handler;
    ...
    void execute_shouldCancel() {
        ...
        verify(submitService).cancel("REQ-1");
        verifyNoMoreInteractions(submitService);
    }
}
