...
class AviationVirRespondFirstReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private AviationVirRespondFirstReminderDateReachedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(virSendReminderNotificationService, times(1)).sendRespondFirstReminderNotification(requestId, date);
    }
}
