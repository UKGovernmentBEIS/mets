...
public class ALRApplicationAmendsSubmittedVerificationReportOpinionStatementNotesMapperTest {

    @InjectMocks
    private ALRApplicationAmendsSubmittedVerificationReportOpinionStatementNotesMapper mapper;
    ...
    public void getRequestActionType() {
        ...
        assertThat(requestActionType).isEqualTo(RequestActionType.ALR_APPLICATION_AMENDS_SUBMITTED);
    }
