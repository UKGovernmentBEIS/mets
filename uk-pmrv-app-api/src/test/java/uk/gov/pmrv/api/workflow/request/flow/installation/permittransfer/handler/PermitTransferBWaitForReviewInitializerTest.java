...
class PermitTransferBWaitForReviewInitializerTest {

    @InjectMocks
    private PermitTransferBWaitForReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(
                RequestTaskPayloadType.PERMIT_TRANSFER_B_WAIT_FOR_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(PermitTransferBWaitForReviewRequestTaskPayload.class);

        PermitTransferBWaitForReviewRequestTaskPayload taskPayload =
                (PermitTransferBWaitForReviewRequestTaskPayload) requestTaskPayload;
    ...
    void getRequestTaskTypes() {
        assertEquals(initializer.getRequestTaskTypes(), Set.of(RequestTaskType.PERMIT_TRANSFER_B_WAIT_FOR_REVIEW));
    }
}