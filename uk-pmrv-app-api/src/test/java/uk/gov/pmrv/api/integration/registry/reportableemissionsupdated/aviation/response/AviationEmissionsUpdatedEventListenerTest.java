...
public class AviationEmissionsUpdatedEventListenerTest {

    private static final String TEST_CORRELATION_ID = "test-correlation-123";

    @Mock
    private AviationEmissionsUpdatedResponseHandler handler;

    @InjectMocks
    private AviationEmissionsUpdatedEventListener listener;
