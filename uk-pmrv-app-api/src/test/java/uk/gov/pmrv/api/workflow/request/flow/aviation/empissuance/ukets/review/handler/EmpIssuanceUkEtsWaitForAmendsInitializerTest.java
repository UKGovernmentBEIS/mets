...
class EmpIssuanceUkEtsWaitForAmendsInitializerTest {

	@InjectMocks
    private EmpIssuanceUkEtsWaitForAmendsInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.EMP_ISSUANCE_UKETS_WAIT_FOR_AMENDS_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpIssuanceUkEtsApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_ISSUANCE_UKETS_WAIT_FOR_AMENDS);
    }

    @Test
    void getRequestTaskPayloadType() {
        assertEquals(RequestTaskPayloadType.EMP_ISSUANCE_UKETS_WAIT_FOR_AMENDS_PAYLOAD, initializer.getRequestTaskPayloadType());
    }
}
