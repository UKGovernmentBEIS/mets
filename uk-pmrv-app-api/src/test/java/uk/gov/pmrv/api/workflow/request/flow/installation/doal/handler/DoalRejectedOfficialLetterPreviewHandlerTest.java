...
class DoalRejectedOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private DoalRejectedOfficialLetterPreviewHandler handler;
    ...
    void generateDocument() {
        ...
        final DoalRejectAuthorityResponse authorityResponse = DoalRejectAuthorityResponse.builder()
                ...
                .authorityRespondDate(LocalDate.of(2023, 1, 1))
                .build();
        ...
        when(documentFileGeneratorService.generateFileDocument(
                ...
                templateParams,
                "Activity_level_determination_not_approved_by_Authority_notice.pdf")).thenReturn(fileDTO);
