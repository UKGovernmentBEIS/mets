...
class EmpVariationCorsiaWaitForReviewInitializerTest {

	@InjectMocks
    private EmpVariationCorsiaWaitForReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.EMP_VARIATION_CORSIA_APPLICATION_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpVariationCorsiaApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_VARIATION_CORSIA_WAIT_FOR_REVIEW);
    }
}
