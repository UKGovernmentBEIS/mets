...
class EmpIssuanceCorsiaApplicationPeerReviewInitializerTest {

    @InjectMocks
    private EmpIssuanceCorsiaApplicationPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        Request request = Request.builder()
            ...
            .payload(empIssuanceCorsiaRequestPayload)
            .build();
        ...
        assertThat(requestTaskPayload.getPayloadType()).isEqualTo(RequestTaskPayloadType.EMP_ISSUANCE_CORSIA_APPLICATION_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(EmpIssuanceCorsiaApplicationReviewRequestTaskPayload.class);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_ISSUANCE_CORSIA_APPLICATION_PEER_REVIEW);
    }

    @Test
    void getRequestTaskPayloadType() {
        assertEquals(RequestTaskPayloadType.EMP_ISSUANCE_CORSIA_APPLICATION_PEER_REVIEW_PAYLOAD, initializer.getRequestTaskPayloadType());
    }
}