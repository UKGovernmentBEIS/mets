...
class DoalAuthorityResponseUploadAttachmentHandlerTest {

    @InjectMocks
    private DoalAuthorityResponseUploadAttachmentHandler handler;

    @Mock
    private DoalAuthorityResponseUploadAttachmentService attachmentService;
    ...
    @Test
    void getTypes() {
        assertThat(handler.getType()).isEqualTo(RequestTaskActionType.DOAL_AUTHORITY_RESPONSE_UPLOAD_ATTACHMENT);
    }
}
