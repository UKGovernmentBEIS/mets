...
class AviationAerUkEtsRequestAmendsVerificationActionHandlerTest {

    @InjectMocks
    private AviationAerUkEtsRequestAmendsVerificationActionHandler amendsVerificationActionHandler;
    ...
    void process() {
        ...
        verify(workflowService, times(1)).completeTask(processTaskId,
            Map.of(BpmnProcessConstants.REQUEST_ID, requestId,
                ...
                BpmnProcessConstants.REQUEST_TYPE_DYNAMIC_TASK_PREFIX, RequestCustomContext.AVIATION_AER_UKETS_AMEND.getCode())
        );
    }

    @Test
    void getTypes() {
        assertThat(amendsVerificationActionHandler.getTypes()).containsOnly(RequestTaskActionType.AVIATION_AER_UKETS_REQUEST_AMENDS_VERIFICATION);
    }
}