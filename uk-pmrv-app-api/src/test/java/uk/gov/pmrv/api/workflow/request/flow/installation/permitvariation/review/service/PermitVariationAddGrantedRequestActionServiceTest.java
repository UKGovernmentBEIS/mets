...
public class PermitVariationAddGrantedRequestActionServiceTest {

	@InjectMocks
    private PermitVariationAddGrantedRequestActionService cut;
    ...
    void add() {
        ...
        PermitVariationApplicationGrantedRequestActionPayload expectedActionPayload = PermitVariationApplicationGrantedRequestActionPayload.builder()
        ...
        verify(requestService, times(1)).addActionToRequest(request, expectedActionPayload, RequestActionType.PERMIT_VARIATION_APPLICATION_GRANTED, requestPayload.getRegulatorReviewer());
    }
}
