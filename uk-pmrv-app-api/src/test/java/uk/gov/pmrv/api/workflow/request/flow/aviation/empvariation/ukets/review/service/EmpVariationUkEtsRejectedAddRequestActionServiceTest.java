...
class EmpVariationUkEtsRejectedAddRequestActionServiceTest {
    ...
    void addRequestAction() {
        ...
        EmpVariationUkEtsApplicationRejectedRequestActionPayload requestActionPayload = EmpVariationUkEtsApplicationRejectedRequestActionPayload.builder()
                .payloadType(RequestActionPayloadType.EMP_VARIATION_UKETS_APPLICATION_REJECTED_PAYLOAD)
                .determination(determination)
                .decisionNotification(decisionNotification)
                .usersInfo(usersInfo)
                .build();
        ...
        verify(requestService, times(1))
            .addActionToRequest(request, requestActionPayload,  RequestActionType.EMP_VARIATION_UKETS_APPLICATION_REJECTED, regulatorUser);
    }
}
