...
class AviationDoECorsiaAddSubmittedRequestActionHandlerFlowableTest {

    @InjectMocks
    private AviationDoECorsiaAddSubmittedRequestActionHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(service, times(1)).addSubmittedRequestAction(requestId);
    }
}
