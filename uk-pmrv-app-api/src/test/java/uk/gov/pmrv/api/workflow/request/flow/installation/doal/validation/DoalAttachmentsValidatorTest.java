...
class DoalAttachmentsValidatorTest {

    @InjectMocks
    private DoalAttachmentsValidator validator;
    ...
    void attachmentsExistInSections() {
        ...
        UUID attachment2 = UUID.randomUUID();
        final Set<UUID> sectionAttachments = Set.of(attachment1, attachment2);
        final Set<UUID> doalAttachments = Set.of(attachment1, attachment2, UUID.randomUUID());
