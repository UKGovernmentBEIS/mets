package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.air;
...
class CalculateAirRespondExpirationRemindersHandlerTest {

    @InjectMocks
    private CalculateAirRespondExpirationRemindersHandler handler;
    ...
    void execute() throws Exception {
        ...
        final String requestId = "AIR-2022-2";
        ...
        when(expirationDateService.calculateExpirationDate(requestId))
                .thenReturn(expirationDate);
        when(requestExpirationVarsBuilder.buildExpirationVars(RequestExpirationType.AIR, expirationDate))
                .thenReturn(vars);
        ...
        verify(expirationDateService, times(1))
                .calculateExpirationDate(requestId);
        verify(requestExpirationVarsBuilder, times(1))
                .buildExpirationVars(RequestExpirationType.AIR, expirationDate);
