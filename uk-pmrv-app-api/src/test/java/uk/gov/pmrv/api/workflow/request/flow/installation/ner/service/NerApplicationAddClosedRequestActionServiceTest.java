...
class NerApplicationAddClosedRequestActionServiceTest {

    @InjectMocks
    private NerApplicationAddClosedRequestActionService service;
    ...
    void execute() {
        ...
        final Request request = Request.builder()
            ...
            .accountId(accountId)
            .build();
        final NerApplicationEndedRequestActionPayload actionPayload = NerApplicationEndedRequestActionPayload.builder()
        ...
        verify(requestService, times(1)).addActionToRequest(request,
            actionPayload,
            RequestActionType.NER_APPLICATION_CLOSED,
            "reviewer");
