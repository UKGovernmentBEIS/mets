...
public class AlrSendOfficialNoticeEmailHandlerTest {

    @InjectMocks
    private AlrSendOfficialNoticeEmailHandler handler;
    ...
    void execute() {
        ...
        verify(alrOfficialNoticeService, times(1)).sendOfficialNotice(requestId);
    }
}
