...
class EmpIssuanceCorsiaWaitForReviewInitializerTest {

    @InjectMocks
    private EmpIssuanceCorsiaWaitForReviewInitializer initializer;
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_ISSUANCE_CORSIA_WAIT_FOR_REVIEW);
    }
