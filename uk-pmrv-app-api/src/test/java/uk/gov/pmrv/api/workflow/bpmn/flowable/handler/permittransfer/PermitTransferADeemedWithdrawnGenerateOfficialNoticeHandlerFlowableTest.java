...
class PermitTransferADeemedWithdrawnGenerateOfficialNoticeHandlerFlowableTest {
    ...
    @InjectMocks
    private PermitTransferADeemedWithdrawnGenerateOfficialNoticeHandlerFlowable handler;
