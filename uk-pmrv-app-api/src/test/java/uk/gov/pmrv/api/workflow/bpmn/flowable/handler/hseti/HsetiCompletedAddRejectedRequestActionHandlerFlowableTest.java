...
class HsetiCompletedAddRejectedRequestActionHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiCompletedAddRejectedRequestActionHandlerFlowable handler;
    ...
    void execute_shouldCallCompleteService() {
        ...
        verify(completeService).addRejectedRequestAction("REQ-1");
