...
import uk.gov.pmrv.api.workflow.request.flow.installation.permittransfer.handler.PermitTransferBApplicationAmendsSubmitInitializer;

@ExtendWith(MockitoExtension.class)
public class PermitTransferBApplicationAmendsSubmitInitializerTest {

    @InjectMocks
    private PermitTransferBApplicationAmendsSubmitInitializer initializer;
    ...
    void initialize() {
        ...
        final PermitTransferBApplicationAmendsSubmitRequestTaskPayload result =
            (PermitTransferBApplicationAmendsSubmitRequestTaskPayload) initializer.initializePayload(request);

        assertEquals(RequestTaskPayloadType.PERMIT_TRANSFER_B_APPLICATION_AMENDS_SUBMIT_PAYLOAD,
