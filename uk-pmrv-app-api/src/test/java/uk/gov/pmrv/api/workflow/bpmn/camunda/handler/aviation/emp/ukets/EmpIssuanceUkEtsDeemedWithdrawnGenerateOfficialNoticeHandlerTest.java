package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.aviation.emp.ukets;
...
class EmpIssuanceUkEtsDeemedWithdrawnGenerateOfficialNoticeHandlerTest {

    @InjectMocks
    private EmpIssuanceUkEtsDeemedWithdrawnGenerateOfficialNoticeHandler handler;
