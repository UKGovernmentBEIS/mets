...
class AviationAerUkEtsReviewUploadAttachmentServiceTest {

    @InjectMocks
    private AviationAerUkEtsReviewUploadAttachmentService uploadAttachmentService;
    ...
    void uploadAttachment() {
        ...
        AviationAerUkEtsApplicationReviewRequestTaskPayload requestTaskPayload = AviationAerUkEtsApplicationReviewRequestTaskPayload.builder().build();
