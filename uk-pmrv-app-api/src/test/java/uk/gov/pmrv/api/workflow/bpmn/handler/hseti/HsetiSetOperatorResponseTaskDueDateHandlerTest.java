...
public class HsetiSetOperatorResponseTaskDueDateHandlerTest {


    @InjectMocks
    private HsetiSetOperatorResponseTaskDueDateHandler handler;
    ...
    void execute() throws Exception {
        ...
        final String requestId = "HSETI00001-2021_2025";
        ...
        verify(requestTaskTimeManagementService, times(1)).setDueDateToTasks(requestId, RequestExpirationType.HSETI,
            expirationDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
        verify(execution, times(1)).getVariable(BpmnProcessConstants.REQUEST_ID);
        verify(execution, times(1)).getVariable(BpmnProcessConstants.HSE_TI_EXPIRATION_DATE);
    }
}
