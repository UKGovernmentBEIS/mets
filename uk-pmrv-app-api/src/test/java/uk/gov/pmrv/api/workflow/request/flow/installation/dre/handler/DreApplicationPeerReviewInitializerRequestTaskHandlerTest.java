...
class DreApplicationPeerReviewInitializerRequestTaskHandlerTest {

	@InjectMocks
    private DreApplicationPeerReviewInitializerRequestTaskHandler cut;
	...
	void initializePayload() {
		...
		assertThat(result.getPayloadType()).isEqualTo(RequestTaskPayloadType.DRE_APPLICATION_PEER_REVIEW_PAYLOAD);
		...
		assertThat(result).isEqualTo(DreApplicationSubmitRequestTaskPayload.builder()
				.payloadType(RequestTaskPayloadType.DRE_APPLICATION_PEER_REVIEW_PAYLOAD).dre(dre).build());
	}
