...
class AviationVirRespondSetTaskDueDateHandlerFlowableTest {

    @InjectMocks
    private AviationVirRespondSetTaskDueDateHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(requestTaskTimeManagementService, times(1)).setDueDateToTasks(requestId, RequestExpirationType.AVIATION_VIR,
