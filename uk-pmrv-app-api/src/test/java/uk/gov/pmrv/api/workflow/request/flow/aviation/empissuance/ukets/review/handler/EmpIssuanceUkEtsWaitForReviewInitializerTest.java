...
class EmpIssuanceUkEtsWaitForReviewInitializerTest {

    @InjectMocks
    private EmpIssuanceUkEtsWaitForReviewInitializer initializer;
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_ISSUANCE_UKETS_WAIT_FOR_REVIEW);
    }
