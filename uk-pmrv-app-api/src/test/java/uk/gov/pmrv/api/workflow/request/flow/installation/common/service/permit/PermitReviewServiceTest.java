...
class PermitReviewServiceTest {
	...
	void cleanUpDeprecatedReviewGroupDecisions() {
		...
		reviewGroupDecisions.put(PermitReviewGroup.CALCULATION_CO2, PermitIssuanceReviewDecision.builder().build());
		...
		Set<MonitoringApproachType> newMonitoringApproaches = Set.of(MonitoringApproachType.FALLBACK, MonitoringApproachType.CALCULATION_PFC);
	...
	void cleanUpDeprecatedReviewGroupDecisions_no_removing() {
		...
		Set<MonitoringApproachType> newMonitoringApproaches = Set.of(MonitoringApproachType.FALLBACK, MonitoringApproachType.CALCULATION_CO2, MonitoringApproachType.CALCULATION_PFC);
		
		cut.cleanUpDeprecatedReviewGroupDecisions(taskPayload, newMonitoringApproaches);
		
		assertThat(taskPayload.getReviewGroupDecisions().keySet())
				.containsExactlyInAnyOrder(PermitReviewGroup.CONFIDENTIALITY_STATEMENT, PermitReviewGroup.FALLBACK, PermitReviewGroup.CALCULATION_CO2);
	}
