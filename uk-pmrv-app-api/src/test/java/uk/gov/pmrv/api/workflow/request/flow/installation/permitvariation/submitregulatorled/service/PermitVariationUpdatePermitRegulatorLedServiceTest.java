...
class PermitVariationUpdatePermitRegulatorLedServiceTest {

	@InjectMocks
    private PermitVariationUpdatePermitRegulatorLedService cut;
    ...
    void updatePermitUponSubmit() {
    	...
    	cut.updatePermitUponSubmit(requestId);
