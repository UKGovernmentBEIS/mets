...
class EmpVariationCorsiaReviewRequestPeerReviewActionHandlerTest {

	@InjectMocks
    private EmpVariationCorsiaReviewRequestPeerReviewActionHandler handler;
    ...
    void process() {
        ...
        RequestTaskActionType requestTaskActionType = RequestTaskActionType.EMP_VARIATION_CORSIA_REQUEST_PEER_REVIEW;
        ...
        verify(requestService, times(1))
            .addActionToRequest(requestTask.getRequest(), null, 
            		RequestActionType.EMP_VARIATION_CORSIA_PEER_REVIEW_REQUESTED, pmrvUser.getUserId());
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.EMP_VARIATION_CORSIA_REQUEST_PEER_REVIEW);
    }
}
