...
public class AviationDoECorsiaOfficialNoticeGenerateServiceTest {
    ...
    void generateOfficialNotice() {
        ...
        String filename = "DoE_notice.pdf";
        ...
        when(documentFileGeneratorService
                .generateAndSaveFileDocument(DocumentTemplateType.AVIATION_DOE_SUBMITTED, templateParams, "DoE_notice.pdf"))
        ...
        verify(documentFileGeneratorService, times(1)).generateAndSaveFileDocument(
                DocumentTemplateType.AVIATION_DOE_SUBMITTED, templateParams, filename);
