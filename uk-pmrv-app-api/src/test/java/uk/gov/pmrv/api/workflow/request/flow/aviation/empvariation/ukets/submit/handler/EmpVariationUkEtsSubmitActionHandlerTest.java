...
class EmpVariationUkEtsSubmitActionHandlerTest {

	@InjectMocks
    private EmpVariationUkEtsSubmitActionHandler handler;
	...
	void process() {
		...
		RequestTaskActionType requestTaskActionType = RequestTaskActionType.EMP_VARIATION_UKETS_SUBMIT_APPLICATION;
        ...
        verify(service, times(1)).submitEmpVariation(requestTask, pmrvUser);
	...
	void getTypes() {
		assertThat(handler.getTypes())
				.containsExactlyInAnyOrder(RequestTaskActionType.EMP_VARIATION_UKETS_SUBMIT_APPLICATION);
	}
}
