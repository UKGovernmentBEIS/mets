...
public class WasteQDRApplicationSubmitInitializerTest {

    @InjectMocks
    private WasteQDRApplicationSubmitInitializer initializer;
    ...
    void initializePayload() {
        ...
        WasteQDRApplicationSubmitRequestTaskPayload taskPayload = WasteQDRApplicationSubmitRequestTaskPayload
                .builder()
                .payloadType(RequestTaskPayloadType.WASTE_QDR_SUBMIT_PAYLOAD)
                .qdr( ((WasteQDRRequestPayload) request.getPayload()).getQdr())
                .build();

        WasteQDRApplicationSubmitRequestTaskPayload actualTaskPayload = (WasteQDRApplicationSubmitRequestTaskPayload) initializer.initializePayload(request);
    ...
    void getRequestTaskTypes(){
        ...
        assertThat(requestTaskTypes).containsExactlyInAnyOrder(RequestTaskType.WASTE_QDR_APPLICATION_SUBMIT);
    }
}
