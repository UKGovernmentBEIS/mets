...
class AviationAccountReportingStatusTypeHistoryControllerTest {
    ...
    void getReportingStatusHistory() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(CONTROLLER_PATH + "/history")
                ...
                .andExpect(jsonPath("reportingStatusHistoryList[0].status").value(AviationAccountReportingStatusType.REQUIRED_TO_REPORT.name()))
    ...
    void submitReportingStatus() throws Exception {
        ...
        final AviationAccountReportingStatusHistoryCreationDTO reportingStatusCreationDTO =
                AviationAccountReportingStatusHistoryCreationDTO.builder().year(Year.now()).status(AviationAccountReportingStatusType.REQUIRED_TO_REPORT).reason("reason").build();
