...
public class HSETISendReminderNotificationServiceTest {

    @InjectMocks
    private HSETISendReminderNotificationService service;
    ...
    void sendFirstReminderNotification() {
        ...
        final NotificationTemplateExpirationReminderParams params = NotificationTemplateExpirationReminderParams.builder()
            .workflowTask(NotificationTemplateWorkflowTaskType.HSETI.getDescription())
