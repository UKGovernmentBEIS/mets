...
class EmpVariationCorsiaPeerReviewDecisionActionHandlerTest {

	@InjectMocks
    private EmpVariationCorsiaPeerReviewDecisionActionHandler cut;
	...
	void getRequestTaskTypes() {
		assertThat(cut.getTypes()).containsExactly(RequestTaskActionType.EMP_VARIATION_CORSIA_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
	}
    ...
    void process() {
        ...
        PeerReviewDecisionRequestTaskActionPayload payload =
            PeerReviewDecisionRequestTaskActionPayload.builder()
                .payloadType(RequestTaskActionPayloadType.EMP_VARIATION_CORSIA_REVIEW_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                .decision(decision)
                .build();
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.EMP_VARIATION_CORSIA_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
