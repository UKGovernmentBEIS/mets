...
public class HsetiGenerateOfficialNoticeApprovedHandlerTest {

    @InjectMocks
    private HsetiGenerateOfficialNoticeApprovedHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(officialNoticeService, times(1))
                .generateOfficialNoticeApproved(requestId);
    }
