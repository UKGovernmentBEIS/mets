...
class EmpVariationUkEtsRequestQueryServiceTest {
    ...
    void findApprovedEmpIssuanceVariationRequests() {
        ...
        when(requestRepository.findByAccountIdAndTypeAndStatusOrderByEndDateDesc(accountId, RequestType.EMP_VARIATION_UKETS, RequestStatus.APPROVED))
