...
class EmpVariationCorsiaCreateValidatorTest {

	@InjectMocks
    private EmpVariationCorsiaCreateValidator validator;
    ...
    void validateAction_whenValid_thenOk() {
        ...
        Set<AccountStatus> applicableAccountStatuses = Set.of(AviationAccountStatus.LIVE);
        Set<RequestType> mutuallyExclusiveRequests = Set.of(RequestType.EMP_VARIATION_CORSIA);
    ...
    void getApplicableAccountStatuses() {
        Set<AccountStatus> accountStatuses = Set.of(AviationAccountStatus.LIVE);
    ...
    @Test
    void type() {
        assertThat(validator.getType()).isEqualTo(RequestCreateActionType.EMP_VARIATION_CORSIA);
    }
}
