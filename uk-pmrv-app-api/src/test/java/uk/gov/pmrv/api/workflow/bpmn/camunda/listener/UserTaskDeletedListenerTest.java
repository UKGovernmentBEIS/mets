package uk.gov.pmrv.api.workflow.bpmn.camunda.listener;
...
import uk.gov.pmrv.api.workflow.request.flow.common.taskhandler.DynamicUserTaskDeletedHandlerResolver;
...
class UserTaskDeletedListenerTest {
    ...
    void onTaskDeletedEvent_whenHandlerExists_thenHandlerDelete() {
        ...
        when(taskDelegate.getTaskDefinitionKey()).thenReturn(DynamicUserTaskDefinitionKey.WAIT_FOR_RFI_RESPONSE.name());
