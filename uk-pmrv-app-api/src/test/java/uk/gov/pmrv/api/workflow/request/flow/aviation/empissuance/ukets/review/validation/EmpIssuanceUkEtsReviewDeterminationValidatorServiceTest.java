...
class EmpIssuanceUkEtsReviewDeterminationValidatorServiceTest {

    @InjectMocks
    private EmpIssuanceUkEtsReviewDeterminationValidatorService reviewDeterminationValidatorService;

    @Spy
    private ArrayList<EmpIssuanceUkEtsReviewDeterminationTypeValidator> validators;

    @Mock
    private EmpIssuanceUkEtsReviewDeterminationApprovedValidator reviewDeterminationApprovedValidator;
