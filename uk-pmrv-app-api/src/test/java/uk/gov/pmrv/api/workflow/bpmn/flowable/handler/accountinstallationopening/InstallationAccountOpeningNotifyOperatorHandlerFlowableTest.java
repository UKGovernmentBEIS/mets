...
import uk.gov.pmrv.api.workflow.request.flow.installation.accountinstallationopening.handler.InstallationAccountOpeningNotifyOperatorService;

@ExtendWith(MockitoExtension.class)
class InstallationAccountOpeningNotifyOperatorHandlerFlowableTest {

	@InjectMocks
	private InstallationAccountOpeningNotifyOperatorHandlerFlowable handler;
