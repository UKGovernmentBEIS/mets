...
class EmpIssuanceUkEtsGrantedOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private EmpIssuanceUkEtsGrantedOfficialLetterPreviewHandler handler;
    ...
    @Test
    void getTypes() {
        assertIterableEquals(List.of(DocumentTemplateType.EMP_ISSUANCE_UKETS_GRANTED), handler.getTypes());
    }
