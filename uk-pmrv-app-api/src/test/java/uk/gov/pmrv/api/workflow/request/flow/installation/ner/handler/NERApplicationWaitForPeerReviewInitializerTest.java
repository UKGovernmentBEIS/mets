...
public class NERApplicationWaitForPeerReviewInitializerTest {

    private final NERApplicationWaitForPeerReviewInitializer initializer =
            new NERApplicationWaitForPeerReviewInitializer();
    ...
    void initializePayload() {
        ...
        assertThat(payload.getPayloadType())
                .isEqualTo(RequestTaskPayloadType.NER_WAIT_FOR_PEER_REVIEW_PAYLOAD);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
                .containsExactly(RequestTaskType.NER_WAIT_FOR_PEER_REVIEW);
    }
}
