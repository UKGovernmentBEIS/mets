...
class EmpIssuanceUkEtsSubmitApplicationAmendActionHandlerTest {
    ...
    void process() {
        ...
        // Invoke
        handler.process(requestTaskId, RequestTaskActionType.EMP_ISSUANCE_UKETS_SUBMIT_APPLICATION_AMEND, appUser, actionPayload);

        // Verify
        verify(requestTaskService, times(1)).findTaskById(requestTaskId);
        verify(requestEmpUkEtsReviewService, times(1)).submitAmend(actionPayload, requestTask, appUser);
