...
public class HsetiGenerateOfficialNoticeWithdrawnHandlerTest {

    @InjectMocks
    private HsetiGenerateOfficialNoticeWithdrawnHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(officialNoticeService, times(1))
                .generateOfficialNoticeWithdrawn(requestId);
    }
}
