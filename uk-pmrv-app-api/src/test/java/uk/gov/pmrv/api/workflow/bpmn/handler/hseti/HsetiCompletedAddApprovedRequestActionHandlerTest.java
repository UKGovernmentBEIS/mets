...
public class HsetiCompletedAddApprovedRequestActionHandlerTest {


    @InjectMocks
    private HsetiCompletedAddApprovedRequestActionHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(completeService, times(1)).addApprovedRequestAction(requestId);
    }
}
