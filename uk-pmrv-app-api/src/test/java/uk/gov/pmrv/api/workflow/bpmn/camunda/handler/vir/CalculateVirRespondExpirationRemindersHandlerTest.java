package uk.gov.pmrv.api.workflow.bpmn.camunda.handler.vir;
...
class CalculateVirRespondExpirationRemindersHandlerTest {

    @InjectMocks
    private CalculateVirRespondExpirationRemindersHandler handler;
    ...
    void execute() throws Exception {
        ...
        when(requestExpirationVarsBuilder.buildExpirationVars(RequestExpirationType.VIR, expirationDate))
                .thenReturn(vars);
        ...
        verify(requestExpirationVarsBuilder, times(1))
                .buildExpirationVars(RequestExpirationType.VIR, expirationDate);
