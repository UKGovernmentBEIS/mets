...
class NerApplicationPeerReviewInitializerTest {

    @InjectMocks
    private NerApplicationPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertEquals(requestTaskPayload, NerApplicationReviewRequestTaskPayload.builder()
            .payloadType(RequestTaskPayloadType.NER_APPLICATION_PEER_REVIEW_PAYLOAD)
            .build());
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes()).containsExactly(RequestTaskType.NER_APPLICATION_PEER_REVIEW);
    }
}
