...
class EmpIssuanceCorsiaGrantedOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private EmpIssuanceCorsiaGrantedOfficialLetterPreviewHandler handler;
    ...
    void initializePayload() {
        ...
        when(documentFileGeneratorService.generateFileDocument(
            ...
            templateParams,
            "corsia_emp_application_approved.pdf")).thenReturn(fileDTO);
    ...
    @Test
    void getTypes() {
        assertIterableEquals(List.of(DocumentTemplateType.EMP_ISSUANCE_CORSIA_GRANTED), handler.getTypes());
    }
