...
class AviationAerCorsiaReviewUploadAttachmentServiceTest {

    @InjectMocks
    private AviationAerCorsiaReviewUploadAttachmentService uploadAttachmentService;
    ...
    void uploadAttachment() {
        ...
        AviationAerCorsiaApplicationReviewRequestTaskPayload requestTaskPayload = AviationAerCorsiaApplicationReviewRequestTaskPayload.builder().build();
