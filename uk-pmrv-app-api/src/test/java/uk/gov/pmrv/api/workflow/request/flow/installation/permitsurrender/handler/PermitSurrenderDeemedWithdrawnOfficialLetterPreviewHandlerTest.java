...
public class PermitSurrenderDeemedWithdrawnOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private PermitSurrenderDeemedWithdrawnOfficialLetterPreviewHandler handler;
    ...
    void initializePayload() {
        ...
        when(documentFileGeneratorService.generateFileDocument(
                ...
                templateParams,
                "permit_surrender_deemed_withdrawn_notice.pdf")).thenReturn(fileDTO);
