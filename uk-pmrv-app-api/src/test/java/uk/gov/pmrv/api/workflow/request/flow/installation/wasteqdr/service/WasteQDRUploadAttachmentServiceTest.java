...
public class WasteQDRUploadAttachmentServiceTest {

    @InjectMocks
    private ALRUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        final RequestTask requestTask = RequestTask.builder()
                .id(requestTaskId)
                .payload(ALRApplicationSubmitRequestTaskPayload.builder().build())
                .build();
