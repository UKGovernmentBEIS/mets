...
public class HSETIApprovedCustomMapperTest {


    @InjectMocks
    private HSETIApprovedCustomMapper mapper;
    ...
    public void getRequestActionType() {
        ...
        assertThat(requestActionType).isEqualTo(RequestActionType.HSE_TI_APPROVED);
    }
