...
class EmpVariationCorsiaSubmitApplicationAmendActionHandlerTest {
    ...
    void process() {
        ...
        // Invoke
        handler.process(requestTaskId, RequestTaskActionType.EMP_VARIATION_CORSIA_SUBMIT_APPLICATION_AMEND, pmrvUser, actionPayload);

        // Verify
        verify(requestTaskService, times(1)).findTaskById(requestTaskId);
        verify(empVariationCorsiaAmendService, times(1)).submitAmend(actionPayload, requestTask, pmrvUser);
