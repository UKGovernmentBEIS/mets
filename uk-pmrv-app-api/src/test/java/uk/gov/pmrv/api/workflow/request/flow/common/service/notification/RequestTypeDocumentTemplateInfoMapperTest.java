...
class RequestTypeDocumentTemplateInfoMapperTest {
    ...
    void test() {
        ...
        assertThat(RequestTypeDocumentTemplateInfoMapper.getTemplateInfo(RequestType.EMP_VARIATION_UKETS)).isEqualTo("your application for an Emissions Monitoring Plan variation");
        assertThat(RequestTypeDocumentTemplateInfoMapper.getTemplateInfo(RequestType.SYSTEM_MESSAGE_NOTIFICATION)).isEqualTo("N/A");
        assertThat(RequestTypeDocumentTemplateInfoMapper.getTemplateInfo(RequestType.EMP_ISSUANCE_CORSIA)).isEqualTo("your application for an Emissions Monitoring Plan");
        assertThat(RequestTypeDocumentTemplateInfoMapper.getTemplateInfo(RequestType.EMP_VARIATION_CORSIA)).isEqualTo("your application for an Emissions Monitoring Plan variation");
    }
}
