...
class EmpVariationUkEtsPeerReviewDecisionRegulatorLedActionHandlerTest {

	@InjectMocks
    private EmpVariationUkEtsPeerReviewDecisionRegulatorLedActionHandler cut;
	...
	void getRequestTaskTypes() {
		assertThat(cut.getTypes()).containsExactly(RequestTaskActionType.EMP_VARIATION_UKETS_REVIEW_SUBMIT_PEER_REVIEW_DECISION_REGULATOR_LED);
	}
    ...
    void process() {
        ...
        PeerReviewDecisionRequestTaskActionPayload payload =
            PeerReviewDecisionRequestTaskActionPayload.builder()
                .payloadType(RequestTaskActionPayloadType.EMP_VARIATION_UKETS_REVIEW_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                .decision(decision)
                .build();
        ...
        verify(requestService, times(1)).addActionToRequest(
            ...
            eq(RequestActionType.EMP_VARIATION_UKETS_APPLICATION_PEER_REVIEWER_REJECTED),
            eq(userId));
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.EMP_VARIATION_UKETS_PEER_REVIEW_DECISION_REGULATOR_LED_SUBMITTED_PAYLOAD);
