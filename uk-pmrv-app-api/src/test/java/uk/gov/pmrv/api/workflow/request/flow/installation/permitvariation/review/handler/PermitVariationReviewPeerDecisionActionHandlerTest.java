...
class PermitVariationReviewPeerDecisionActionHandlerTest {

    @InjectMocks
    private PermitVariationReviewPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.PERMIT_VARIATION_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.PERMIT_VARIATION_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
