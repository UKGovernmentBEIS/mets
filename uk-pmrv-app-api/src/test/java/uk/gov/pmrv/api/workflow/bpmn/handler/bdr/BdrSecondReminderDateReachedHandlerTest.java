...
public class BdrSecondReminderDateReachedHandlerTest {

    @InjectMocks
    private BdrSecondReminderDateReachedHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(bdrSendReminderNotificationService).sendSecondReminderNotification(requestId, expirationDate);
    }
}
