...
class NerApplicationAddAcceptedWithCorrectionsRequestActionServiceTest {
    ...
    void execute() {
        ...
        service.acceptWithCorrections(requestId);

        verify(requestService, times(1)).findRequestById(requestId);
        verify(requestService, times(1)).addActionToRequest(request,
            actionPayload,
            RequestActionType.NER_APPLICATION_ACCEPTED_WITH_CORRECTIONS,
            "reviewer");
