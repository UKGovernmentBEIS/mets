...
public class AviationDoECorsiaSubmitPeerDecisionActionHandlerTest {

    @InjectMocks
    private AviationDoECorsiaSubmitPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        final PeerReviewDecisionRequestTaskActionPayload payload =
            PeerReviewDecisionRequestTaskActionPayload.builder()
                .payloadType(RequestTaskActionPayloadType.AVIATION_DOE_CORSIA_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
                .decision(decision)
                .build();
        ...
        verify(requestService, times(1)).addActionToRequest(
            ...
            eq(RequestActionType.AVIATION_DOE_CORSIA_PEER_REVIEWER_REJECTED),
            eq(userId));
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.AVIATION_DOE_CORSIA_SUBMIT_PEER_REVIEW_DECISION);
    }
}
