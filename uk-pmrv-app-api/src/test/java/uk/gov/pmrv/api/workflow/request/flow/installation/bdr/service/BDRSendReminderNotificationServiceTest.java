...
public class BDRSendReminderNotificationServiceTest {

    @InjectMocks
    private BDRSendReminderNotificationService service;
    ...
    void sendFirstReminderNotification() {
        ...
        final NotificationTemplateExpirationReminderParams params = NotificationTemplateExpirationReminderParams.builder()
            .workflowTask(NotificationTemplateWorkflowTaskType.BDR.getDescription())
