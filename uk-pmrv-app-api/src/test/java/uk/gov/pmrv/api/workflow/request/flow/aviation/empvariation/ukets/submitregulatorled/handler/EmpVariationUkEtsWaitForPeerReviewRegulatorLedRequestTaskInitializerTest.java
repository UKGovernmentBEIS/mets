...
class EmpVariationUkEtsWaitForPeerReviewRegulatorLedRequestTaskInitializerTest {

	@InjectMocks
    private EmpVariationUkEtsWaitForPeerReviewRegulatorLedRequestTaskInitializer cut;
	...
	void getRequestTaskTypes() {
		assertThat(cut.getRequestTaskTypes()).containsExactly(RequestTaskType.EMP_VARIATION_UKETS_REGULATOR_LED_WAIT_FOR_PEER_REVIEW);
	}
	...
	void initializePayload() {
		...
		assertThat(result).isEqualTo(EmpVariationUkEtsApplicationSubmitRegulatorLedRequestTaskPayload.builder()
				.payloadType(RequestTaskPayloadType.EMP_VARIATION_UKETS_WAIT_FOR_PEER_REVIEW_REGULATOR_LED_PAYLOAD)
				.emissionsMonitoringPlan(EmissionsMonitoringPlanUkEts.builder()
						.abbreviations(EmpAbbreviations.builder()
								.exist(false)
								.build())
