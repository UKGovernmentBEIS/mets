...
class DoalGenerateAuthorityResponseOfficialNoticeHandlerFlowableTest {
    ...
    @InjectMocks
    private DoalGenerateAuthorityResponseOfficialNoticeHandlerFlowable handler;
    ...
    void execute_shouldGenerateAndSaveAuthorityResponseOfficialNotice() {
        ...
        verify(doalOfficialNoticeService).generateAndSaveAuthorityResponseOfficialNotice(requestId);
