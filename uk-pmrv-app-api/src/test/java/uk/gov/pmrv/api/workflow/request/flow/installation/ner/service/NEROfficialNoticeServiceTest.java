...
public class NEROfficialNoticeServiceTest {
    ...
    void sendOfficialNotice_accountPrimaryContactExists_sendEmail() {
        final String requestId = "NER-2025";
        final Long accountId = 1L;
        final String primaryContactUserId = "userId";

        uk.gov.netz.api.userinfoapi.UserInfoDTO userInfo = UserInfoDTO.builder().userId(primaryContactUserId).email("topal@pmrv.uk").build();

        NerRequestPayload nerRequestPayload = NerRequestPayload.builder().regulatorReviewOutcome(NERApplicationRegulatorReviewOutcome.builder().opinion(NERReviewOpinion.PROCEED_TO_AUTHORITY).build()).build();
        ...
        final EmailData<PmrvEmailNotificationTemplateData> emailData = EmailData.<PmrvEmailNotificationTemplateData>builder()
                .notificationTemplateData(PmrvEmailNotificationTemplateData.builder()
                        ...
                        .templateName(PmrvNotificationTemplateName.NER_COMPLETED.getName())
