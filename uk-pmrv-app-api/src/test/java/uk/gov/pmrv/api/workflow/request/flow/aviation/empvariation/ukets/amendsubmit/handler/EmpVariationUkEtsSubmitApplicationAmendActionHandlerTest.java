...
class EmpVariationUkEtsSubmitApplicationAmendActionHandlerTest {

	@InjectMocks
    private EmpVariationUkEtsSubmitApplicationAmendActionHandler handler;
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsOnly(RequestTaskActionType.EMP_VARIATION_UKETS_SUBMIT_APPLICATION_AMEND);
    }
}
