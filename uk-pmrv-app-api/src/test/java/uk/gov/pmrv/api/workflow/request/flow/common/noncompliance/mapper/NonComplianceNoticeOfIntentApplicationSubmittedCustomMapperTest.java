...
class NonComplianceNoticeOfIntentApplicationSubmittedCustomMapperTest {
    ...
    void toRequestActionDTO() {
        ...
        final RequestAction requestAction = RequestAction.builder()
            .type(RequestActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_APPLICATION_SUBMITTED)
    ...
    void getRequestActionType() {
        assertThat(mapper.getRequestActionType()).isEqualTo(RequestActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_APPLICATION_SUBMITTED);
    }
