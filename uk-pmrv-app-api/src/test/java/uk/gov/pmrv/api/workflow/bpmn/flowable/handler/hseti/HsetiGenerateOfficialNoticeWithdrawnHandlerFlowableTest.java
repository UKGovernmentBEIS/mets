...
class HsetiGenerateOfficialNoticeWithdrawnHandlerFlowableTest {
    ...
    @InjectMocks
    private HsetiGenerateOfficialNoticeWithdrawnHandlerFlowable handler;
    ...
    void execute_shouldCallOfficialNoticeService() {
        ...
        verify(officialNoticeService).generateOfficialNoticeWithdrawn("REQ-1");
