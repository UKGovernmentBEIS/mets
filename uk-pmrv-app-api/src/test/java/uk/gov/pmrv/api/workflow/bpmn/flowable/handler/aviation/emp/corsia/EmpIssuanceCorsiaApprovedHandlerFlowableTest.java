...
class EmpIssuanceCorsiaApprovedHandlerFlowableTest {
    ...
    @InjectMocks
    private EmpIssuanceCorsiaApprovedHandlerFlowable handler;
    ...
    void execute_callsServiceApproveEmp_withRequestId() {
        ...
        verify(empIssuanceCorsiaApprovedService).approveEmp(requestId);
        verifyNoMoreInteractions(empIssuanceCorsiaApprovedService);
    }
}
