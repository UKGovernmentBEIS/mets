...
class EmpVariationUkEtsReviewPeerDecisionActionHandlerTest {

	@InjectMocks
    private EmpVariationUkEtsReviewPeerDecisionActionHandler handler;
    ...
    void process() {
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(RequestActionPayloadType.EMP_VARIATION_UKETS_PEER_REVIEW_DECISION_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(RequestTaskActionType.EMP_VARIATION_UKETS_REVIEW_SUBMIT_PEER_REVIEW_DECISION);
    }
}
