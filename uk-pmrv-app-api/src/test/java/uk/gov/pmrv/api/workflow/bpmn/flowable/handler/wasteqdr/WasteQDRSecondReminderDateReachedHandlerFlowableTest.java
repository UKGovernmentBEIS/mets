...
class WasteQDRSecondReminderDateReachedHandlerFlowableTest {
    ...
    @InjectMocks
    private WasteQDRSecondReminderDateReachedHandlerFlowable handler;
    ...
    void execute_callsServiceWithCorrectVariables() {
        ...
        verify(wasteQDRSendReminderNotificationService)
                .sendSecondReminderNotification(requestId, expirationDate);
        verifyNoMoreInteractions(wasteQDRSendReminderNotificationService);
    }
}
