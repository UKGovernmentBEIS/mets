...
import { PermitSurrenderReviewDeterminationGrant } from './permitSurrenderReviewDeterminationGrant';
import { RequestActionPayload } from './requestActionPayload';
import { RequestActionUserInfo } from './requestActionUserInfo';

export interface PermitSurrenderApplicationGrantedRequestActionPayload extends RequestActionPayload {
  reviewDetermination: PermitSurrenderReviewDeterminationGrant;
