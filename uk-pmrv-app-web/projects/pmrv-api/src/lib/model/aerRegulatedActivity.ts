...
export interface AerRegulatedActivity {
  ...
  energyCrf?:
    ...
    | '_2_G_4_OTHER'
    | '_2_H_OTHER'
    | '_5_A_1_A_SOLID_WASTE_DISPOSAL_TO_LAND'
    | '_5_B_1_A_MUNICIPAL_SOLID_WASTE_COMPOSTING'
    | '_5_B_2_A_MUNICIPAL_SOLID_WASTE_ANAEROBIC_DIGESTION_AT_BIOGAS_FACILITIES'
    | '_5_C_1_1_B_INCINERATION_SEWAGE_SLUDGE'
    | '_5_C_1_2_A_INCINERATION_MUNICIPAL_SOLID_WASTE'
    | '_5_C_1_2_B_INCINERATION_CLINICAL_WASTE'
    | '_5_C_2_1_B_OPEN_BURNING_OTHER_BIOGENIC_WASTE'
    | '_5_C_2_2_B_OPEN_BURNING_ACCIDENTAL_BUILDING_AND_VEHICLE_FIRES'
    | '_5_D_1_DOMESTIC'
    | '_5_D_2_INDUSTRIAL';
  industrialCrf?:
    | '_1_A_1_A_PUBLIC_ELECTRICITY_AND_HEAT_PRODUCTION'
