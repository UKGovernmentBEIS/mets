...
import { PermitSurrenderReviewDeterminationReject } from './permitSurrenderReviewDeterminationReject';
import { RequestActionPayload } from './requestActionPayload';
import { RequestActionUserInfo } from './requestActionUserInfo';

export interface PermitSurrenderApplicationRejectedRequestActionPayload extends RequestActionPayload {
  reviewDetermination: PermitSurrenderReviewDeterminationReject;
