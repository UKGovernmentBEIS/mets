...
import { PermitIssuanceRejectDetermination } from './permitIssuanceRejectDetermination';
import { RequestActionPayload } from './requestActionPayload';
import { RequestActionUserInfo } from './requestActionUserInfo';

export interface PermitIssuanceApplicationRejectedRequestActionPayload extends RequestActionPayload {
  decisionNotification: DecisionNotification;
  determination: PermitIssuanceRejectDetermination;
