...
export class UsersService {
  ...
  /**
   * Updates the last login domain of the logged in user
   * @param registerUserLoginDomainDTO
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public registerUserLastLoginDomain(registerUserLoginDomainDTO: RegisterUserLoginDomainDTO): Observable<any>;
  public registerUserLastLoginDomain(
    registerUserLoginDomainDTO: RegisterUserLoginDomainDTO,
    observe: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<HttpResponse<any>>;
  ...
  public registerUserLastLoginDomain(
    ...
    if (registerUserLoginDomainDTO === null || registerUserLoginDomainDTO === undefined) {
      throw new Error(
        'Required parameter registerUserLoginDomainDTO was null or undefined when calling registerUserLastLoginDomain.',
      );
    }
    ...
    return this.httpClient.put<any>(
      `${this.configuration.basePath}/v1.0/users/last-login`,
      registerUserLoginDomainDTO,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
