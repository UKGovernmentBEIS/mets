...
export class InstallationAccountUpdateService {
  ...
  public updateCommencementDate(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling updateCommencementDate.');
    }
    if (accountUpdateCommencementDateDTO === null || accountUpdateCommencementDateDTO === undefined) {
      throw new Error(
        'Required parameter accountUpdateCommencementDateDTO was null or undefined when calling updateCommencementDate.',
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/v1.0/installation/accounts/${encodeURIComponent(String(id))}/commencement-date`,
