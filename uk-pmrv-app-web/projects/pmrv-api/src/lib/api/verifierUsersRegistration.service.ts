...
export class VerifierUsersRegistrationService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public acceptVerifierInvitation(tokenDTO: TokenDTO): Observable<InvitedUserInfoDTO>;
  public acceptVerifierInvitation(
    tokenDTO: TokenDTO,
    observe: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ...
  public acceptVerifierInvitation(
    ...
    if (tokenDTO === null || tokenDTO === undefined) {
      throw new Error('Required parameter tokenDTO was null or undefined when calling acceptVerifierInvitation.');
    }
    ...
    return this.httpClient.post<InvitedUserInfoDTO>(
      `${this.configuration.basePath}/v1.0/verifier-users/registration/accept-invitation`,
      tokenDTO,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
