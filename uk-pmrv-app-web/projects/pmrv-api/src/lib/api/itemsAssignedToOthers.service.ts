...
export class ItemsAssignedToOthersService {
  ...
  public getAssignedToOthersItems(
    ...
    if (accountType === null || accountType === undefined) {
      throw new Error('Required parameter accountType was null or undefined when calling getAssignedToOthersItems.');
    }
    if (page === null || page === undefined) {
      throw new Error('Required parameter page was null or undefined when calling getAssignedToOthersItems.');
    }
    ...
    return this.httpClient.get<ItemDTOResponse>(
      `${this.configuration.basePath}/v1.0/${encodeURIComponent(String(accountType))}/items/assigned-to-others`,
      {
