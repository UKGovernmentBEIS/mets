...
export class MiReportsService {
  ...
  public getCurrentUserMiReports(
    ...
    if (accountType === null || accountType === undefined) {
      throw new Error('Required parameter accountType was null or undefined when calling getCurrentUserMiReports.');
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRegulatorRequestTaskTypes(accountType: 'INSTALLATION' | 'AVIATION'): Observable<Array<string>>;
  ...
  public getRegulatorRequestTaskTypes(
    ...
    if (accountType === null || accountType === undefined) {
      throw new Error(
        'Required parameter accountType was null or undefined when calling getRegulatorRequestTaskTypes.',
      );
    }
