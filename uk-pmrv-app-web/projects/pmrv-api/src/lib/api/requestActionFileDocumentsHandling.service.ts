...
export class RequestActionFileDocumentsHandlingService {
   ...
   */
  public generateRequestActionGetFileDocumentToken(id: number, fileDocumentUuid: string): Observable<FileToken>;
  public generateRequestActionGetFileDocumentToken(
    id: number,
  ...
  public generateRequestActionGetFileDocumentToken(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling generateRequestActionGetFileDocumentToken.',
      );
    }
    if (fileDocumentUuid === null || fileDocumentUuid === undefined) {
      throw new Error(
        'Required parameter fileDocumentUuid was null or undefined when calling generateRequestActionGetFileDocumentToken.',
      );
    }
    ...
    return this.httpClient.get<FileToken>(
      `${this.configuration.basePath}/v1.0/request-action-file-documents/${encodeURIComponent(String(id))}`,
      {
