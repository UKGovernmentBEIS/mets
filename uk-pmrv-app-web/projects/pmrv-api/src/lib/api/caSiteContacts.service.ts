...
export class CaSiteContactsService {
  ...
  public getCaSiteContacts(
    ...
    if (accountType === null || accountType === undefined) {
      throw new Error('Required parameter accountType was null or undefined when calling getCaSiteContacts.');
    }
    if (page === null || page === undefined) {
      throw new Error('Required parameter page was null or undefined when calling getCaSiteContacts.');
    }
    ...
    return this.httpClient.get<AccountContactInfoResponse>(
      `${this.configuration.basePath}/v1.0/${encodeURIComponent(String(accountType))}/ca-site-contacts`,
      {
  ...
  public updateCaSiteContacts(
    ...
    if (accountType === null || accountType === undefined) {
      throw new Error('Required parameter accountType was null or undefined when calling updateCaSiteContacts.');
    }
    if (accountContactDTO === null || accountContactDTO === undefined) {
      throw new Error('Required parameter accountContactDTO was null or undefined when calling updateCaSiteContacts.');
    }
