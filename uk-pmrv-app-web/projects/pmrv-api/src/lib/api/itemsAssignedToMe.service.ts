...
export class ItemsAssignedToMeService {
  ...
  public getAssignedItems(
    ...
    if (accountType === null || accountType === undefined) {
      throw new Error('Required parameter accountType was null or undefined when calling getAssignedItems.');
    }
    if (page === null || page === undefined) {
      throw new Error('Required parameter page was null or undefined when calling getAssignedItems.');
    }
    if (size === null || size === undefined) {
      throw new Error('Required parameter size was null or undefined when calling getAssignedItems.');
    }
    if (orderBy === null || orderBy === undefined) {
      throw new Error('Required parameter orderBy was null or undefined when calling getAssignedItems.');
    }
    ...
    return this.httpClient.get<ItemDTOResponse>(
      `${this.configuration.basePath}/v1.0/${encodeURIComponent(String(accountType))}/items/assigned-to-me`,
      {
