...
export class DocumentTemplateFilesService {
   ...
   */
  public generateGetDocumentTemplateFileToken(id: number, fileUuid: string): Observable<FileToken>;
  public generateGetDocumentTemplateFileToken(
    id: number,
    fileUuid: string,
    observe: 'response',
  ...
  public generateGetDocumentTemplateFileToken(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling generateGetDocumentTemplateFileToken.');
    }
    if (fileUuid === null || fileUuid === undefined) {
      throw new Error(
        'Required parameter fileUuid was null or undefined when calling generateGetDocumentTemplateFileToken.',
      );
    }
