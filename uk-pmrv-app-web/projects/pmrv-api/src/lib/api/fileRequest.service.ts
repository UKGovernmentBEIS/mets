...
export class FileRequestService {
   ...
   */
  public generateGetFileRequestAttachmentToken(id: string, uuid: string): Observable<FileToken>;
  public generateGetFileRequestAttachmentToken(
    id: string,
    uuid: string,
    observe: 'response',
  ...
  public generateGetFileRequestAttachmentToken(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling generateGetFileRequestAttachmentToken.',
      );
    }
    if (uuid === null || uuid === undefined) {
      throw new Error(
        'Required parameter uuid was null or undefined when calling generateGetFileRequestAttachmentToken.',
      );
    }
    ...
    return this.httpClient.get<FileToken>(
      `${this.configuration.basePath}/v1.0/file-request/${encodeURIComponent(String(id))}/attachments`,
      {
