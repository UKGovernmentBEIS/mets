...
describe('StopDateComponent', () => {
  ...
  it('should render empty form when surrender is empty', () => {
    createComponent();
    expect(page.stopDateDay).toBeFalsy();
    expect(page.stopDateMonth).toBeFalsy();
    expect(page.stopDateYear).toBeFalsy();
  });
  ...
  it('should render form when surrender exists', () => {
    ...
    expect(page.stopDateDay).toContain('21');
    expect(page.stopDateMonth).toContain('12');
    expect(page.stopDateYear).toContain('2012');
  });
  ...
  it('should validate future date upon submitting', () => {
    ...
    expect(page.errors[0].textContent).toContain('This date must be the same as or before');
    expect(tasksService.processRequestTaskAction).not.toHaveBeenCalled();
  });
