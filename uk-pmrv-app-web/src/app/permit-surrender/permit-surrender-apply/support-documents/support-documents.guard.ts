...
import { allStepsAreValid, justificationStepIsValid, stopDateStepIsValid } from '../wizard-status';

@Injectable({
  providedIn: 'root',
})
export class SupportDocumentsGuard {
  constructor(
      ...
      this.store.pipe(
        map((surrenderState) => {
          ...
          return (
            ...
            ((!stopDateStepIsValid(permitSurrender) || !justificationStepIsValid(permitSurrender)) &&
