...
@Component({
  ...
  template: `
    <app-wizard-step
      ...
      <app-page-heading>
        Confirm the date on which the regulated activities at the installation stopped
      </app-page-heading>
      <div class="govuk-hint">The date must not be in the future, for example, 27 3 2007</div>

      <div formControlName="stopDate" govuk-date-input [max]="today" [isRequired]="true"></div>
    </app-wizard-step>
