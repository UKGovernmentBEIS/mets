...
const taskRoutes: PermitSurrenderRoute[] = [
  {
    path: '',
    data: { pageTitle: 'Permit surrender task list', breadcrumb: true },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'justification',
        data: { pageTitle: 'Surrender permit request task - Justification', backlink: '../' },
      ...
      },
      {
        ...
        data: { pageTitle: 'Surrender permit request task - Supporting documents', backlink: '../justification' },
      ...
      },
      {
        ...
        data: { pageTitle: 'Surrender permit request task - Upload documents', backlink: '../support-documents' },
      ...
      {
        path: 'summary',
        data: { pageTitle: 'Surrender permit request task - Summary', breadcrumb: 'Summary' },
