...
import { areAllowancesDatePreviousStepsValid, initialStep, isWizardComplete } from '../wizard';
      ...
      this.store.pipe(
        map((storeState) => {
          ...
          return (
            ...
            ((!allowancesSurrenderRequired || !areAllowancesDatePreviousStepsValid(cessation)) &&
