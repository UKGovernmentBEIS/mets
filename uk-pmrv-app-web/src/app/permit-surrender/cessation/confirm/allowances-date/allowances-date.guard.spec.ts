...
import { AllowancesDateGuard } from './allowances-date.guard';

describe('AllowancesDateGuard', () => {
  let router: Router;
  let guard: AllowancesDateGuard;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(AllowancesDateGuard);
