...
import { WasteQdrUploadQdrComponent } from './upload-qdr.component';

describe('UploadQdrComponent', () => {
  let component: WasteQdrUploadQdrComponent;
  let fixture: ComponentFixture<WasteQdrUploadQdrComponent>;
  let router: Router;
  let reportControl: FormControl;
  ...
  class Page extends BasePage<WasteQdrUploadQdrComponent> {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [WasteQdrUploadQdrComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(WasteQdrUploadQdrComponent);
    component = fixture.componentInstance;
    supportingFilesControl = component.form.get('supportingFiles') as FormControl;
    reportControl = component.form.get('report') as FormControl;
  ...
  it('should submit a valid form and navigate to next page', async () => {
    ...
    reportControl.setValue({
      file: new File(['test waste qdr file content 1'], 'wastQdrfile-testfile1.jpg'),
      uuid: uuid2,
    });
