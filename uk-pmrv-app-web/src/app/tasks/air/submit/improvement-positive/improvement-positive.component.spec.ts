...
import { noComment, noDate } from '@tasks/air/shared/errors/validation-errors';
...
import { ImprovementPositiveComponent } from './improvement-positive.component';

describe('ImprovementPositiveComponent', () => {
  let page: Page;
  let router: Router;
  let control: FormControl;
  let store: CommonTasksStore;
  let component: ImprovementPositiveComponent;
  let fixture: ComponentFixture<ImprovementPositiveComponent>;
  ...
  class Page extends BasePage<ImprovementPositiveComponent> {
    get heading1(): HTMLHeadingElement {
      return this.query<HTMLHeadingElement>('h1');
    }

    set proposal(value: string) {
      this.setInputValue('#proposal', value);
    }

    set proposedDate(date: Date) {
      this.setInputValue(`#proposedDate-day`, date.getDate());
      this.setInputValue(`#proposedDate-month`, date.getMonth() + 1);
      this.setInputValue(`#proposedDate-year`, date.getFullYear());
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(ImprovementPositiveComponent);
  ...
  describe('for new improvement positive details', () => {
    beforeEach(() => {
    ...
    it('should display error on empty form submit', () => {
      ...
      expect(page.errorSummaryListContents).toEqual([noComment, noDate]);
    });
    ...
    it('should submit a valid form and navigate to `summary` page', () => {
      ...
      page.proposal = 'Test description 1';
      page.proposedDate = expectedDate;
  ...
  describe('for existing improvement positive details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
    ...
    it('should edit, submit a valid form and navigate to `summary` page', () => {
      ...
      page.proposal = 'Test description 1 edited';
      page.proposedDate = expectedDate;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            operatorImprovementResponses: {
              ...
              [reference]: {
                ...
                proposal: 'Test description 1 edited',
                proposedDate: expectedDate,
                files: [uuid3, uuid4],
              },
            },
