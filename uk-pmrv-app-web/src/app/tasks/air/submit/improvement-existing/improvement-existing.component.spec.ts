...
import { ImprovementExistingComponent } from './improvement-existing.component';

describe('ImprovementExistingComponent', () => {
  let page: Page;
  let router: Router;
  let control: FormControl;
  let store: CommonTasksStore;
  let component: ImprovementExistingComponent;
  let fixture: ComponentFixture<ImprovementExistingComponent>;
  ...
  class Page extends BasePage<ImprovementExistingComponent> {
    ...
    set improvementDate(date: Date) {
      this.setInputValue(`#improvementDate-day`, date.getDate());
      this.setInputValue(`#improvementDate-month`, date.getMonth() + 1);
      this.setInputValue(`#improvementDate-year`, date.getFullYear());
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(ImprovementExistingComponent);
  ...
  describe('for new improvement positive details', () => {
    ...
    it('should submit a valid form and navigate to `summary` page', () => {
      ...
      page.explanation = 'Test description 1';
      page.improvementDate = expectedDate;
  ...
  describe('for existing improvement positive details', () => {
    ...
    it('should edit, submit a valid form and navigate to `summary` page', () => {
      ...
      page.explanation = 'Test description 1 edited';
      page.improvementDate = expectedDate;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            operatorImprovementResponses: {
              ...
              [reference]: {
                ...
                explanation: 'Test description 1 edited',
                improvementDate: expectedDate,
                files: [uuid3, uuid4],
              },
            },
