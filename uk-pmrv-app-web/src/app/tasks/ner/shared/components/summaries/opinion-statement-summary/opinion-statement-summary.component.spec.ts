...
import { NerOpinionStatementSummaryComponent } from './opinion-statement-summary.component';

describe('OpinionStatementSummaryComponent', () => {
  let component: NerOpinionStatementSummaryComponent;
  let fixture: ComponentFixture<NerOpinionStatementSummaryComponent>;
  let page: Page;
  let router: Router;
  ...
  class Page extends BasePage<NerOpinionStatementSummaryComponent> {
    get summaryTemplate() {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NerOpinionStatementSummaryComponent],
      providers: [
        CapitalizeFirstPipe,
    ...
    fixture = TestBed.createComponent(NerOpinionStatementSummaryComponent);
