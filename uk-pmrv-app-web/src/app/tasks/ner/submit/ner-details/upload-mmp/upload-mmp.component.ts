...
import { nerUploadMmpFormProvider } from './upload-mmp-form.provider';

@Component({
  selector: 'app-upload-mmp',
  imports: [SharedModule, NerTaskComponent],
  templateUrl: './upload-mmp.component.html',
  providers: [nerUploadMmpFormProvider],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NerDetailsUploadMmpComponent {
  ...
  onSubmit() {
    ...
    const { file, supportingFiles } = this.form.controls;
