...
import { NerDetailsUploadMmpComponent } from './upload-mmp.component';

describe('UploadMmpComponent', () => {
  let component: NerDetailsUploadMmpComponent;
  let fixture: ComponentFixture<NerDetailsUploadMmpComponent>;
  let router: Router;
  ...
  class Page extends BasePage<NerDetailsUploadMmpComponent> {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NerDetailsUploadMmpComponent],
      providers: [
        CapitalizeFirstPipe,
    ...
    fixture = TestBed.createComponent(NerDetailsUploadMmpComponent);
