...
import { NerOverallDecisionAssessmentComponent } from './overall-decision-assessment.component';

describe('OverallDecisionComponent', () => {
  let component: NerOverallDecisionAssessmentComponent;
  let fixture: ComponentFixture<NerOverallDecisionAssessmentComponent>;
  ...
  class Page extends BasePage<NerOverallDecisionAssessmentComponent> {
    get existRadios() {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NerOverallDecisionAssessmentComponent],
      providers: [
        CapitalizeFirstPipe,
    ...
    fixture = TestBed.createComponent(NerOverallDecisionAssessmentComponent);
