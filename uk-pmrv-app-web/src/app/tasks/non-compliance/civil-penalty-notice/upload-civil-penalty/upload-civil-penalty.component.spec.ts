...
import { UploadCivilPenaltyComponent } from './upload-civil-penalty.component';

describe('UploadCivilPenaltyComponent', () => {
  let component: UploadCivilPenaltyComponent;
  let fixture: ComponentFixture<UploadCivilPenaltyComponent>;
  let router: Router;
  ...
  class Page extends BasePage<UploadCivilPenaltyComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(UploadCivilPenaltyComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [UploadCivilPenaltyComponent, NonComplianceTaskComponent],
  ...
  describe('for new civil penalty notice', () => {
    beforeEach(() => {
