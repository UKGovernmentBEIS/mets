...
import { DailyPenaltyComponent } from './daily-penalty.component';

describe('DailyPenaltyComponent', () => {
  let component: DailyPenaltyComponent;
  let fixture: ComponentFixture<DailyPenaltyComponent>;
  ...
  class Page extends BasePage<DailyPenaltyComponent> {
    get dailyPenaltyRadios() {
      return this.queryAll<HTMLInputElement>('input[name$="dailyPenalty"]');
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(DailyPenaltyComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DailyPenaltyComponent, NonComplianceTaskComponent],
  ...
  describe('for new non compliance', () => {
    ...
    it('should submit and navigate to summary', () => {
      ...
      page.dailyPenaltyRadios[0].click();
      fixture.detectChanges();
