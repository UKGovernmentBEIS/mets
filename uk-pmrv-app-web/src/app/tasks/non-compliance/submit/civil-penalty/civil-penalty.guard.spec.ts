...
import { CivilPenaltyGuard } from './civil-penalty.guard';

describe('CivilPenaltyGuard', () => {
  let guard: CivilPenaltyGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: 'tasks/1/non-compliance/submit/civil-penalty',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(CivilPenaltyGuard);
