...
import { ChooseWorkflowGuard } from './choose-workflow.guard';

describe('ChooseWorkflowGuard', () => {
  let guard: ChooseWorkflowGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: 'tasks/1/non-compliance/submit/choose-workflow',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(ChooseWorkflowGuard);
