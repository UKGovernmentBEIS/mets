...
import { ChooseWorkflowAddGuard } from './choose-workflow-add.guard';

describe('ChooseWorkflowAddGuard', () => {
  let guard: ChooseWorkflowAddGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: 'tasks/1/non-compliance/submit/choose-workflow/0',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(ChooseWorkflowAddGuard);
