...
import { UploadNoticeOfIntentComponent } from './upload-notice-of-intent.component';

describe('UploadNoticeOfIntentComponent', () => {
  let component: UploadNoticeOfIntentComponent;
  let fixture: ComponentFixture<UploadNoticeOfIntentComponent>;
  let router: Router;
  ...
  class Page extends BasePage<UploadNoticeOfIntentComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(UploadNoticeOfIntentComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [UploadNoticeOfIntentComponent, NonComplianceTaskComponent],
