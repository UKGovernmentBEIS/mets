    ...
    return (
      ...
      this.store.pipe(
        map((storeState) => {
          ...
          const activityLevelsStep = `${wizardBaseUrl}/activity-levels`;
          ...
          return (
            ...
            (!payload?.doal.activityLevelChangeInformation.activityLevels?.[Number(index)] &&
              this.router.parseUrl(activityLevelsStep)) ||
            true
          );
        }),
      )
