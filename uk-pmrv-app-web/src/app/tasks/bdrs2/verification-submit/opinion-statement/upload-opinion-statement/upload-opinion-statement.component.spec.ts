...
describe('UploadOpinionStatementComponent', () => {
  ...
  describe('for new upload documents files details', () => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.heading1.textContent.trim()).toEqual('Upload stage 2 BDR verification opinion statement');
    ...
    it('should submit a valid form and navigate to next page', async () => {
      ...
      expect(tasksService.processRequestTaskAction).toHaveBeenCalledWith(
        mockPostBuild(
          {
            opinionStatement: {
              opinionStatementFile: '11111111-1111-4111-a111-111111111111',
              supportingFiles: [],
              notes: null,
            },
          },
