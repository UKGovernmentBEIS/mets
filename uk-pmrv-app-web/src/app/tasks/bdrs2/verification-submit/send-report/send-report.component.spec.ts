...
import { mockState } from '../testing/mock-bdrs2-payload';
import { SendBdrs2ReportComponent } from './send-report.component';

describe('SendBdrs2ReportComponent', () => {
  let page: Page;
  let component: SendBdrs2ReportComponent;
  let store: CommonTasksStore;
  let fixture: ComponentFixture<SendBdrs2ReportComponent>;

  const tasksService = mockClass(TasksService);

  class Page extends BasePage<SendBdrs2ReportComponent> {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [BdrS2TaskSharedModule, RouterTestingModule],
  ...
  describe('when it can be submitted', () => {
    beforeEach(() => {
      ...
      fixture = TestBed.createComponent(SendBdrs2ReportComponent);
  ...
  describe('when it has been submitted', () => {
    beforeEach(() => {
      ...
      component.requestId$ = new BehaviorSubject('BDRS2-00180-2025');
      fixture.detectChanges();
    });
    ...
    it('should display all html elements', () => {
      ...
      expect(page.panelBody.textContent.trim()).toEqual('Your reference number BDRS2-00180-2025');
