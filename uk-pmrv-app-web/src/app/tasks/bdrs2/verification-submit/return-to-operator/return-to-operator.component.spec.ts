...
import { BdrS2ReturnToOperatorComponent, returnToOperatorFormProvider } from './';

describe('ReturnToOperatorComponent', () => {
  let component: BdrS2ReturnToOperatorComponent;
  let fixture: ComponentFixture<BdrS2ReturnToOperatorComponent>;
  let page: Page;
  ...
  class Page extends BasePage<BdrS2ReturnToOperatorComponent> {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [BdrS2ReturnToOperatorComponent],
    ...
    fixture = TestBed.createComponent(BdrS2ReturnToOperatorComponent);
