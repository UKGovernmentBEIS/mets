...
import { Bdrs2SendReportVerifierGuard } from './send-report-verifier-guard';

describe('Bdrs2SendReportVerifierGuard', () => {
  let guard: Bdrs2SendReportVerifierGuard;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(Bdrs2SendReportVerifierGuard);
