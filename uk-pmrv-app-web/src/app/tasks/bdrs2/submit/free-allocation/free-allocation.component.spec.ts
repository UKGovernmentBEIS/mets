...
describe('FreeAllocationComponent', () => {
  ...
  describe('for new free allocation details', () => {
    ...
    it('should display error on empty form submit', () => {
      ...
      expect(page.errorSummaryListContents).toEqual(['Select yes if you want to continue your application']);
    ...
    it('should submit a valid form and navigate to next page', async () => {
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['details'], { relativeTo: activatedRoute });
    });
  });
});
