...
import { BDRS2UploadReportComponent } from './bdrs2-upload-report.component';

describe('BDRS2UploadReportComponent', () => {
  let page: Page;
  let router: Router;
  ...
  const renamedFileName = 'BDRS2-00001-2026-v1-uploaded by -Unknown.jpg';

  class Page extends BasePage<BDRS2UploadReportComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(BDRS2UploadReportComponent);
    component = fixture.componentInstance;
    control = component.form.get('files') as FormControl;
    bdrs2FileControl = component.form.get('bdrs2File') as FormControl;
  ...
  describe('for new upload documents files details', () => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.heading1.textContent.trim()).toEqual('Upload stage 2 baseline data report file');
