...
import { BdrS2ReviewGroupDecisionComponent } from './bdrs2-review-group-decision.component';

describe('BdrS2ReviewGroupDecisionComponent', () => {
  let page: Page;
  let store: CommonTasksStore;
  let component: BdrS2ReviewGroupDecisionComponent;
  let fixture: ComponentFixture<BdrS2ReviewGroupDecisionComponent>;
  ...
  class Page extends BasePage<BdrS2ReviewGroupDecisionComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(BdrS2ReviewGroupDecisionComponent);
