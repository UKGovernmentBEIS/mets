...
import { BDRS2ReturnLinkComponent } from './return-link.component';

describe('BDRS2ReturnLinkComponent', () => {
  let component: BDRS2ReturnLinkComponent;
  ...
  describe('for summary routes', () => {
    beforeEach(async () => {
      ...
      component = fixture.debugElement.query(By.directive(BDRS2ReturnLinkComponent)).componentInstance;
    });
