...
export const bdrs2CovidAdjustmentsFormProvider = {
  ...
  useFactory: (fb: UntypedFormBuilder, store: CommonTasksStore) => {
    ...
    return fb.group({
      covidAdjustmentsOpinion: [
        {
          value: outcome?.covidAdjustmentsOpinion ?? null,
          disabled,
        },
        {
          updateOn: 'change',
          validators: [GovukValidators.required('Select your opinion on the COVID adjustments')],
        },
      ],
      operatorNotes: [
        {
          value: outcome?.covidAdjustmentsReviewNotes?.operatorNotes ?? null,
          disabled,
        },
        {
          updateOn: 'change',
      ...
      internalNotes: [
        {
          value: outcome?.covidAdjustmentsReviewNotes?.internalNotes ?? null,
          disabled,
        },
        {
          updateOn: 'change',
