...
import { BDRS2OutcomeCbamComponent } from './outcome-cbam.component';

describe('BDRS2OutcomeCbamComponent', () => {
  let page: Page;
  let store: CommonTasksStore;
  let component: BDRS2OutcomeCbamComponent;
  let fixture: ComponentFixture<BDRS2OutcomeCbamComponent>;
  ...
  class Page extends BasePage<BDRS2OutcomeCbamComponent> {
    get decisionRadioButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="cbamSplitOpinion"]');
    }
    get notesOperator() {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(BDRS2OutcomeCbamComponent);
  ...
  describe('for new decision', () => {
    ...
    it('should display an empty form', () => {
      expect(page.header).toEqual(
        'What is your decision on the sub-installation splits required because of the UK CBAM?',
      );
    ...
    it('should submit a free allocation decision', () => {
      ...
      expect(page.errorSummaryList).toEqual(['Select your opinion on CBAM']);
