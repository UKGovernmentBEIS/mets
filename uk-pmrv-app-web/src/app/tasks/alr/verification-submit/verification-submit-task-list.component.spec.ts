...
describe('VerificationSubmitContainerComponent', () => {
  ...
  let component: VerificationSubmitTaskListComponent;
  let fixture: ComponentFixture<VerificationSubmitTaskListComponent>;

  class Page extends BasePage<VerificationSubmitTaskListComponent> {
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(VerificationSubmitTaskListComponent);
  ...
  it('should display all HTMLElements', () => {
    ...
    expect(page.heading1.textContent.trim()).toEqual('Verify 2021 activity level report');
    ...
    expect(page.sections.map((el) => el.textContent.trim())).toEqual([
      ...
      'Overall decision',
      'Send verification report to operator',
    ]);
  });
});
