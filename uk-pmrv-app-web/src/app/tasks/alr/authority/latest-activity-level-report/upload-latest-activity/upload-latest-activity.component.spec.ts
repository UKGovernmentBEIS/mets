...
import { AlrAuthorityUploadLatestActivityComponent } from './upload-latest-activity.component';

describe('UploadLatestActivityComponent', () => {
  let component: AlrAuthorityUploadLatestActivityComponent;
  let fixture: ComponentFixture<AlrAuthorityUploadLatestActivityComponent>;
  let page: Page;
  let router: Router;
  ...
  class Page extends BasePage<AlrAuthorityUploadLatestActivityComponent> {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AlrAuthorityUploadLatestActivityComponent],
      providers: [
      ...
      mockAlrAuthorityStateBuild(
        {
          ...
          authorityReviewOutcome: { ...alrMockAuthorityPayload.authorityReviewOutcome },
          alrFileVersion: 1,
    ...
    fixture = TestBed.createComponent(AlrAuthorityUploadLatestActivityComponent);
