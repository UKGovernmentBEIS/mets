...
import { AlrUploadLatestActivityComponent } from './upload-latest-activity.component';

describe('UploadLatestActivityComponent', () => {
  let component: AlrUploadLatestActivityComponent;
  let fixture: ComponentFixture<AlrUploadLatestActivityComponent>;
  let page: Page;
  let router: Router;
  ...
  const renamedFileName = 'ALR00189-2021-v1-uploaded by -Unknown.jpg';

  class Page extends BasePage<AlrUploadLatestActivityComponent> {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AlrUploadLatestActivityComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(AlrUploadLatestActivityComponent);
  ...
  it('should display all HTMLElements and form with 0 errors', () => {
    ...
    expect(page.heading1.textContent.trim()).toEqual('Upload the latest activity level report file');
  ...
  it('should submit a valid form and navigate to next page', async () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['../', 'latest-activity'], { relativeTo: activatedRoute });
  });
});
