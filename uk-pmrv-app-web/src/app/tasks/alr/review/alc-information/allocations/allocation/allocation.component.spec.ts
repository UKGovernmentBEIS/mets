...
import { AlrAllocationComponent } from './allocation.component';

describe('AlrAllocationComponent', () => {
  let component: AlrAllocationComponent;
  let fixture: ComponentFixture<AlrAllocationComponent>;
  ...
  class Page extends BasePage<AlrAllocationComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(AlrAllocationComponent);
