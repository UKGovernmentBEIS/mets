...
import { AlrReviewGroupDecisionComponent } from './alr-review-group-decision.component';

describe('AlrReviewGroupDecisionComponent', () => {
  let page: Page;
  let store: CommonTasksStore;
  let component: AlrReviewGroupDecisionComponent;
  let fixture: ComponentFixture<AlrReviewGroupDecisionComponent>;
  ...
  class Page extends BasePage<AlrReviewGroupDecisionComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(AlrReviewGroupDecisionComponent);
