...
describe('BdrVerificationReviewGroupDecisionComponent', () => {
  let page: Page;
  let store: CommonTasksStore;
  let component: BdrVerificationReviewGroupDecisionComponent;
  let fixture: ComponentFixture<BdrVerificationReviewGroupDecisionComponent>;
  ...
  class Page extends BasePage<BdrVerificationReviewGroupDecisionComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(BdrVerificationReviewGroupDecisionComponent);
  ...
  describe('for new decision', () => {
    ...
    it('should display an empty form', () => {
      expect(page.header).toEqual('What is your decision for the information submitted?');
