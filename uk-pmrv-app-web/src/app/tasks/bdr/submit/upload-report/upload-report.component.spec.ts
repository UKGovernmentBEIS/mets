...
describe('UploadReportComponent', () => {
  ...
  const expectedNextRoute = 'free-allocation';
  ...
  const renamedFileName = 'BDR00186-2025-v1-uploaded by -Unknown.jpg';

  class Page extends BasePage<UploadReportComponent> {
