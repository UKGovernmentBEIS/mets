...
import { TransferAAemReportComponent } from './aem-report.component';

describe('AemReportComponent', () => {
  let component: TransferAAemReportComponent;
  let fixture: ComponentFixture<TransferAAemReportComponent>;
  ...
  class Page extends BasePage<TransferAAemReportComponent> {
    get submitButton() {
      return this.query<HTMLButtonElement>('button[type="submit"]');
    }

    get reportOptions() {
      return this.queryAll<HTMLInputElement>('input[name$="aerLiable"]');
    }
  }
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(TransferAAemReportComponent);
