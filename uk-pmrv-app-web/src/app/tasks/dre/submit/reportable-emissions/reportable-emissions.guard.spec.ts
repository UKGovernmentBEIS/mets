...
import { ReportableEmissionsGuard } from './reportable-emissions.guard';

describe('ReportableEmissionsGuard', () => {
  let guard: ReportableEmissionsGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: '/tasks/1/dre/submit/reportable-emissions',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(ReportableEmissionsGuard);
