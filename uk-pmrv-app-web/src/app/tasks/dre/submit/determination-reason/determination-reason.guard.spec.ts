...
import { DeterminationReasonGuard } from './determination-reason.guard';

describe('DeterminationReasonGuard', () => {
  let guard: DeterminationReasonGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: '/tasks/1/dre/submit/determination-reason',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(DeterminationReasonGuard);
