...
import { ChargeOperatorGuard } from './charge-operator.guard';

describe('ChargeOperatorGuard', () => {
  let guard: ChargeOperatorGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: '/tasks/1/dre/submit/charge-operator',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(ChargeOperatorGuard);
