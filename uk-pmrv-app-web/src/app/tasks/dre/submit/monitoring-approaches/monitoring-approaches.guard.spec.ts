...
import { MonitoringApproachesGuard } from './monitoring-approaches.guard';

describe('MonitoringApproachesGuard', () => {
  let guard: MonitoringApproachesGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: '/tasks/1/dre/submit/monitoring-approaches',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(MonitoringApproachesGuard);
