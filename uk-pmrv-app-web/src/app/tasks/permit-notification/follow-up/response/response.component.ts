...
export class ResponseComponent implements OnInit {
  ...
  readonly isFileUploaded$: Observable<boolean> = this.form.get('followUpAttachments').valueChanges.pipe(
    startWith(this.form.get('followUpAttachments').value),
  ...
  onSubmit() {
    if (this.form.valid) {
      ...
      const files: string[] = this.form.get('followUpAttachments').value.map((file) => file.uuid);
