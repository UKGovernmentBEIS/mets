  ...
  private get attachments() {
    ...
    switch (requestTaskType) {
      ...
      case 'PERMIT_NOTIFICATION_WAIT_FOR_PEER_REVIEW':
        attachments = (
          this.store.getValue().requestTaskItem.requestTask
            .payload as PermitNotificationApplicationSubmitRequestTaskPayload
        ).permitNotificationAttachments;
        break;
      ...
      case 'PERMIT_NOTIFICATION_FOLLOW_UP_APPLICATION_REVIEW':
        attachments = (
          this.store.getValue().requestTaskItem.requestTask.payload as PermitNotificationFollowUpRequestTaskPayload
        ).followUpAttachments;
        break;
