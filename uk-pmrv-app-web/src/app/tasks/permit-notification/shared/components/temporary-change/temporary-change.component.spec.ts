...
describe('TemporaryChangeComponent', () => {
  ...
  it('should update values on setValue', () => {
    ...
    hostComponent.form.get('notification.justification').setValue(<any>notification.justification);
  ...
  it('should apply field validations', () => {
    ...
    hostComponent.form.get('notification.justification').setValue(<any>'a'.repeat(10001));
    fixture.detectChanges();
