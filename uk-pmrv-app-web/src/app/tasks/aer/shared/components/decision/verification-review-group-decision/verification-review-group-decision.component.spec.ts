...
describe('VerificationReviewGroupDecisionComponent', () => {
  let page: Page;
  let store: CommonTasksStore;
  let component: VerificationReviewGroupDecisionComponent;
  let fixture: ComponentFixture<VerificationReviewGroupDecisionComponent>;
  ...
  class Page extends BasePage<VerificationReviewGroupDecisionComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(VerificationReviewGroupDecisionComponent);
