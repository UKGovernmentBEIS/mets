...
describe('CalculationEmissionsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculationEmissionsModule, RouterTestingModule],
  ...
  describe('for empty source stream emissions', () => {
    ...
    it('should display "Calculation emissions" as a heading', async () => {
      expect(page.heading.textContent.trim()).toEqual('Calculation emissions');
    });
  ...
  describe('for non empty source stream emissions', () => {
    ...
    it('should display "Calculation of emissions" as a heading', async () => {
      expect(page.heading.textContent.trim()).toEqual('Calculation of emissions');
    });
