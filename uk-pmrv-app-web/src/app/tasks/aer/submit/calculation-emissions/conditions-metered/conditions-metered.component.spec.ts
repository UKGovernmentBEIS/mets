...
import { ConditionsMeteredComponent } from './conditions-metered.component';

describe('ConditionsMeteredComponent', () => {
  let page: Page;
  let router: Router;

  let component: ConditionsMeteredComponent;
  let fixture: ComponentFixture<ConditionsMeteredComponent>;
  ...
  class Page extends BasePage<ConditionsMeteredComponent> {
    get fuelMeteringConditionTypeRadios() {
      return this.queryAll<HTMLInputElement>('input[name$="fuelMeteringConditionType"]');
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(ConditionsMeteredComponent);
  ...
  describe('for editing a source stream emission', () => {
    ...
    it('should  fill the form with data from the store', () => {
      ...
      expect(page.fuelMeteringConditionTypeRadios.length).toEqual(2);
      expect(page.fuelMeteringConditionTypeRadios[0].checked).toBeTruthy();
      expect(page.fuelMeteringConditionTypeRadios[1].checked).toBeFalsy();
    });
