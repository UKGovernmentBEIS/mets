...
import { InstallationPostcodeComponent } from './installation-postcode.component';

describe('InstallationPostcodeComponent', () => {
  let page: Page;
  let router: Router;

  let component: InstallationPostcodeComponent;
  let fixture: ComponentFixture<InstallationPostcodeComponent>;
  ...
  class Page extends BasePage<InstallationPostcodeComponent> {
    get postCode(): string {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(InstallationPostcodeComponent);
  ...
  describe('for adding a new source stream emission', () => {
    ...
    it('should submit a valid form, update the store and navigate to summary', () => {
      ...
      expect(page.errorSummaryLinks).toEqual(['This postcode does not exist.']);

      page.submitButton.click();
      fixture.detectChanges();

      page.postCode = 'abc 123';
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../delivery-zone'], { relativeTo: route });
    });
  });
  ...
  describe('for editing a source stream emission', () => {
    ...
    it('should  fill the form with data from the store', () => {
      ...
      expect(page.postCode).toEqual('abc 123');
    });
    ...
    it('should post a valid form and navigate to next step ', () => {
      ...
      expect(postTaskSaveSpy).toHaveBeenCalledTimes(1);
      expect(navigateSpy).toHaveBeenCalledWith(['../delivery-zone'], {
