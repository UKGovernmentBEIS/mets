...
import { AerApplicationSubmitRequestTaskPayload, RequestTaskAttachmentsHandlingService, TasksService } from 'pmrv-api';
...
describe('AdditionalDocumentsComponent', () => {
  ...
  it('should validate, upload new files and submit the data', async () => {
    ...
    expect(
      (
        TestBed.inject(CommonTasksStore).getValue().requestTaskItem.requestTask
