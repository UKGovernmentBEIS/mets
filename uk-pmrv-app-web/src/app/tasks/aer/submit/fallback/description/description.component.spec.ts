...
import { noDescription } from '@tasks/aer/submit/fallback/errors/fallback-validation.errors';
...
describe('DescriptionComponent', () => {
  ...
  const expectedNextRoute = '../total-emissions';
  ...
  describe('for new fallback emissions', () => {
    ...
    it(`should submit a valid form, update the store and navigate to ${expectedNextRoute}`, () => {
      ...
      expect(page.heading1.textContent).toEqual('Describe the fall back approach used');

      page.submitButton.click();
      fixture.detectChanges();

      expect(page.errorSummary).toBeTruthy();
      expect(page.errorSummaryErrorList).toEqual([noDescription]);

      page.description = 'New test description';
      fixture.detectChanges();
  ...
  describe('for editing existing fallback emissions', () => {
    ...
    it('should post a valid form and navigate to next step ', () => {
      ...
      page.description = 'Modified test description';
      page.submitButton.click();
      fixture.detectChanges();
