...
export class InstrumentsComponent implements PendingRequest {
  ...
  radioOptions: InherentReceivingTransferringInstallation['measurementInstrumentOwnerTypes'] = [
    'INSTRUMENTS_BELONGING_TO_YOUR_INSTALLATION',
    'INSTRUMENTS_BELONGING_TO_THE_OTHER_INSTALLATION',
  ];
