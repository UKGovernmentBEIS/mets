...
describe('EmissionNetworkComponent', () => {
  ...
  describe('for adding a new emission point emission', () => {
    ...
    it('should submit a valid form, update the store and navigate to summary', () => {
      ...
      expect(page.errorSummaryLinks).toEqual([
        ...
        'Select at least one source stream',
      ...
      page.emissionPoint = mockAerApplyPayload.aer.emissionPoints[0].id;
                ...
                emissionPointEmissions: [
                  {
                    ...
                    emissionPoint: mockAerApplyPayload.aer.emissionPoints[0].id,
  ...
  describe('for editing a emission point emission', () => {
    ...
    it('should  fill the form with data from the store', () => {
      ...
      const emissionPoint = mockAerApplyPayload.aer.emissionPoints[0];
      ...
      expect(page.emissionPoint).toEqual(emissionPoint.id);
      expect(page.sourceStreams).toEqual([sourceStream.id]);
