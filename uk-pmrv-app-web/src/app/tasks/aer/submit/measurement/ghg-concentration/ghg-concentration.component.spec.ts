...
import { GhgConcentrationComponent } from './ghg-concentration.component';

describe('GhgConcentrationComponent', () => {
  let page: Page;
  let router: Router;

  let component: GhgConcentrationComponent;
  let fixture: ComponentFixture<GhgConcentrationComponent>;
  ...
  class Page extends BasePage<GhgConcentrationComponent> {
    get annualHourlyAverageGHGConcentration() {
      return this.getInputValue('#annualHourlyAverageGHGConcentration');
    }
    set annualHourlyAverageGHGConcentration(value: string) {
      this.setInputValue('#annualHourlyAverageGHGConcentration', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(GhgConcentrationComponent);
  ...
  describe('for adding a new emission point emission', () => {
    ...
    it('should submit a valid form, update the store and navigate to summary', () => {
      ...
      page.annualHourlyAverageGHGConcentration = '30';
        ...
        mockPostBuild(
          {
            monitoringApproachEmissions: {
              ...
              MEASUREMENT_CO2: {
                ...
                emissionPointEmissions: [
                  {
                    annualHourlyAverageGHGConcentration: '30',
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../operation-hours'], { relativeTo: route });
    });
  });
  ...
  describe('for editing a emission point emission', () => {
    ...
    it('should  fill the form with data from the store', () => {
      ...
      expect(page.annualHourlyAverageGHGConcentration).toBe('30');
    });
    ...
    it('should post a valid form and navigate to next step ', () => {
      ...
      expect(tasksService.processRequestTaskAction).toHaveBeenCalledTimes(1);
      expect(navigateSpy).toHaveBeenCalledWith(['../operation-hours'], {
