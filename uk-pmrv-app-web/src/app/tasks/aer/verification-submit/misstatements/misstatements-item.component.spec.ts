...
describe('MisstatementsItemComponent', () => {
  let page: Page;
  let router: Router;
  let store: CommonTasksStore;
  let activatedRoute: ActivatedRoute;
  let component: MisstatementsItemComponent;
  let fixture: ComponentFixture<MisstatementsItemComponent>;

  const tasksService = mockClass(TasksService);
  const route = new ActivatedRouteStub({ index: '0' });

  class Page extends BasePage<MisstatementsItemComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(MisstatementsItemComponent);
  ...
  describe('for new item', () => {
    ...
    it('should submit a valid form and navigate to list', () => {
      ...
      expect(page.errorSummaryList).toEqual(['Please give details of the misstatement', 'Please select yes or no']);
