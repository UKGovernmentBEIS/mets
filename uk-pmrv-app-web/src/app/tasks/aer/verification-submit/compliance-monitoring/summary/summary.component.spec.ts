...
import { SummaryComponent } from '@tasks/aer/verification-submit/compliance-monitoring/summary/summary.component';
...
describe('SummaryComponent', () => {
  ...
  it('should submit and navigate to task list', () => {
    ...
    expect(tasksService.processRequestTaskAction).toHaveBeenCalledWith(
      mockPostBuild(null, { complianceMonitoringReporting: [true] }),
    );
