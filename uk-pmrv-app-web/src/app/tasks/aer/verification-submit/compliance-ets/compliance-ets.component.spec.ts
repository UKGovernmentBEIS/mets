...
describe('ComplianceEtsComponent', () => {
  ...
  const monitoringPlanRequirementsNotMetReasonValue = 'No planning requirements reason';
  const nextRoute = 'regulation-monitoring-reporting';

  class Page extends BasePage<ComplianceEtsComponent> {
    get monitoringPlanRequirementsMetButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="monitoringPlanRequirementsMet"]');
    }

    get monitoringPlanRequirementsNotMetReason() {
      return this.getInputValue('#monitoringPlanRequirementsNotMetReason');
    }

    set monitoringPlanRequirementsNotMetReason(value: string) {
      this.setInputValue('#monitoringPlanRequirementsNotMetReason', value);
    }
  ...
  describe('for new monitoring plan details', () => {
    beforeEach(() => {
    ...
    it(`should submit a valid form and navigate to ${nextRoute}`, () => {
      ...
      page.monitoringPlanRequirementsMetButtons[1].click();
      page.submitButton.click();
      fixture.detectChanges();
      ...
      page.monitoringPlanRequirementsNotMetReason = monitoringPlanRequirementsNotMetReasonValue;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            etsComplianceRules: {
              ...
              monitoringPlanRequirementsNotMetReason: monitoringPlanRequirementsNotMetReasonValue,
            },
          },
  ...
  describe('for existing monitoring plan details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
