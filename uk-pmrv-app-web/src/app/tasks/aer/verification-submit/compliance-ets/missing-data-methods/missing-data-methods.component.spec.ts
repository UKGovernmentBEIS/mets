...
describe('MissingDataMethodsComponent', () => {
  let page: Page;
  let router: Router;
  let store: CommonTasksStore;
  let activatedRoute: ActivatedRoute;
  let component: MissingDataMethodsComponent;
  let fixture: ComponentFixture<MissingDataMethodsComponent>;

  const tasksService = mockClass(TasksService);
  const methodsApplyingMissingDataNotUsedReasonValue = 'No missing data methods reason';
  const nextRoute = '../uncertainty-assessment';

  class Page extends BasePage<MissingDataMethodsComponent> {
    get methodsApplyingMissingDataUsedButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="methodsApplyingMissingDataUsed"]');
    }

    get methodsApplyingMissingDataNotUsedReason() {
      return this.getInputValue('#methodsApplyingMissingDataNotUsedReason');
    }

    set methodsApplyingMissingDataNotUsedReason(value: string) {
      this.setInputValue('#methodsApplyingMissingDataNotUsedReason', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(MissingDataMethodsComponent);
  ...
  describe('for new missing data methods details', () => {
    beforeEach(() => {
    ...
    it(`should submit a valid form and navigate to ${nextRoute}`, () => {
      ...
      page.methodsApplyingMissingDataUsedButtons[1].click();
      page.submitButton.click();
      fixture.detectChanges();
      ...
      page.methodsApplyingMissingDataNotUsedReason = methodsApplyingMissingDataNotUsedReasonValue;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            etsComplianceRules: {
              ...
              methodsApplyingMissingDataNotUsedReason: methodsApplyingMissingDataNotUsedReasonValue,
            },
          },
  ...
  describe('for existing missing data methods details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
