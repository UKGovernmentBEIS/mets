...
describe('CompetentAuthorityGuidanceComponent', () => {
  ...
  let component: CompetentAuthorityGuidanceComponent;
  let fixture: ComponentFixture<CompetentAuthorityGuidanceComponent>;

  const tasksService = mockClass(TasksService);
  const competentAuthorityGuidanceNotMetReasonValue = 'No competent authority guidance reason';
  const nextRoute = '../non-conformities';

  class Page extends BasePage<CompetentAuthorityGuidanceComponent> {
    get competentAuthorityGuidanceMetButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="competentAuthorityGuidanceMet"]');
    }

    get competentAuthorityGuidanceNotMetReason() {
      return this.getInputValue('#competentAuthorityGuidanceNotMetReason');
    }

    set competentAuthorityGuidanceNotMetReason(value: string) {
      this.setInputValue('#competentAuthorityGuidanceNotMetReason', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(CompetentAuthorityGuidanceComponent);
  ...
  describe('for new competent authority guidance details', () => {
    beforeEach(() => {
    ...
    it(`should submit a valid form and navigate to ${nextRoute}`, () => {
      ...
      page.competentAuthorityGuidanceMetButtons[1].click();
      page.submitButton.click();
      fixture.detectChanges();
      ...
      page.competentAuthorityGuidanceNotMetReason = competentAuthorityGuidanceNotMetReasonValue;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            etsComplianceRules: {
              ...
              competentAuthorityGuidanceNotMetReason: competentAuthorityGuidanceNotMetReasonValue,
            },
          },
  ...
  describe('for existing competent authority guidance details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
