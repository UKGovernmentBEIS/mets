...
export const competentAuthorityGuidanceFormProvider = {
  ...
  useFactory: (fb: UntypedFormBuilder, store: CommonTasksStore) => {
    ...
    return fb.group({
      competentAuthorityGuidanceMet: [
        { value: etsComplianceRules?.competentAuthorityGuidanceMet ?? null, disabled: !state.isEditable },
        { validators: [GovukValidators.required(noSelection)] },
      ],
      competentAuthorityGuidanceNotMetReason: [
        { value: etsComplianceRules?.competentAuthorityGuidanceNotMetReason ?? null, disabled: !state.isEditable },
        {
