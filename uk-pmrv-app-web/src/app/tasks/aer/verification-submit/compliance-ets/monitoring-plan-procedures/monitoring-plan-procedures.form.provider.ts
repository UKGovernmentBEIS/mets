...
export const monitoringPlanProceduresFormProvider = {
  ...
  useFactory: (fb: UntypedFormBuilder, store: CommonTasksStore) => {
    ...
    return fb.group({
      proceduresMonitoringPlanDocumented: [
        { value: etsComplianceRules?.proceduresMonitoringPlanDocumented ?? null, disabled: !state.isEditable },
        { validators: [GovukValidators.required(noSelection)] },
      ],
      proceduresMonitoringPlanNotDocumentedReason: [
        { value: etsComplianceRules?.proceduresMonitoringPlanNotDocumentedReason ?? null, disabled: !state.isEditable },
        {
