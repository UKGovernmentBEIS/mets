...
export const monitoringApproachFormProvider = {
  ...
  useFactory: (fb: UntypedFormBuilder, store: CommonTasksStore) => {
    ...
    return fb.group({
      monitoringApproachAppliedCorrectly: [
        { value: etsComplianceRules?.monitoringApproachAppliedCorrectly ?? null, disabled: !state.isEditable },
        { validators: [GovukValidators.required(noSelection)] },
      ],
      monitoringApproachNotAppliedCorrectlyReason: [
        { value: etsComplianceRules?.monitoringApproachNotAppliedCorrectlyReason ?? null, disabled: !state.isEditable },
        {
