...
describe('MonitoringApproachComponent', () => {
  ...
  const monitoringApproachNotAppliedCorrectlyReasonValue = 'No monitoring approach reason';
  const nextRoute = '../planned-changes';

  class Page extends BasePage<MonitoringApproachComponent> {
    get monitoringApproachAppliedCorrectlyButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="monitoringApproachAppliedCorrectly"]');
    }

    get monitoringApproachNotAppliedCorrectlyReason() {
      return this.getInputValue('#monitoringApproachNotAppliedCorrectlyReason');
    }

    set monitoringApproachNotAppliedCorrectlyReason(value: string) {
      this.setInputValue('#monitoringApproachNotAppliedCorrectlyReason', value);
    }
  ...
  describe('for new monitoring approach details', () => {
    beforeEach(() => {
    ...
    it(`should submit a valid form and navigate to ${nextRoute}`, () => {
      ...
      page.monitoringApproachAppliedCorrectlyButtons[1].click();
      page.submitButton.click();
      fixture.detectChanges();
      ...
      page.monitoringApproachNotAppliedCorrectlyReason = monitoringApproachNotAppliedCorrectlyReasonValue;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            etsComplianceRules: {
              ...
              monitoringApproachNotAppliedCorrectlyReason: monitoringApproachNotAppliedCorrectlyReasonValue,
            },
          },
  ...
  describe('for existing monitoring approach details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
