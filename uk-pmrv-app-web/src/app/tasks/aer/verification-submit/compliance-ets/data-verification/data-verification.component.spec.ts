...
describe('DataVerificationComponent', () => {
  ...
  const dataVerificationNotCompletedReasonValue = 'No data verification reason';
  const nextRoute = '../monitoring-approach';

  class Page extends BasePage<DataVerificationComponent> {
    get dataVerificationCompletedButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="dataVerificationCompleted"]');
    }

    get dataVerificationNotCompletedReason() {
      return this.getInputValue('#dataVerificationNotCompletedReason');
    }

    set dataVerificationNotCompletedReason(value: string) {
      this.setInputValue('#dataVerificationNotCompletedReason', value);
    }
  ...
  describe('for new data verification details', () => {
    beforeEach(() => {
    ...
    it(`should submit a valid form and navigate to ${nextRoute}`, () => {
      ...
      page.dataVerificationCompletedButtons[1].click();
      page.submitButton.click();
      fixture.detectChanges();
      ...
      page.dataVerificationNotCompletedReason = dataVerificationNotCompletedReasonValue;
      page.submitButton.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            etsComplianceRules: {
              ...
              dataVerificationNotCompletedReason: dataVerificationNotCompletedReasonValue,
            },
          },
  ...
  describe('for existing data verification details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
