...
describe('IdentifiedChangesComponent', () => {
  let page: Page;
  let router: Router;
  let store: CommonTasksStore;
  let activatedRoute: ActivatedRoute;
  let component: IdentifiedChangesComponent;
  let fixture: ComponentFixture<IdentifiedChangesComponent>;

  const tasksService = mockClass(TasksService);

  class Page extends BasePage<IdentifiedChangesComponent> {
    get radioButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="changesIdentified"]');
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(IdentifiedChangesComponent);
  ...
  describe('for new identified changes details', () => {
    beforeEach(() => {
    ...
    it('should submit a valid form and navigate to not reported item', () => {
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../identified-changes-list', 0], { relativeTo: activatedRoute });
    });
  ...
  describe('for existing identified changes details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
