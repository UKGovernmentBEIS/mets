...
describe('NotIncludedListGuard', () => {
  let guard: NotIncludedListGuard;
  let router: Router;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(NotIncludedListGuard);
  ...
  it('should redirect', async () => {
    ...
    await expect(
      firstValueFrom(guard.canActivate(activatedRouteSnapshot) as Observable<true | UrlTree>),
    ).resolves.toEqual(router.parseUrl('/tasks/1/aer/verification-submit/summary-of-conditions/not-included-list/0'));
