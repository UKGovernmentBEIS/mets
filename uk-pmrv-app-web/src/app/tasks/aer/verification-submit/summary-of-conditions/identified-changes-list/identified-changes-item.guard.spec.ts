...
describe('IdentifiedChangesItemGuard', () => {
  let guard: IdentifiedChangesItemGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: '/tasks/1/aer/verification-submit/summary-of-conditions/identified-changes-list/1',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(IdentifiedChangesItemGuard);
  ...
  it('should redirect to list', async () => {
    ...
    await expect(
      ...
      router.parseUrl('/tasks/1/aer/verification-submit/summary-of-conditions/identified-changes-list'),
    );
