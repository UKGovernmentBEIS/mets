...
import { DeleteComponent } from '@tasks/aer/verification-submit/non-conformities/previous-year/delete/delete.component';
...
describe('DeleteComponent', () => {
  ...
  it('should display all HTMLElements', () => {
    ...
    expect(page.heading1.textContent.trim()).toContain("Are you sure you want to delete 'E1 Explanation 1'?");
