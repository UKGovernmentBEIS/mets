...
describe('PerPlanItemComponent', () => {
  let page: Page;
  let router: Router;
  let store: CommonTasksStore;
  let activatedRoute: ActivatedRoute;
  let component: PerPlanItemComponent;
  let fixture: ComponentFixture<PerPlanItemComponent>;

  const tasksService = mockClass(TasksService);
  const route = new ActivatedRouteStub({ index: '0' });

  class Page extends BasePage<PerPlanItemComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(PerPlanItemComponent);
  ...
  describe('for new item', () => {
    ...
    it('should submit a valid form and navigate to list', () => {
      ...
      expect(page.errorSummaryList).toEqual([noNonConformityExplanation, noSelection]);
