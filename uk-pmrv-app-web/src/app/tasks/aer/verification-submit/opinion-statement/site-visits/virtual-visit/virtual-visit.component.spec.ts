...
describe('VirtualVisitComponent', () => {
  ...
  class Page extends BasePage<VirtualVisitComponent> {
  ...
  describe('for new virtual-visit details', () => {
    beforeEach(() => {
    ...
    it('should display headings, inputs and form with 0 errors', () => {
      ...
      expect(page.heading1.textContent.trim()).toEqual('Virtual site visit details');
  ...
  describe('for existing virtual-visit details', () => {
