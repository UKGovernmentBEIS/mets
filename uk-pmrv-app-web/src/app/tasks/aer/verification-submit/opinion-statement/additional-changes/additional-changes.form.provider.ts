...
export const additionalChangesFormProvider = {
  ...
  useFactory: (fb: UntypedFormBuilder, store: CommonTasksStore) => {
    ...
    return fb.group({
      additionalChangesNotCovered: [
        { value: opinionStatement?.additionalChangesNotCovered ?? null, disabled: !state.isEditable },
        { validators: [GovukValidators.required(noSelection)] },
      ],
      additionalChangesNotCoveredDetails: [
        { value: opinionStatement?.additionalChangesNotCoveredDetails ?? null, disabled: !state.isEditable },
        {
          validators: [
            GovukValidators.required(additionalChangesNotCoveredDetailsDescription),
