...
describe('RecommendedImprovementsComponent', () => {
  ...
  class Page extends BasePage<RecommendedImprovementsComponent> {
    ...
    get recommendedImprovementsButtons() {
      return this.queryAll<HTMLInputElement>('input[name$="areThereRecommendedImprovements"]');
    }
  ...
  describe('for new recommended-improvements details', () => {
    beforeEach(() => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.heading1.textContent.trim()).toEqual('Are there any recommended improvements?');
      expect(page.recommendedImprovementsButtons).toBeTruthy();
    ...
    it('should submit a valid form and navigate to `index` page', () => {
      ...
      page.recommendedImprovementsButtons[0].click();
      page.submitButton.click();
      fixture.detectChanges();
  ...
  describe('for existing recommended-improvements details', () => {
    beforeEach(() => {
      store = TestBed.inject(CommonTasksStore);
      store.setState(
        mockStateBuild({
    ...
    it('should edit, submit a valid form and navigate to `summary`', () => {
      ...
      page.recommendedImprovementsButtons[1].click();
      page.submitButton.click();
      fixture.detectChanges();
