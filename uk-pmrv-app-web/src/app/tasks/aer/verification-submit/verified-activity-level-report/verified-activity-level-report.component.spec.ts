...
import { VerifiedActivityLevelReportModule } from '@tasks/aer/verification-submit/verified-activity-level-report/verified-activity-level-report.module';
...
describe('VerifiedActivityLevelReportComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [VerifiedActivityLevelReportModule, RouterTestingModule],
      providers: [
        KeycloakService,
  ...
  describe('for new activity level report details', () => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.heading1.textContent.trim()).toEqual('Verification report of the activity level report');
