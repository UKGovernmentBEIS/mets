...
import { SummaryComponent } from '@tasks/aer/verification-submit/overall-decision/summary/summary.component';
...
describe('SummaryComponent', () => {
  ...
  it('should submit and navigate to task list', () => {
    ...
    expect(page.summaryListValues).toEqual([
      ['Not verified', 'Change', 'the monitoring plan is not approved by the competent authority', 'Change'],
    ]);
    ...
    expect(tasksService.processRequestTaskAction).toHaveBeenCalledWith(
      mockPostBuild(null, { overallAssessment: [true] }),
    );
