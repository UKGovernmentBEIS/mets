...
import { HSETIReturnLinkComponent } from './hseti-return-link.component';

describe('HSETIReturnLinkComponent', () => {
  let component: HSETIReturnLinkComponent;
  ...
  describe('for summary routes', () => {
    beforeEach(async () => {
      ...
      component = fixture.debugElement.query(By.directive(HSETIReturnLinkComponent)).componentInstance;
    });
