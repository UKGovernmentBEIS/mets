...
describe('NotifyComponent', () => {
  ...
  const mockUsers = {
    ...
    contactTypes: {
      ...
      SECONDARY: 'd83706ba-42d4-4909-b54f-e8607a56cdfd',
    },
  };

  class Page extends BasePage<NotifyComponent> {
    set assignees(value: string) {
      this.setInputValue('#assignee', value);
    }
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [RouterTestingModule, SharedModule, RfiModule],
      providers: [
