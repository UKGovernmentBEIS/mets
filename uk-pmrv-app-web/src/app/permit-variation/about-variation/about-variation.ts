...
export const nonSignificantChanges: { [key in PermitVariationModification['type']]?: string } = {
  ...
  OTHER_NON_SIGNFICANT:
    'Other non-significant changes to the Monitoring Plan (MP) or the Monitoring Methodology Plan (MMP)',
};
...
export const significantChangesMonitoringPlan: { [key in PermitVariationModification['type']]?: string } = {
  ...
  OTHER_MONITORING_PLAN: 'Other significant modifications to the Monitoring Plan (MP)',
};
...
export const significantChangesMonitoringMethodologyPlan: { [key in PermitVariationModification['type']]?: string } = {
  ...
  OTHER_MONITORING_METHODOLOGY_PLAN: 'Other significant modifications to the Monitoring Methodology Plan (MMP)',
};
