...
import { ALR_NOT_REQUIRE_FORM, alrReasonProvider } from './alr-mark-as-not-required-form.provider';
...
export class AlrMarkAsNotRequiredComponent {
  ...
  constructor(
    @Inject(ALR_NOT_REQUIRE_FORM) public form: UntypedFormGroup,
      ...
      this.requestId$
        .pipe(
          ...
          switchMap((requestId) => {
            ...
            return this.requestsService.markAsNotRequiredAlr(requestId, this.form.value);
          }),
