...
import { RevocationFinalAlrComponent } from './final-alr.component';

describe('Revocation final alr Component', () => {
  let component: RevocationFinalAlrComponent;
  let fixture: ComponentFixture<RevocationFinalAlrComponent>;
  ...
  class Page extends BasePage<RevocationFinalAlrComponent> {
    set radioOption(value: boolean) {
      this.setInputValue('#alrRequired-option0', value);
    }

    get radioOption() {
      return this.getInputValue('#alrRequired-option0');
    }

    set radioOption1(value: boolean) {
      this.setInputValue('#alrRequired-option1', value);
    }

    get radioOption1() {
      return this.getInputValue('#alrRequired-option1');
    }

    get radioBtnOption() {
      return this.query<HTMLFormElement>('input[type="radio"]#alrRequired-option0');
    }

    get radioBtnOption1() {
      return this.query<HTMLButtonElement>('input[type="radio"]#alrRequired-option1');
    }
  ...
  const route = new ActivatedRouteStub({ taskId: mockTaskState.requestTaskId }, null, {
    ...
    keys: ['alrRequired', 'alrReportDate'],
  });

  const createComponent = () => {
    fixture = TestBed.createComponent(RevocationFinalAlrComponent);
  ...
  it('should render form', () => {
    expect(component.form.get('alrRequired').value).toEqual(null);
  });
  ...
  it('should validate form with an error message for minimum date limit', () => {
    ...
    page.alrReportDateYear = year;
    page.alrReportDateMonth = month;
    page.alrReportDateDay = days;
