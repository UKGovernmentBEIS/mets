...
import { ChangesSummaryGuard } from './changes-summary.guard';

describe('ChangesSummaryGuard', () => {
  let guard: ChangesSummaryGuard;
  let router: Router;
  ...
  const routerStateSnapshot = {
    url: '/batch-variations/submit/changes-summary',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(ChangesSummaryGuard);
