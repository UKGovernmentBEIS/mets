...
@Component({
  ...
  template: `
    <app-base-action-container-component
      ...
      [expectedActionType]="['PERMIT_NOTIFICATION_APPLICATION_SUBMITTED']"></app-base-action-container-component>
    <ng-template #customContentTemplate>
      ...
      <ng-container *ngIf="notification$ | async as notification">
        <app-permit-notification-summary-details
          ...
          [files]="
            permitNotificationService.getDownloadUrlFiles(notification.documents)
          "></app-permit-notification-summary-details>
      </ng-container>
    </ng-template>
  `,
