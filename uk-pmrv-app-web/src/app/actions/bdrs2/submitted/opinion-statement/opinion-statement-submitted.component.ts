  ...
  vm: Signal<ViewModel> = computed(() => {
    ...
    return {
      ...
      opinionStatementFile: opinionStatement?.opinionStatementFile
        ? this.bdrs2ActionService.getVerifierDownloadUrlFile(opinionStatement?.opinionStatementFile)
        : ({} as any),
      supportingFiles: opinionStatement?.supportingFiles
        ? this.bdrs2ActionService.getVerifierDownloadUrlFiles(opinionStatement?.supportingFiles)
        : [],
    };
  });
