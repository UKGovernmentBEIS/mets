...
import { mockAirApplicationSubmittedRequestActionPayload } from '../submitted/testing/mock-air-submitted';
...
describe('AirImprovementItemResolver', () => {
  ...
  beforeEach(() => {
    airService = {
      payload$: of(mockAirApplicationSubmittedRequestActionPayload),
    };
