...
import { WasteGasFlowsComponent } from './waste-gas-flows.component';

describe('WasteGasFlowsComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: WasteGasFlowsComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<WasteGasFlowsComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<WasteGasFlowsComponent> {
    get wasteGasFlowsRelevant() {
      return this.query<HTMLInputElement>('#wasteGasFlowsRelevant-option0');
    }

    get dataSourcesValue1() {
      return this.getInputValue('select[name="wasteGasFlowsDataSources.0.quantification"]');
    }
    set dataSourcesValue1(value: string) {
      this.setInputValue('[name="wasteGasFlowsDataSources.0.quantification"]', value);
    }

    get dataSourcesValue2() {
      return this.getInputValue('select[name="wasteGasFlowsDataSources.0.energyContent"]');
    }
    set dataSourcesValue2(value: string) {
      this.setInputValue('[name="wasteGasFlowsDataSources.0.energyContent"]', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(WasteGasFlowsComponent);
  ...
  describe('for wasteGasFlows of mmp energy flows', () => {
    beforeEach(() => {
    ...
    it('should submit a valid form', () => {
      ...
      page.wasteGasFlowsRelevant.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            monitoringMethodologyPlans: {
              ...
              digitizedPlan: {
                energyFlows: {
                  wasteGasFlows: energyFlowsDigitizedPlan.energyFlows.wasteGasFlows,
                },
              },
            },
          },
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../electricity-flows'], {
