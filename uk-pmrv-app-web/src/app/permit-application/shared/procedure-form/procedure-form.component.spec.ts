...
describe('ProcedureFormComponent', () => {
  ...
  it('should update values on setValue', () => {
    ...
    hostComponent.form.get('procedureForm.procedureDocumentName').setValue(<any>procedure.procedureDocumentName);
    ...
    hostComponent.form
      .get('procedureForm.responsibleDepartmentOrRole')
      .setValue(<any>procedure.responsibleDepartmentOrRole);
    ...
    hostComponent.form.get('procedureForm.appliedStandards').setValue(<any>procedure.appliedStandards);
    fixture.detectChanges();
  ...
  it('should apply field validations', () => {
    ...
    hostComponent.form.get('procedureForm.procedureDocumentName').setValue(<any>'a'.repeat(1001));
    fixture.detectChanges();
    ...
    hostComponent.form.get('procedureForm.responsibleDepartmentOrRole').setValue(<any>'a'.repeat(1001));
    fixture.detectChanges();
    expect(responsibleDepartmentOrRole.errors).toEqual({
    ...
    hostComponent.form.get('procedureForm.appliedStandards').setValue(<any>'a'.repeat(2001));
    fixture.detectChanges();
