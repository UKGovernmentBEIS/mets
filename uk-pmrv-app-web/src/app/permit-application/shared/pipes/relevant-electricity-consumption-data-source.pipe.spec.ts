import { RelevantElectricityConsumptionDataSourcePipe } from './relevant-electricity-consumption-data-source.pipe';

describe('RelevantElectricityConsumptionDataSourcePipe', () => {
  const pipe = new RelevantElectricityConsumptionDataSourcePipe();
