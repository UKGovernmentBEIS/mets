...
describe('AppliedStandardFormComponent', () => {
  ...
  it('should update values on setValue', () => {
    hostComponent.form.get('appliedStandard.parameter').setValue(<any>appliedStandard.parameter);
    hostComponent.form.get('appliedStandard.appliedStandard').setValue(<any>appliedStandard.appliedStandard);
    hostComponent.form
      .get('appliedStandard.deviationFromAppliedStandardExist')
      .setValue(<any>appliedStandard.deviationFromAppliedStandardExist);
    hostComponent.form
      .get('appliedStandard.deviationFromAppliedStandardDetails')
      .setValue(<any>appliedStandard.deviationFromAppliedStandardDetails);
    hostComponent.form.get('appliedStandard.laboratoryName').setValue(<any>appliedStandard.laboratoryName);
    hostComponent.form.get('appliedStandard.laboratoryAccredited').setValue(<any>appliedStandard.laboratoryAccredited);
    hostComponent.form
      .get('appliedStandard.laboratoryAccreditationEvidence')
      .setValue(<any>appliedStandard.laboratoryAccreditationEvidence);
    fixture.detectChanges();
  ...
  it('should apply field validations', () => {
    ...
    hostComponent.form.get('appliedStandard.parameter').setValue(<any>'a'.repeat(251));
    fixture.detectChanges();
