...
describe('CalculationComponent', () => {
  ...
  describe('without source stream categories', () => {
    ...
    it('should display the tasks', () => {
      ...
      expect(page.rows).toEqual([['Calculation of CO2', '0t', '0t', '0t', '0t']]);
  ...
  describe('with source stream categories', () => {
    beforeEach(() => {
      ...
      store.setState({
        ...
        permitSectionsCompleted: {
          CALCULATION_CO2_Description: [true],
          CALCULATION_CO2_Plan: [true],
          CALCULATION_CO2_Category: [true],
          CALCULATION_CO2_Emission_Factor: [true],
          emissionPoints: [true],
    ...
    it('should display the tasks', () => {
      ...
      expect(page.rows).toEqual([
        ['Calculation of CO2', '0t', '0t', '0t', '30t'],
        [
