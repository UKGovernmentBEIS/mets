  ...
  permit: {
    ...
    monitoringApproaches: {
        ...
        inherentReceivingTransferringInstallations: [
          {
            ...
            inherentReceivingTransferringInstallationDetailsType: {
              installationDetails: {
                city: 'Est libero nulla cu',
                email: 'sononihewi@mailinator.com',
                line1: '997 Rocky Fabien Avenue',
                line2: 'Qui consequat Non r',
                postcode: 'Quaerat in amet qua',
                installationName: 'Angela Mcdowell',
              },
            },
          },
        ],
      ...
      TRANSFERRED_CO2_N2O: {
        ...
        monitoringTransportNetworkApproach: 'METHOD A',
...
export const mockPermitCompletePayload: PermitIssuanceApplicationSubmitRequestTaskPayload = {
    ...
    monitoringApproaches: {
      ...
      MEASUREMENT_N2O: {
        ...
        emissionPointCategoryAppliedTiers: [
          {
            emissionPointCategory: {
              sourceStreams: ['16285906590910.6068077459918291'],
              emissionSources: ['16322182132590.5885074834095196'],
              emissionPoint: '16285907821090.18383344328435758',
              annualEmittedCO2Tonnes: '23.8',
              categoryType: 'MAJOR',
  ...
  permitSectionsCompleted: {
    ...
    MEASUREMENT_N2O_Reference: [true],
    MEASUREMENT_N2O_Operational: [true],
    MEASUREMENT_N2O_Emissions: [true],
    MEASUREMENT_N2O_Concentration: [true],
    MEASUREMENT_N2O_Product: [true],
    MEASUREMENT_N2O_Materials: [true],
    MEASUREMENT_N2O_Gas: [true],
    MEASUREMENT_CO2_Description: [true],
    MEASUREMENT_CO2_Emission: [true],
    MEASUREMENT_CO2_Reference: [true],
    MEASUREMENT_CO2_Gasflow: [true],
    MEASUREMENT_CO2_Biomass: [true],
    MEASUREMENT_CO2_Corroborating: [true],
    MEASUREMENT_CO2_Category: [true],
    MEASUREMENT_CO2_Measured_Emissions: [true],
    ...
    TRANSFERRED_CO2_N2O_Storage: [true],
    TRANSFERRED_CO2_N2O_Transport_Network_Approach: [true],
    TRANSFERRED_CO2_N2O_Pipeline: [true],
  },
  permitAttachments: {
    '2c30c8bf-3d5e-474d-98a0-123a87eb60dd': 'cover.jpg',
    '60fe9548-ac65-492a-b057-60033b0fbbea': 'PublicationAgreement.pdf',
...
export const mockPermitCompletedReviewSectionsCompleted = {
  PERMIT_TYPE: true,
...
export const mockPermitCompletedAcceptedReviewGroupDecisions = {
