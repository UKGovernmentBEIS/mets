...
const routes: PermitRoute[] = [
    ...
    children: [
      {
        path: '',
        data: {
          pageTitle: 'Monitoring approaches - Perfluorocarbons (PFC) source stream category tier',
          backlink: '../..',
        },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'summary',
            data: {
              pageTitle: 'Monitoring approaches - Perfluorocarbons (PFC) source stream category - Summary page',
            },
      ...
      {
        path: 'activity-data',
        data: { statusKey: 'CALCULATION_PFC_Activity_Data' },
        children: [
          {
            path: '',
            data: {
  ...
  {
    path: 'description',
    data: { taskKey: 'monitoringApproaches.CALCULATION_PFC', statusKey: 'CALCULATION_PFC_Description' },
    children: [
      {
        path: '',
        data: { pageTitle: 'Monitoring approaches - Perfluorocarbons (PFC) approach description', backlink: '../' },
  ...
  {
    path: 'types',
    data: { taskKey: 'monitoringApproaches.CALCULATION_PFC.cellAndAnodeTypes', statusKey: 'CALCULATION_PFC_Types' },
    children: [
      {
        path: '',
        data: {
          pageTitle: 'Monitoring approaches - Perfluorocarbons (PFC) cell and anode types',
  ...
  },
  {
    path: 'efficiency',
    data: {
      taskKey: 'monitoringApproaches.CALCULATION_PFC.collectionEfficiency',
      statusKey: 'CALCULATION_PFC_Efficiency',
    },
    children: [
      {
        path: '',
        data: {
          pageTitle: 'Monitoring approaches - Perfluorocarbons (PFC) collection efficiency',
          backlink: '../types',
        },
    ...
    children: [
      {
        path: '',
        data: {
          pageTitle: 'Monitoring approaches - Perfluorocarbons (PFC) tier 2 emission factor',
          backlink: '../efficiency',
        },
      ...
      },
      {
        ...
        data: {
          ...
          backlink: '../determination-installation',
        },
