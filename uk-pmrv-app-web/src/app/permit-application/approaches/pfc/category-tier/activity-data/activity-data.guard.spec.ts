...
describe('ActivityDataGuard', () => {
  ...
  activatedRouteSnapshot.data = { statusKey: 'CALCULATION_PFC_Activity_Data' };
  ...
  it('should redirect to answers page if task in progress', async () => {
    ...
    await expect(
      ...
      router.parseUrl(
        `/permit-issuance/${activatedRouteSnapshot.params.taskId}/pfc/category-tier/${activatedRouteSnapshot.params.index}/activity-data/answers`,
      ),
    );
  });
  ...
  it('should redirect to summary page if task completed', async () => {
    ...
    await expect(
      ...
      router.parseUrl(
        `/permit-issuance/${activatedRouteSnapshot.params.taskId}/pfc/category-tier/${activatedRouteSnapshot.params.index}/activity-data/summary`,
      ),
    );
  });
});
