...
describe('LeakageComponent', () => {
  ...
  const route = new ActivatedRouteStub(
    ...
    {},
    {
      taskKey: 'monitoringApproaches.TRANSFERRED_CO2_N2O.transportCO2AndN2OPipelineSystems.procedureForLeakageEvents',
    },
  );

  class Page extends BasePage<LeakageComponent> {
    get leakageRadios() {
  ...
  describe('for new leakage event', () => {
    beforeEach(() => {
