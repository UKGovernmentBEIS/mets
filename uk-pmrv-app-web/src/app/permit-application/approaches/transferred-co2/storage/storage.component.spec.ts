...
describe('StorageComponent', () => {
  ...
  class Page extends BasePage<StorageComponent> {
    get geologicalStorageRadios() {
  ...
  describe('for new storage', () => {
    beforeEach(() => {
      store = TestBed.inject(PermitApplicationStore);
      store.setState(
        mockStateBuild({ monitoringApproaches: { TRANSFERRED_CO2_N2O: { geologicalStorage: undefined } } }),
      );
    });
    ...
    it('should submit a valid form', () => {
      ...
      page.geologicalStorageRadios[1].click();
      page.continueButton.click();
      fixture.detectChanges();
