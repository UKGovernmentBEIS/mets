...
export const formTierOptionsMap = {
  ...
  MEASUREMENT_CO2_Emission_Factor: {
    options: [
      {
        label: 'Tier 3',
        value: 'TIER_3',
  ...
  MEASUREMENT_CO2_Oxidation_Factor: {
    options: [
      {
        label: 'Tier 3',
        value: 'TIER_3',
  ...
  MEASUREMENT_CO2_Carbon_Content: {
    options: [
      {
        label: 'Tier 3',
        value: 'TIER_3',
  ...
  MEASUREMENT_CO2_Conversion_Factor: {
    options: [
      {
        label: 'Tier 2',
        value: 'TIER_2',
  ...
  MEASUREMENT_CO2_Biomass_Fraction: {
    options: [
      {
        label: 'Tier 3',
        value: 'TIER_3',
