...
describe('SummaryTemplateComponent', () => {
  ...
  it('should display the list of data', () => {
    const measurementApproach = mockPermitApplyPayload.permit.monitoringApproaches
      .MEASUREMENT_CO2 as MeasurementOfCO2MonitoringApproach;

    expect(page.summaryListValues).toEqual([['Approach description', measurementApproach.approachDescription]]);
  });
});
