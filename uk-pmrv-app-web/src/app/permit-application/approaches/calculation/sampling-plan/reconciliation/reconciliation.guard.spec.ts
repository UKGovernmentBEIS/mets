...
import { ReconciliationGuard } from './reconciliation.guard';

describe('ReconciliationGuard', () => {
  let router: Router;
  let guard: ReconciliationGuard;
  let store: PermitApplicationStore<PermitApplicationState>;

  const tasksService = mockClass(TasksService);
  const activatedRouteSnapshot = new ActivatedRouteSnapshot();
  activatedRouteSnapshot.url = [new UrlSegment('reconciliation', null)];
  const routerStateSnapshot = {
    url: '/permit-issuance/276/calculation/sampling-plan/reconciliation',
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(ReconciliationGuard);
          ...
          CALCULATION_CO2: {
            ...
            samplingPlan: {
              ...
              details: {
                ...
                appropriateness: {
                  ...mockCalculation.samplingPlan.details.appropriateness,
                },
              },
            },
