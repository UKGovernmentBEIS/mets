...
describe('SummaryComponent', () => {
  ...
  it('should display the list of data', () => {
    const calculationApproachData = mockPermitApplyPayload.permit.monitoringApproaches
      .CALCULATION_CO2 as CalculationOfCO2MonitoringApproach;

    expect(page.summaryListValues).toEqual([['Approach description', calculationApproachData.approachDescription]]);
  });
