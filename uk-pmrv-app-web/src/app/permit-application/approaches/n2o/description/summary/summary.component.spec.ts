...
describe('SummaryComponent', () => {
  ...
  it('should display the list of data', () => {
    const nitrousOxide = mockPermitApplyPayload.permit.monitoringApproaches
      .MEASUREMENT_N2O as MeasurementOfN2OMonitoringApproach;

    expect(page.summaryListValues).toEqual([['Approach description', nitrousOxide.approachDescription]]);
  });
