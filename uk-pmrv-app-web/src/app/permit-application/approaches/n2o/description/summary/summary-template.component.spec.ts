...
describe('SummaryTemplateComponent', () => {
  ...
  it('should display the list of data', () => {
    const n2oApproach = mockPermitApplyPayload.permit.monitoringApproaches
      .MEASUREMENT_N2O as MeasurementOfN2OMonitoringApproach;

    expect(page.summaryListValues).toEqual([['Approach description', n2oApproach.approachDescription]]);
  });
});
