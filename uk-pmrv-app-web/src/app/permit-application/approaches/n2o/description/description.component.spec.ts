...
describe('DescriptionComponent', () => {
  ...
  const route = new ActivatedRouteStub(
    {},
    {},
    { taskKey: 'monitoringApproaches.MEASUREMENT_N2O', statusKey: 'n2oDescription' },
  );
  ...
  describe('for existing approach description', () => {
    ...
    it('should fill the form from the store', () => {
      expect(page.descriptionValue).toEqual(
        store.getState().permit.monitoringApproaches.MEASUREMENT_N2O['approachDescription'],
      );
    });
