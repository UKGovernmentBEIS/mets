  ...
  useFactory: (
    ...
    return fb.group({
      ...
      measurementDevicesOrMethods: [
        {
          value: sourceStreamCategoryTier?.measurementDevicesOrMethods
            ? sourceStreamCategoryTier.measurementDevicesOrMethods.filter((device) =>
      ...
      uncertainty: [
        {
          value: sourceStreamCategoryTier?.uncertainty,
          disabled,
        },
      ],
    });
