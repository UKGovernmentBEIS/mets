...
const routes: PermitRoute[] = [
  {
    path: '',
    data: { pageTitle: 'Monitoring approaches - Fallback approach' },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'delete',
        data: { pageTitle: 'Delete source stream category', backlink: '../' },
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        data: { pageTitle: 'Monitoring approaches - Fallback approach description and justification' },
        component: DescriptionComponent,
        canDeactivate: [PendingRequestGuard],
      },
      {
        path: 'summary',
        data: { pageTitle: 'Monitoring approaches - Fallback approach description and justification - Summary page' },
    ...
    children: [
      {
        path: '',
        data: {
          pageTitle: 'Monitoring approaches - Fallback approach annual uncertainty analysis',
      ...
      {
        path: 'summary',
        data: { pageTitle: 'Monitoring approaches - Fallback approach annual uncertainty analysis - Summary page' },
