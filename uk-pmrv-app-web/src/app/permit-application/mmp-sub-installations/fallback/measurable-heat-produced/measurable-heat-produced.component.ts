...
import { measurableHeatProducedAddFormFactory } from './measurable-heat-produced-form.provider';
...
export class MeasurableHeatProducedComponent extends ProductBenchmarkComponent implements PendingRequest {
  ...
  get heatProducedDataSourcesFormArray(): FormArray {
    return this.form.get('dataSources') as FormArray;
  }

  addMeasureableHeatDataSource() {
    this.heatProducedDataSourcesFormArray.push(
      new UntypedFormGroup({
        heatProduced: new UntypedFormControl('', [
  ...
  onSubmit(): void {
    combineLatest([this.permitTask$, this.store, this.route.paramMap])
                      ...
                      ? {
                          ...
                          measurableHeat: {
                            ...
                            measurableHeatProduced: {
                              ...this.form.value,
                              ...(this.form.controls.produced.value === true
                                ? {
                                    dataSources: [
      ...
      .subscribe(() => {
        ...
        this.router.navigate(['../measurable-heat-imported'], { relativeTo: this.route });
      });
  }
}
