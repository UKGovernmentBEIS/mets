...
import { mockDigitizedPlanAnnualHeatLevel, mockDigitizedPlanDirectlyAttributableEmissionsFA } from '../../testing/mock';
import { DirectlyAttributableEmissionsFAComponent } from './directly-attributable-emissions.component';

describe('DirectlyAttributableEmissionsFAComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: DirectlyAttributableEmissionsFAComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<DirectlyAttributableEmissionsFAComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<DirectlyAttributableEmissionsFAComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(DirectlyAttributableEmissionsFAComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DirectlyAttributableEmissionsFAComponent],
