...
import { mockDigitizedPlanMeasurableHeatImported, mockDigitizedPlanMeasurableHeatProduced } from '../../testing/mock';
import { MeasurableHeatImportedComponent } from './measurable-heat-imported.component';

describe('MeasurableHeatImportedComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: MeasurableHeatImportedComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<MeasurableHeatImportedComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<MeasurableHeatImportedComponent> {
    get measurableHeatImportedActivityTypes() {
      return this.query<HTMLInputElement>('#measurableHeatImportedActivities-0');
    }
    get dataSourcesValue1() {
      return this.getInputValue('select[name="dataSources.0.MEASURABLE_HEAT_IMPORTED_OTHER_SOURCES.entity"]');
    }
    set dataSourcesValue1(value: string) {
      this.setInputValue('select[name="dataSources.0.MEASURABLE_HEAT_IMPORTED_OTHER_SOURCES.entity"]', value);
    }
    get dataSourcesValue2() {
      return this.getInputValue('select[name="dataSources.0.MEASURABLE_HEAT_IMPORTED_OTHER_SOURCES.netContent"]');
    }
    set dataSourcesValue2(value: string) {
      this.setInputValue('select[name="dataSources.0.MEASURABLE_HEAT_IMPORTED_OTHER_SOURCES.netContent"]', value);
    }
    get dataSourcesMethodologyAppliedDescriptionValue() {
      return this.getInputValue('#methodologyAppliedDescription');
    }
    get methodologyDeterminationEmissionDescriptionValue() {
      return this.getInputValue('#methodologyDeterminationEmissionDescription');
    }
    set dataSourcesMethodologyAppliedDescriptionValue(value: string) {
      this.setInputValue('#methodologyAppliedDescription', value);
    }
    set methodologyDeterminationEmissionDescriptionValue(value: string) {
      this.setInputValue('#methodologyDeterminationEmissionDescription', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(MeasurableHeatImportedComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [MeasurableHeatImportedComponent],
  ...
  describe('for existing sub installation', () => {
        ...
        mockStateBuild(
          {
            monitoringMethodologyPlans: {
              ...
              digitizedPlan: mockDigitizedPlanMeasurableHeatProduced,
            },
          },
          {
    ...
    it('should submit a valid form', () => {
      ...
      page.measurableHeatImportedActivityTypes.click();
      fixture.detectChanges();
      ...
      page.followed = true;
      page.methodologyDeterminationEmissionDescriptionValue = 'description';
      fixture.detectChanges();
