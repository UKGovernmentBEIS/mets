...
import {
  ...
  mockDigitizedPlanMeasurableHeatExported,
} from '../../testing/mock';
import { MeasurableHeatExportedComponent } from './measurable-heat-exported.component';

describe('MeasurableHeatExportedComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: MeasurableHeatExportedComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<MeasurableHeatExportedComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<MeasurableHeatExportedComponent> {
    get measurableHeatExported() {
      return this.query<HTMLInputElement>('#measurableHeatExported-option0');
    }

    get dataSourcesValue1() {
      return this.getInputValue('select[name="dataSources.0.heatExported"]');
    }
    set dataSourcesValue1(value: string) {
      this.setInputValue('[name="dataSources.0.heatExported"]', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(MeasurableHeatExportedComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [MeasurableHeatExportedComponent],
  ...
  describe('for measurableHeatExporteding sub installation', () => {
    beforeEach(() => {
    ...
    it('should submit a valid form', () => {
      ...
      page.measurableHeatExported.click();
      fixture.detectChanges();
        ...
        mockPostBuild(
          {
            monitoringMethodologyPlans: {
              measurableHeatExported: true,
              plans: ['e227ea8a-778b-4208-9545-e108ea66c113'],
              digitizedPlan: mockDigitizedPlanMeasurableHeatExported,
            },
          },
          {
