...
@Injectable()
export class MMPSubInstallationsFallbackSummaryGuard {
  constructor(
        ...
        map((state) => {
          return (
            ...
            this.router.parseUrl(
              `/${this.store.urlRequestType}/${route.paramMap.get('taskId')}/mmp-sub-installations/fallback/${subInstallationNo}`,
            )
          );
        }),
      )
