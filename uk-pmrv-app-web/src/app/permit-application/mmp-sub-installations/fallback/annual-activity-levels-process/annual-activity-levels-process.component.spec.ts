...
import {
  ...
  mockDigitizedPlanFallbackDetailsProcess,
...
import { AnnualActivityLevelsProcessComponent } from './annual-activity-levels-process.component';

describe('AnnualActivityLevelsProcessComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: AnnualActivityLevelsProcessComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<AnnualActivityLevelsProcessComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<AnnualActivityLevelsProcessComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(AnnualActivityLevelsProcessComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AnnualActivityLevelsProcessComponent],
        ...
        mockStateBuild(
          {
            monitoringMethodologyPlans: {
              ...
              digitizedPlan: mockDigitizedPlanFallbackDetailsProcess,
            },
          },
          {
