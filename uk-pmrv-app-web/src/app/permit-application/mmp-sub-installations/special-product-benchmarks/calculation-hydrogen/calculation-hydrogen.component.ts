...
import { calculationHydrogenAddFormFactory } from './calculation-hydrogen-form.provider';
    ...
    this.dataSourcesFormArray.push(
      new UntypedFormGroup({
        details: new UntypedFormGroup(
          {
            HYDROGEN_TOTAL_PRODUCTION: new UntypedFormControl(''),
            HYDROGEN_VOLUME_FRACTION: new UntypedFormControl(''),
          },
          {
            validators: [
