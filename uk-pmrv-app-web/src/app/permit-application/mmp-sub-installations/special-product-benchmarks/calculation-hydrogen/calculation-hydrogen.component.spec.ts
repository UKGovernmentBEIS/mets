...
import { mockDigitizedPlanSPHydrogen, mockDigitizedPlanWasteGasBalance } from '../../testing/mock';
import { CalculationHydrogenComponent } from './calculation-hydrogen.component';

describe('CalculationHydrogenComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: CalculationHydrogenComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<CalculationHydrogenComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<CalculationHydrogenComponent> {
    get dataSourcesValue1() {
      return this.getInputValue('select[name="dataSources.0.details.HYDROGEN_TOTAL_PRODUCTION"]');
    }
    get dataSourcesValue2() {
      return this.getInputValue('select[name="dataSources.0.details.HYDROGEN_VOLUME_FRACTION"]');
    }
    set dataSourcesValue1(value: string) {
      this.setInputValue('[name="dataSources.0.details.HYDROGEN_TOTAL_PRODUCTION"]', value);
    }
    set dataSourcesValue2(value: string) {
      this.setInputValue('[name="dataSources.0.details.HYDROGEN_VOLUME_FRACTION"]', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(CalculationHydrogenComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CalculationHydrogenComponent],
