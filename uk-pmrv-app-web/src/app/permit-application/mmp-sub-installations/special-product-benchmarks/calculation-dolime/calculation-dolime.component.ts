...
import { calculationDolimeAddFormFactory } from './calculation-dolime-form.provider';
  ...
  addDataSource() {
    this.dataSourcesFormArray.push(
      new UntypedFormGroup({
        detail: new UntypedFormControl('', [GovukValidators.required('Select the composition data')]),
      }),
    );
  }
