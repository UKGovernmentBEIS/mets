...
import { mockDigitizedPlanSPSynthesisGas, mockDigitizedPlanWasteGasBalance } from '../../testing/mock';
import { CalculationSynthesisGasComponent } from './calculation-synthesis-gas.component';

describe('CalculationSynthesisGasComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: CalculationSynthesisGasComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<CalculationSynthesisGasComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<CalculationSynthesisGasComponent> {
    get dataSourcesValue1() {
      return this.getInputValue('select[name="dataSources.0.details.SYNTHESIS_GAS_TOTAL_PRODUCTION"]');
    }
    get dataSourcesValue2() {
      return this.getInputValue('select[name="dataSources.0.details.SYNTHESIS_GAS_COMPOSITION_DATA"]');
    }
    set dataSourcesValue1(value: string) {
      this.setInputValue('[name="dataSources.0.details.SYNTHESIS_GAS_TOTAL_PRODUCTION"]', value);
    }
    set dataSourcesValue2(value: string) {
      this.setInputValue('[name="dataSources.0.details.SYNTHESIS_GAS_COMPOSITION_DATA"]', value);
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(CalculationSynthesisGasComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CalculationSynthesisGasComponent],
  ...
  describe('for existing sub installation', () => {
    ...
    it('should submit a valid form', () => {
      ...
      page.dataSourcesValue2 = 'LABORATORY_ANALYSES_SECTION_61';
