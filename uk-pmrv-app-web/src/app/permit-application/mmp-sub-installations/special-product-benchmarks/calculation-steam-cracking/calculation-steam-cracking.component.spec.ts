...
import { mockDigitizedPlanSPSteamCracking, mockDigitizedPlanWasteGasBalance } from '../../testing/mock';
import { CalculationSteamCrackingComponent } from './calculation-steam-cracking.component';

describe('CalculationSteamCrackingComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: CalculationSteamCrackingComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<CalculationSteamCrackingComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<CalculationSteamCrackingComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(CalculationSteamCrackingComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CalculationSteamCrackingComponent],
