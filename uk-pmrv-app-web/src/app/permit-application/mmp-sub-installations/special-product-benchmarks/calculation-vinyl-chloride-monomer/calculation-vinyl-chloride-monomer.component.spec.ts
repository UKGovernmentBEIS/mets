...
import { mockDigitizedPlanSPVinylChlorideMonomer, mockDigitizedPlanWasteGasBalance } from '../../testing/mock';
import { CalculationVinylChlorideMonomerComponent } from './calculation-vinyl-chloride-monomer.component';

describe('CalculationVinylChlorideMonomerComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: CalculationVinylChlorideMonomerComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<CalculationVinylChlorideMonomerComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<CalculationVinylChlorideMonomerComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(CalculationVinylChlorideMonomerComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CalculationVinylChlorideMonomerComponent],
  ...
  describe('for existing sub installation', () => {
    ...
    it('should submit a valid form', () => {
      ...
      page.dataSourcesValue1 = 'NOT_OPERATOR_CONTROL_DIRECT_READING_NOT_A';
