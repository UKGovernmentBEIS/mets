...
import { mockDigitizedPlanSPLime, mockDigitizedPlanWasteGasBalance } from '../../testing/mock';
import { CalculationLimeComponent } from './calculation-lime.component';

describe('CalculationLimeComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: CalculationLimeComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<CalculationLimeComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<CalculationLimeComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(CalculationLimeComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CalculationLimeComponent],
