...
import { aromaticsFormFactory, relevantCWTFunctions } from './calculation-aromatics.component-form.provider';
...
export class CalculationAromaticsComponent extends ProductBenchmarkComponent implements PendingRequest {
  ...
  relevantCWTFunctions = relevantCWTFunctions;
                    ...
                    item.subInstallationNo === paramMap.get('subInstallationNo')
                      ? {
                          ...
                          specialProduct: {
                            ...this.form.value,
                            dataSources:
                              this.form.value?.dataSources?.length > 0
                                ? [
                                    ...this.form.value.dataSources.reduce(
