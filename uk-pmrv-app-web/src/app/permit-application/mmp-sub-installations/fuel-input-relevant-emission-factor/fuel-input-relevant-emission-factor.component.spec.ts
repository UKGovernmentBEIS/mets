...
import { FuelInputRelevantEmissionFactorComponent } from './fuel-input-relevant-emission-factor.component';

describe('FuelInputRelevantEmissionFactorComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: FuelInputRelevantEmissionFactorComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<FuelInputRelevantEmissionFactorComponent>;

  const attachmentService = mockClass(RequestTaskAttachmentsHandlingService);
  const route = new ActivatedRouteStub({ subInstallationNo: '0' }, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<FuelInputRelevantEmissionFactorComponent> {
    get exist() {
      return this.query<HTMLInputElement>('#exist-option0');
    }

    get dataSourcesValue1() {
      return this.getInputValue('select[name="dataSources.0.fuelInput"]');
    }
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(FuelInputRelevantEmissionFactorComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [FuelInputRelevantEmissionFactorComponent],
  ...
  describe('for existing sub installation', () => {
    ...
    it('should submit a valid form', () => {
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../imported-exported-measurable-heat'], {
