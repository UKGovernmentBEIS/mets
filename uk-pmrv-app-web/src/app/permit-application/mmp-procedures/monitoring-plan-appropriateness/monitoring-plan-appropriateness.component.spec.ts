...
import { MonitoringPlanAppropriatenessComponent } from './monitoring-plan-appropriateness.component';

describe('MonitoringPlanAppropriatenessComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: MonitoringPlanAppropriatenessComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<MonitoringPlanAppropriatenessComponent>;

  const route = new ActivatedRouteStub({}, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<MonitoringPlanAppropriatenessComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(MonitoringPlanAppropriatenessComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [MonitoringPlanAppropriatenessComponent, MmpProcedureFormComponent],
  ...
  describe('for new mmp methods', () => {
    ...
    it('should submit a valid form', () => {
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../data-flow-activities'], {
