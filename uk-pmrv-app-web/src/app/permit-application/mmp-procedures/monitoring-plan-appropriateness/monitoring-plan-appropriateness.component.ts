...
import { MonitoringPlanAppropriatenessFormProvider } from './monitoring-plan-appropriateness-form.provider';
...
export class MonitoringPlanAppropriatenessComponent implements PendingRequest {
  ...
  onContinue(): void {
    combineLatest([this.permitTask$, this.store])
            ...
            permitTask,
            {
              ...
              digitizedPlan: {
                ...
                procedures: {
                  ...
                  ['MONITORING_PLAN_APPROPRIATENESS']: this.form.value,
                },
              },
            },
            false,
      ...
      .subscribe(() => this.router.navigate(['../data-flow-activities'], { relativeTo: this.route }));
  }
}
