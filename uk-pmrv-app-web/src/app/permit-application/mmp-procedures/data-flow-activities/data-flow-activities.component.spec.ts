...
import { DataFlowActivitiesComponent } from './data-flow-activities.component';

describe('DataFlowActivitiesComponent', () => {
  let page: Page;
  let store: PermitApplicationStore<PermitApplicationState>;
  let component: DataFlowActivitiesComponent;
  let activatedRoute: ActivatedRoute;
  let router: Router;
  let fixture: ComponentFixture<DataFlowActivitiesComponent>;

  const route = new ActivatedRouteStub({}, {}, { permitTask: 'monitoringMethodologyPlans' });

  class Page extends BasePage<DataFlowActivitiesComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(DataFlowActivitiesComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DataFlowActivitiesComponent, MmpProcedureFormComponent],
  ...
  describe('for new mmp methods', () => {
    ...
    it('should submit a valid form', () => {
      ...
      expect(navigateSpy).toHaveBeenCalledWith(['../control-activities'], {
