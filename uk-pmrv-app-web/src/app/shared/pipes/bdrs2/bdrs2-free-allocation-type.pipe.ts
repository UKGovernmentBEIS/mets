  ...
  transform(value: BDRS2GuardQuestions['continueApplicationForFreeAllocationType']): string {
    switch (value) {
      case 'CONTINUE_AS_MAIN_SCHEME_PARTICIPANT':
        return 'Yes, I hold a GHGE permit and want to continue my application for free allocation as a main scheme participant, or I currently hold HSE status and want to become a main scheme participant from 2027';
