import { CrfActivityItemNamePipe } from './crf-activity-item-name.pipe';

describe('CrfActivityItemNamePipe', () => {
  let pipe: CrfActivityItemNamePipe;

  beforeEach(async () => {
    pipe = new CrfActivityItemNamePipe();
  });
  ...
  it('should transform value', () => {
    ...
    expect(pipe.transform('_1_A_2_GVIII_STATIONARY_COMBUSTION_IN_MANUFACTURING_AND_CONSTRUCTION_OTHER')).toEqual(
    ...
    expect(pipe.transform('_2_G_2_SF_6_AND_PFCS_FROM_OTHER_PRODUCT_USE')).toEqual(
      '2.G.2 SF6 and PFCs from Other Product Use',
    );
    expect(pipe.transform('_2_G_3_N_2_O_FROM_PRODUCT_USES')).toEqual('2.G.3 N2O from Product Uses');
