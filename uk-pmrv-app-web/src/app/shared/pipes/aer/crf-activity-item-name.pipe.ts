...
export class CrfActivityItemNamePipe implements PipeTransform {
  transform(activityItem?: AerRegulatedActivity['energyCrf'] | AerRegulatedActivity['industrialCrf']): string {
    switch (activityItem) {
      ...
      case '_1_A_2_GVIII_STATIONARY_COMBUSTION_IN_MANUFACTURING_AND_CONSTRUCTION_OTHER':
      ...
      case '_2_G_2_SF_6_AND_PFCS_FROM_OTHER_PRODUCT_USE':
        return '2.G.2 SF6 and PFCs from Other Product Use';
      case '_2_G_3_N_2_O_FROM_PRODUCT_USES':
