...
import { EmissionPointsTableComponent } from './emission-points-table.component';
...
describe('EmissionPointsTableComponent', () => {
  ...
  let component: EmissionPointsTableComponent;
  ...
  const createComponent = () => {
    ...
    component = fixture.debugElement.query(By.directive(EmissionPointsTableComponent)).componentInstance;
