...
describe('DecisionComponent', () => {
  ...
  class Page extends BasePage<TestComponent> {
    ...
    get acceptanceReason() {
      return this.getInputValue('#acceptanceReason');
    }

    set acceptanceReason(value: string) {
      this.setInputValue('#acceptanceReason', value);
    }
  }
