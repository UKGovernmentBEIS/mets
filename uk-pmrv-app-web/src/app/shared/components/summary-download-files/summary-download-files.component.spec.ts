...
describe('SummaryDownloadFilesComponent', () => {
  ...
  describe('for permit files', () => {
    ...
    it('should display files', () => {
      ...
      expect(page.items).toEqual([
        [
          'http://localhost/permit-issuance/237/file-download/attachment/2c30c8bf-3d5e-474d-98a0-123a87eb60dd',
          'cover.jpg',
        ],
        [
          'http://localhost/permit-issuance/237/file-download/attachment/60fe9548-ac65-492a-b057-60033b0fbbea',
  ...
  describe('for permit action files', () => {
    ...
    it('should display files', () => {
      ...
      expect(page.items).toEqual([
        [
          'http://localhost/permit-issuance/action/1/file-download/attachment/2c30c8bf-3d5e-474d-98a0-123a87eb60dd',
          'cover.jpg',
        ],
        [
          'http://localhost/permit-issuance/action/1/file-download/attachment/60fe9548-ac65-492a-b057-60033b0fbbea',
          'PublicationAgreement.pdf',
        ],
      ]);
    });
