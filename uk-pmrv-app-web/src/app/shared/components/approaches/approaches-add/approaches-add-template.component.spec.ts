...
describe('ApproachesAddTemplateComponent', () => {
  ...
  class TestComponent {
    form = new FormGroup({
      ...
      hasTransferCalculationCO2: new FormControl(null),
      hasTransferMeasurementCO2: new FormControl(null),
      hasTransferMeasurementN2O: new FormControl(null),
    });
    monitoringApproaches = { CALCULATION_CO2: 'CALCULATION_CO2' };
