...
import { ALRRejectAuthorityResponse } from 'pmrv-api';

import {
  AlrAuthoritySummaryTemplateComponent,
  AlrSummaryAuthorityResponse,
} from './authority-summary-template.component';

describe('AlrAuthoritySummaryTemplateComponent', () => {
  ...
  class TestComponent {
    ...
    } as AlrSummaryAuthorityResponse;
    editable = true;
  }
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [RouterTestingModule, AlrAuthoritySummaryTemplateComponent, SharedModule],
    }).compileComponents();
