...
import { AlrBulkDownloadsComponent } from './alr.component';

describe('AlrBulkDownloadsComponent (ngOnInit behavior)', () => {
  let fixture: ComponentFixture<AlrBulkDownloadsComponent>;
  let component: AlrBulkDownloadsComponent;
  let page: Page;
  ...
  class Page extends BasePage<AlrBulkDownloadsComponent> {
    get rows() {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SharedModule, TaskSharedModule, AlrBulkDownloadsComponent],
      providers: [
        provideRouter([{ path: 'alr', component: RouterStubComponent }]),
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AlrBulkDownloadsComponent);
