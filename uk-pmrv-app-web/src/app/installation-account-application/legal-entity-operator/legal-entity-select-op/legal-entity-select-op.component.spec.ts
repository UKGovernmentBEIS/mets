...
import { LegalEntitySelectOpComponent } from './legal-entity-select-op.component';
...
describe('LegalEntitySelectOpComponent', () => {
  let component: LegalEntitySelectOpComponent;
  let fixture: ComponentFixture<LegalEntitySelectOpComponent>;
  let page: Page;
  let router: Router;
  ...
  class Page extends BasePage<LegalEntitySelectOpComponent> {
    get optionValues() {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [LegalEntitySelectOpComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LegalEntitySelectOpComponent);
  ...
  it('should navigate to regno if new', () => {
    changeInputValue(fixture, '#isNew-option1');
    page.submitButton.click();
    fixture.detectChanges();

    expect(navigateSpy).toHaveBeenCalledWith(['../regno'], { relativeTo: TestBed.inject(ActivatedRoute) });
