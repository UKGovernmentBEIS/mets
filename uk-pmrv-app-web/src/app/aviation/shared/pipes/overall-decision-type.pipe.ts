...
import { AviationAerVerificationDecision } from 'pmrv-api';

@Pipe({ name: 'verificationDecisionType', standalone: true })
export class AviationOverallDecisionTypePipe implements PipeTransform {
  transform(assessmentType: AviationAerVerificationDecision['type'], isCorsia?: boolean): string {
