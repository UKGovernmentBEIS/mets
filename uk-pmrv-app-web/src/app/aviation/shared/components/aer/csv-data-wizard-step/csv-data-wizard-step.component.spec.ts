...
import { CsvDataWizardStepComponent } from './csv-data-wizard-step.component';

describe('CsvDataWizardStepComponent', () => {
  let component: CsvDataWizardStepComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, GovukComponentsModule, RouterTestingModule, CsvDataWizardStepComponent],
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(By.directive(CsvDataWizardStepComponent)).componentInstance;
