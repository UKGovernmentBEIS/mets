...
import { EmpVariationReviewDecisionGroupSummaryComponent } from './emp-variation-review-decision-group-summary.component';

describe('EmpVariationReviewDecisionGroupSummaryComponent', () => {
  let component: EmpVariationReviewDecisionGroupSummaryComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [RouterTestingModule, SharedModule, EmpVariationReviewDecisionGroupSummaryComponent],
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(
      By.directive(EmpVariationReviewDecisionGroupSummaryComponent),
    ).componentInstance;
