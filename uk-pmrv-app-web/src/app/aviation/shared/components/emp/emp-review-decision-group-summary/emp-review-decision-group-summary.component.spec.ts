...
import { EmpReviewDecisionGroupSummaryComponent } from './emp-review-decision-group-summary.component';

describe('EmpReviewDecisionGroupSummaryComponent', () => {
  let component: EmpReviewDecisionGroupSummaryComponent;
  ...
  @Component({
    template: `
      <app-emp-review-decision-group-summary
        ...
        downloadBaseUrl="test-link"></app-emp-review-decision-group-summary>
    `,
  })
  class TestComponent {
    data = {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [RouterTestingModule, SharedModule, EmpReviewDecisionGroupSummaryComponent],
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(By.directive(EmpReviewDecisionGroupSummaryComponent)).componentInstance;
