...
import { AviationVirApplicationSubmittedRequestActionPayload, UncorrectedItem } from 'pmrv-api';
...
describe('ReferenceItemComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SharedModule, RequestActionTaskComponent, ReferenceItemComponent],
      providers: [
