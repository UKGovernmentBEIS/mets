...
import { AerReturnForAmendsComponent } from './aer-return-for-amends.component';

describe('AerReturnForAmendsComponent', () => {
  let component: AerReturnForAmendsComponent;
  let fixture: ComponentFixture<AerReturnForAmendsComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(AerReturnForAmendsComponent);
