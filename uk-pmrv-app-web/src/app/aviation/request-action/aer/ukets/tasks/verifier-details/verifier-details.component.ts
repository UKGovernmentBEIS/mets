    ...
    <app-request-action-task
      *ngIf="vm$ | async as vm"
      ...
      <app-aer-verifier-details-group-form
        [verificationReport]="vm.verificationReportData"></app-aer-verifier-details-group-form>
  ...
  vm$: Observable<ViewModel & AerDecisionViewModel> = combineLatest([
    ...
    map(([payload, requestActionType, regulatorViewer]) => {
      return {
        ...
        ...getAerDecisionReview(payload, requestActionType, regulatorViewer, 'verificationReport', false),
      };
    }),
  );
}
