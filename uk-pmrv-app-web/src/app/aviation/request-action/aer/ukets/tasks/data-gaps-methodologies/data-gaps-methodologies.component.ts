    ...
    <app-request-action-task
      *ngIf="vm$ | async as vm"
      ...
      <app-data-gaps-methodologies-group
        [dataGapsMethodologies]="vm.dataGapsMethodologies"></app-data-gaps-methodologies-group>
  ...
  vm$: Observable<ViewModel & AerDecisionViewModel> = combineLatest([
    ...
    map(([payload, requestActionType, regulatorViewer]) => {
      return {
        ...
        ...getAerDecisionReview(payload, requestActionType, regulatorViewer, 'dataGapsMethodologies', false),
      };
    }),
  );
}
