...
import GeneralInformationComponent from '@aviation/request-action/aer/corsia/tasks/general-information/general-information.component';
...
describe('GeneralInformationComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SharedModule, RequestActionTaskComponent, GeneralInformationComponent],
      providers: [
  ...
  it('should show task details', () => {
    expect(page.header).toEqual('Verification criteria and operator data');
