...
import TimeAllocationComponent from '@aviation/request-action/aer/corsia/tasks/time-allocation/time-allocation.component';
...
describe('TimeAllocationComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SharedModule, RequestActionTaskComponent, TimeAllocationComponent],
      providers: [
  ...
  it('should show task details', () => {
    expect(page.header).toEqual('Time allocation and scope');
