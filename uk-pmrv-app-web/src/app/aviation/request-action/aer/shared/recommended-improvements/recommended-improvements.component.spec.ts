...
describe('RecommendedImprovementsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SharedModule, RequestActionTaskComponent, RecommendedImprovementsComponent],
      providers: [
  ...
  it('should show task details', () => {
    expect(page.header).toEqual('Recommended improvements');

    expect(page.summaryValues).toEqual([['Are there any recommended improvements?', 'Yes']]);
  });
});
