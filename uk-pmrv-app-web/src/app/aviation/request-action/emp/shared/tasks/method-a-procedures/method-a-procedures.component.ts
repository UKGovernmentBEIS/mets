...
@Component({
  selector: 'app-method-a-procedures',
  standalone: true,
  imports: [
  ...
  templateUrl: './method-a-procedures.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MethodAProceduresComponent {
  ...
  vm$: Observable<ViewModel & EmpSubmittedViewModel> = combineLatest([
    ...
    map(([payload, regulatorViewer, requestActionType]) => ({
      data: payload.emissionsMonitoringPlan.methodAProcedures,
