...
import { MethodAProceduresComponent } from '@aviation/request-action/emp/shared/tasks/method-a-procedures/method-a-procedures.component';
...
class Page extends BasePage<MethodAProceduresComponent> {
  get header(): string {
...
describe('MethodAProceduresComponent', () => {
  let component: MethodAProceduresComponent;
  let fixture: ComponentFixture<MethodAProceduresComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [RequestActionTaskComponent, EmpReviewDecisionGroupSummaryComponent, MethodAProceduresComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(MethodAProceduresComponent);
  ...
  it('should show task details', () => {
    expect(page.header).toEqual('Method A procedures');
