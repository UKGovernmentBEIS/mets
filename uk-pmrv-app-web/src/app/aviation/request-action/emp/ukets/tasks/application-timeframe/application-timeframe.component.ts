...
@Component({
  ...
  templateUrl: './application-timeframe.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ApplicationTimeframeComponent {
  ...
  vm$: Observable<ViewModel & EmpSubmittedViewModel> = combineLatest([
    ...
    map(([payload, regulatorViewer, requestActionType]) => ({
      data: payload.emissionsMonitoringPlan.applicationTimeframeInfo,
