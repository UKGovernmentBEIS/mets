...
import { SummaryComponent } from '@aviation/request-task/aer/corsia/aer-verify/tasks/time-allocation/summary/summary.component';
  ...
  it('should submit a valid form and navigate to task list page', () => {
    ...
    expect(tasksService.processRequestTaskAction).toHaveBeenCalledWith({
      ...
      requestTaskActionPayload: {
        ...
        verificationSectionsCompleted: { timeAllocationScope: [true] },
