...
export class DataSamplingComponent {
  form = new FormGroup(
    {
      dataSampling: this.formProvider.dataSamplingCtrl,
      dataSamplingResults: this.formProvider.dataSamplingResultsCtrl,
    },
    { updateOn: 'change' },
  );
  ...
  onSubmit() {
    (this.store.aerVerifyDelegate as AerVerifyCorsiaStoreDelegate)
      ...
      .subscribe(() => this.router.navigate(['../compliance'], { relativeTo: this.route }));
  }
}
