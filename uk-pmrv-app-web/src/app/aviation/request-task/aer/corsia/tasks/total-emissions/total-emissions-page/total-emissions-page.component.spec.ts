...
describe('TotalEmissionsPageComponent', () => {
  let component: TotalEmissionsPageComponent;
  ...
  class Page extends BasePage<TotalEmissionsPageComponent> {
    get appSchemeCorsia() {
  ...
  it('should call saveAer on submit and redirect to task list', async () => {
    ...
    expect(saveAerSpy).toHaveBeenCalledWith({ totalEmissionsCorsia: undefined }, 'in progress');
