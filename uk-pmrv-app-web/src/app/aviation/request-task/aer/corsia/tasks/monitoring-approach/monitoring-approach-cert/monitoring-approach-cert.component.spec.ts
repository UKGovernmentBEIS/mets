...
import { MonitoringApproachCertComponent } from './monitoring-approach-cert.component';

describe('MonitoringApproachCertComponent', () => {
  let component: MonitoringApproachCertComponent;
  let fixture: ComponentFixture<MonitoringApproachCertComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MonitoringApproachCertComponent, RouterTestingModule],
      providers: [
    ...
    fixture = TestBed.createComponent(MonitoringApproachCertComponent);
  ...
  it('should show form errors', async () => {
    ...
    expect(screen.getAllByText(/Select a monitoring approach/)).toHaveLength(2);
  });
  ...
  it('should call the saveAer function with the correct data when the form is valid and navigate to next page', async () => {
    ...
    component.form.setValue(monitoringApproach);
    component.form.markAsDirty();
    component.onSubmit();

    expect(saveAerSpy).toHaveBeenCalledTimes(1);
    expect(saveAerSpy).toHaveBeenCalledWith(data, 'in progress');
    expect(navigateSpy).toHaveBeenCalledWith(['cert-usage'], { relativeTo: activatedRouteStub });
  });
});
