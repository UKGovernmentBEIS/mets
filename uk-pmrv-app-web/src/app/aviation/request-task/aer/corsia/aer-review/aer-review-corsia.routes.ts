...
const AER_REVIEW_VERIFICATION_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/general-information/general-information.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/verify-monitoring-approach/verify-monitoring-approach.component').then(
        (c) => c.VerifyMonitoringApproachComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/verify-emissions-reduction-claim/verify-emissions-reduction-claim.component').then(
        (c) => c.VerifyEmissionsReductionClaimComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/uncorrected-misstatements/uncorrected-misstatements.component').then(
        (c) => c.UncorrectedMisstatementsComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/uncorrected-non-conformities/uncorrected-non-conformities.component').then(
        (c) => c.UncorrectedNonConformitiesComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/uncorrected-non-compliances/uncorrected-non-compliances.component').then(
        (c) => c.UncorrectedNonCompliancesComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/recommended-improvements/recommended-improvements.component').then(
        (c) => c.RecommendedImprovementsComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('@aviation/request-task/aer/corsia/aer-review/tasks/verifiers-conclusions/verifiers-conclusions.component').then(
        (c) => c.VerifiersConclusionsComponent,
      ),
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      ...AER_CORSIA_CHILD_ROUTES,
      {
        ...
        loadComponent: () =>
          import('@aviation/request-task/aer/corsia/aer-review/tasks/reporting-obligation-details/reporting-obligation-details.component').then(
            (c) => c.ReportingObligationDetailsComponent,
          ),
      },
      {
