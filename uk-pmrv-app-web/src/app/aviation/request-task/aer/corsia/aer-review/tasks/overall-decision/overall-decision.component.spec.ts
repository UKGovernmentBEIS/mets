...
describe('OverallDecisionComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [OverallDecisionComponent, RouterTestingModule],
        ...
        requestTask: {
          ...
          payload: {
            ...
            verificationReport: {
              ...
              } as AviationAerVerificationDecision,
  ...
  it('should show summary values', () => {
    expect(page.summaryValues).toEqual([
      ['Decision', 'Verified as not satisfactory'],
      ['Reason', 'An uncorrected material misstatement (individual or in aggregate)'],
    ]);
  });
});
