...
const selectRecommendedImprovements: OperatorFunction<RequestTaskState, AviationAerRecommendedImprovements> = pipe(
  selectVerificationReport,
  map((verificationReport) => verificationReport.recommendedImprovements),
);
...
export const recommendedImprovementsQuery = {
  selectPayload,
  selectVerificationReport,
