...
import { MisstatementItemComponent } from './misstatement-item.component';

describe('MisstatementItemComponent', () => {
  let page: Page;
  let router: Router;
  let store: RequestTaskStore;
  let activatedRoute: ActivatedRoute;
  let component: MisstatementItemComponent;
  let fixture: ComponentFixture<MisstatementItemComponent>;

  const route = new ActivatedRouteStub({ index: '0' });

  class Page extends BasePage<MisstatementItemComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(MisstatementItemComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MisstatementItemComponent, RouterTestingModule],
      providers: [
  ...
  describe('for new item', () => {
    ...
    it('should submit a valid form and navigate to list', () => {
      ...
      expect(page.errorSummaryList).toEqual([
        'Add a description of the misstatement',
