...
const selectUncorrectedNonCompliances: OperatorFunction<RequestTaskState, AviationAerUncorrectedNonCompliances> = pipe(
  selectVerificationReport,
  map((verificationReport) => verificationReport.uncorrectedNonCompliances),
);
...
export const uncorrectedNonCompliancesQuery = {
  selectPayload,
  selectVerificationReport,
