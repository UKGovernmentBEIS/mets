...
import { IssuingAuthoritiesService, TasksService } from 'pmrv-api';
...
describe('OperatorDetailsAirOperatingCertificateComponent', () => {
  ...
  it('should call the saveAer function with the correct data when the form is valid and navigate to operating license page', async () => {
