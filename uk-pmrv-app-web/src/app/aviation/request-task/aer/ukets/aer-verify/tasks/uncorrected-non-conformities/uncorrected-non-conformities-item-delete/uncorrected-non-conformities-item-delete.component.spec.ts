...
import UncorrectedNonConformitiesItemDeleteComponent from './uncorrected-non-conformities-item-delete.component';
...
describe('UncorrectedNonConformitiesItemDeleteComponent', () => {
  ...
  class Page extends BasePage<UncorrectedNonConformitiesItemDeleteComponent> {
    get header() {
  ...
  const createComponent = () => {
    ...
    fixture.componentInstance.formProvider.setFormValue(uncorrectedNonConformities);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UncorrectedNonConformitiesItemDeleteComponent, RouterTestingModule],
      providers: [
