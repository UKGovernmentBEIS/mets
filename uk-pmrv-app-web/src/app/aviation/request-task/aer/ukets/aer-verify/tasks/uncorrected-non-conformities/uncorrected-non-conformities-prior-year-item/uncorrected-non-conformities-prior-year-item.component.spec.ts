...
import UncorrectedNonConformitiesPriorYearItemComponent from './uncorrected-non-conformities-prior-year-item.component';

describe('UncorrectedNonConformitiesPriorYearItemComponent', () => {
  let fixture: ComponentFixture<UncorrectedNonConformitiesPriorYearItemComponent>;
  let page: Page;
  let router: Router;
  ...
  class Page extends BasePage<UncorrectedNonConformitiesPriorYearItemComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(UncorrectedNonConformitiesPriorYearItemComponent);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UncorrectedNonConformitiesPriorYearItemComponent, RouterTestingModule],
      providers: [
  ...
  describe('for new item', () => {
    ...
    it('should submit a valid form and navigate to list', () => {
      ...
      expect(page.errorSummaryList).toEqual([
        'Describe the non-conformity from the previous year that has not been resolved',
      ]);
