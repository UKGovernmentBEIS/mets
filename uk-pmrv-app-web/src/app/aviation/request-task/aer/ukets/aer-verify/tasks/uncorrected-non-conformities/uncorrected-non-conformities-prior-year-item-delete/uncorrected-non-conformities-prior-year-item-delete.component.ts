...
export default class UncorrectedNonConformitiesPriorYearItemDeleteComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.referenceNumber = this.uncorrectedNonConformities.priorYearIssues.find(
  ...
  onDelete() {
    const uncorrectedNonConformitiesValue: AviationAerUncorrectedNonConformities = {
      ...
      priorYearIssues: (this.uncorrectedNonConformities as AviationAerUncorrectedNonConformities).priorYearIssues
