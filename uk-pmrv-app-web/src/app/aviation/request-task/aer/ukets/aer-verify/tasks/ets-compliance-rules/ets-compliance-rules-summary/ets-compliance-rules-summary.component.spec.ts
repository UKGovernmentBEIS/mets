...
import EtsComplianceRulesSummaryComponent from './ets-compliance-rules-summary.component';

describe('EtsComplianceRulesSummaryComponent', () => {
  let fixture: ComponentFixture<EtsComplianceRulesSummaryComponent>;
  let router: Router;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [EtsComplianceRulesSummaryComponent, RouterTestingModule],
      providers: [
    ...
    fixture = TestBed.createComponent(EtsComplianceRulesSummaryComponent);
