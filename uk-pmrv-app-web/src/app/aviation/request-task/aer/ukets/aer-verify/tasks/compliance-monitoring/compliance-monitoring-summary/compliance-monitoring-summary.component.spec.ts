...
import ComplianceMonitoringSummaryComponent from './compliance-monitoring-summary.component';

describe('EtsComplianceRulesSummaryComponent', () => {
  let fixture: ComponentFixture<ComplianceMonitoringSummaryComponent>;
  let router: Router;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ComplianceMonitoringSummaryComponent, RouterTestingModule],
      providers: [
    ...
    fixture = TestBed.createComponent(ComplianceMonitoringSummaryComponent);
