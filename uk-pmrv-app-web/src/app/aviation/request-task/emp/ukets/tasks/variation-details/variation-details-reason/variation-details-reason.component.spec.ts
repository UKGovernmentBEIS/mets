...
import { VariationDetailsReasonComponent } from '@aviation/request-task/emp/ukets/tasks/variation-details/variation-details-reason/variation-details-reason.component';
...
describe('VariationDetailsReasonComponent', () => {
  ...
  beforeEach(async () => {
    ...
    formProvider.setFormValue({
      ...
      ...store.empUkEtsDelegate.payload.reasonRegulatorLed,
    } as EmpVariationUkEtsDetails & EmpVariationUkEtsRegulatorLedReason);
