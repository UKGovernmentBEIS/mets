...
export interface UkEtsOperatorDetailsFormModel {
  ...
  implements TaskFormProvider<EmpOperatorDetailsViewModel, OperatorDetailsFormModel>
{
  ...
  private disableOperatingLicenseFormGroupConditionally() {
    ...
    if (!operatingLicenseControl) return;
  ...
  private airOperatingCertificateCreateInitialForm() {
    const form = this.fb.group(
      {
        certificateExist: new FormControl<EmpOperatorDetails['airOperatingCertificate']['certificateExist']>(null, {
          validators: GovukValidators.required(
            'Select if you have an Air Operating Certificate or equivalent certification',
          ),
        }),
        certificateNumber: new FormControl<EmpOperatorDetails['airOperatingCertificate']['certificateNumber']>(null, {
          validators: [
        ...
        issuingAuthority: new FormControl<EmpOperatorDetails['airOperatingCertificate']['issuingAuthority']>(null, {
  ...
  private organisationStructureCreateInitialForm() {
    const partners = (
      this.store.empUkEtsDelegate.payload.emissionsMonitoringPlan.operatorDetails
    ...
    const form = this.fb.group(
      {
        ...
        operationScopes: new FormControl([], {
          validators: GovukValidators.required(
            'Select if your scope of operation is UK domestic or UK to EEA countries',
          ),
        }),
      },
      { updateOn: 'change' },
