...
@Component({
  selector: 'app-management-procedures-corrections',
  templateUrl: './management-procedures-corrections.component.html',
  standalone: true,
  imports: [SharedModule, RouterLinkWithHref, ProcedureFormStepComponent, ProcedureFormPageHeaderDirective],
  providers: [DestroySubject],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ManagementProceduresCorrectionsComponent implements OnInit, OnDestroy {
  ...
  form = this.formProvider.correctionsAndCorrectiveActionsCtrl;
  ...
  onSubmit() {
    this.store.empUkEtsDelegate
      ...
      .subscribe(() => {
        ...
        this.router.navigate(['../outsourced-activities'], { relativeTo: this.route });
      });
  }
}
