...
import { EmpOperatorDetails, PartnershipOrganisation, TasksService } from 'pmrv-api';
...
describe('OperatorDetailsNameComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [OperatorDetailsNameComponent],
      providers: [
  ...
  it('should call the saveEmp function with the correct data when the form is valid and navigate to flight identification page', async () => {
    ...
    const operatorName = 'Operator name' as EmpOperatorDetails['operatorName'];
    const crcoCode = 'CRCO code' as EmpOperatorDetails['crcoCode'];
