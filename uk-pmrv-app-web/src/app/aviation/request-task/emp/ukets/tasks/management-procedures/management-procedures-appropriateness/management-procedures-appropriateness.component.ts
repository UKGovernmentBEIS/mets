...
@Component({
  selector: 'app-management-procedures-appropriateness',
  templateUrl: './management-procedures-appropriateness.component.html',
  standalone: true,
  imports: [SharedModule, RouterLinkWithHref, ProcedureFormStepComponent, ProcedureFormPageHeaderDirective],
  providers: [DestroySubject],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ManagementProceduresAppropriatenessComponent implements OnInit, OnDestroy {
  ...
  form = this.formProvider.monitoringPlanAppropriatenessCtrl;
