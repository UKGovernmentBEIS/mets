...
import { EmpOperatorDetails, IssuingAuthoritiesService } from 'pmrv-api';
...
export abstract class BaseOperatorDetailsComponent implements OnInit {
  ...
  getform(operatorDetailsSection: keyof EmpOperatorDetails) {
  ...
  submitForm(
    formControlName: keyof EmpOperatorDetails,
    operatorDetails: EmpOperatorDetails,
    navigateTo: string,
