...
export class OperatorDetailsOrganisationStructureComponent extends BaseOperatorDetailsComponent implements OnInit {
  ...
  onSubmit() {
    const formObjectToSubmit = this.cleanUpFormBeforeSubmit();

    const operatorDetails = {
      ...this.operatorDetails,
      organisationStructure: formObjectToSubmit,
    };
    this.submitForm('organisationStructure', operatorDetails, 'activities-description');
  }
