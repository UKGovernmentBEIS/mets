...
import { EmissionSourcesPageComponent } from './emission-sources-page.component';

describe('EmissionSourcesPageComponent', () => {
  let result: RenderResult<EmissionSourcesPageComponent>;

  beforeEach(async () => {
    result = await render(EmissionSourcesPageComponent, {
      providers: [
