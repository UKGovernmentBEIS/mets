...
import FlightProceduresAircraftUsedComponent from './flight-procedures-aircraft-used.component';

describe('FlightProceduresAircraftUsedComponent', () => {
  let fixture: ComponentFixture<FlightProceduresAircraftUsedComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FlightProceduresAircraftUsedComponent, RouterTestingModule],
      providers: [
    ...
    fixture = TestBed.createComponent(FlightProceduresAircraftUsedComponent);
  ...
  it('should submit and navigate to completeness-of-the-flights-list', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['completeness-of-the-flights-list'], { relativeTo: activatedRoute });
  });
});
