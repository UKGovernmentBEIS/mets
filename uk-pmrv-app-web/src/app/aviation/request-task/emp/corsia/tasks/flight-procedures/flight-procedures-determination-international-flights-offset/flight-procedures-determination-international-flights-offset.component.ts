...
export default class FlightProceduresDeterminationInternationalFlightsOffsetComponent {
  protected form = this.formProvider.internationalFlightsDeterminationOffsetCtrl;
  ...
  onSubmit() {
    ...
    this.store.empCorsiaDelegate
      ...
      .subscribe(() => {
        ...
        this.router.navigate(['..', 'determination-international-flights-no-monitoring'], { relativeTo: this.route });
      });
  }
}
