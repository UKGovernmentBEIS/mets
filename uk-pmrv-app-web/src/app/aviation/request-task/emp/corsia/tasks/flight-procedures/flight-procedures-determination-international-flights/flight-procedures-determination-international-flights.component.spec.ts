...
import FlightProceduresDeterminationInternationalFlightsComponent from './flight-procedures-determination-international-flights.component';

describe('FlightProceduresDeterminationInternationalFlightsComponent', () => {
  let fixture: ComponentFixture<FlightProceduresDeterminationInternationalFlightsComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FlightProceduresDeterminationInternationalFlightsComponent, RouterTestingModule],
      providers: [
    ...
    fixture = TestBed.createComponent(FlightProceduresDeterminationInternationalFlightsComponent);
  ...
  it('should submit and navigate to determination-international-flights-offset', () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['..', 'determination-international-flights-offset'], {
