...
import { FuelDensityComponent } from './fuel-density.component';
...
describe('FuelDensityComponent', () => {
  let component: FuelDensityComponent;
  let fixture: ComponentFixture<FuelDensityComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(FuelDensityComponent);
