...
import { FuelUpliftMeasurementComponent } from './fuel-uplift-measurement.component';
...
describe('FuelUpliftMeasurementComponent', () => {
  let component: FuelUpliftMeasurementComponent;
  let fixture: ComponentFixture<FuelUpliftMeasurementComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(FuelUpliftMeasurementComponent);
