...
import { EmpReviewDecisionGroupFormComponent } from './emp-review-decision-group-form.component';
...
class MockParentComponent {
  ...
  constructor(readonly formProvider: EmpReviewDecisionGroupFormProvider) {}
}

describe('EmpReviewDecisionGroupFormComponent', () => {
