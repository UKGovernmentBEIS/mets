...
import { DoeEmissionsReasonsComponent } from './doe-emissions-reasons.component';

describe('DoeEmissionsReasonsComponent', () => {
  let component: DoeEmissionsReasonsComponent;
  let fixture: ComponentFixture<DoeEmissionsReasonsComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(DoeEmissionsReasonsComponent);
  ...
  it('should call the saveDoe function with the correct data when the form is valid', async () => {
    const data = {
      ...
      emissions: {
        calculationApproach: null,
        emissionsAllInternationalFlights: null,
        emissionsClaimFromCorsiaEligibleFuels: null,
