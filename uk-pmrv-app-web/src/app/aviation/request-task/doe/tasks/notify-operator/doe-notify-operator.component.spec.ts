...
import { DoeNotifyOperatorComponent } from './doe-notify-operator.component';

describe('DoeNotifyOperatorComponent', () => {
  let component: DoeNotifyOperatorComponent;
  let fixture: ComponentFixture<DoeNotifyOperatorComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [DoeNotifyOperatorComponent, SharedModule],
      providers: [
    ...
    fixture = TestBed.createComponent(DoeNotifyOperatorComponent);
