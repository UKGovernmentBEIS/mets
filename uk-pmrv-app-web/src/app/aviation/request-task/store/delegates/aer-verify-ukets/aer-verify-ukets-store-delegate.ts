...
import { AerVerifyUkEtsStoreSideEffectsHandler } from './aer-verify-ukets-store-side-effects.handler';

export class AerVerifyUkEtsStoreDelegate implements RequestTaskStoreDelegate {
  ...
  private sideEffectsHandler = new AerVerifyUkEtsStoreSideEffectsHandler(this.store);
