...
import { AviationEmissionsReasonsComponent } from './aviation-emissions-reasons.component';

describe('AviationEmissionsReasonsComponent', () => {
  let component: AviationEmissionsReasonsComponent;
  let fixture: ComponentFixture<AviationEmissionsReasonsComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(AviationEmissionsReasonsComponent);
  ...
  it('should call the saveDre function with the correct data when the form is valid', async () => {
    const data = {
      ...
      calculationApproach: {
        type: null,
        otherDataSourceExplanation: null,
      },
      supportingDocuments: [],
    };
