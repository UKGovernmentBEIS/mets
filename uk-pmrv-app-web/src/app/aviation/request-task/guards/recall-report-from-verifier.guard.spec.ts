...
import { RecallReportFromVerifierGuard } from './recall-report-from-verifier.guard';

describe('canRecallReportFromVerifierGuard', () => {
  let store: RequestTaskStore;
  let guard: RecallReportFromVerifierGuard;
  let router: Router;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [RecallReportFromVerifierGuard],
    });
    ...
    store.setState({
      ...
      requestTaskItem: {
        ...
        allowedRequestTaskActions: ['AVIATION_AER_RECALL_FROM_VERIFICATION'],
      },
    });

    router = TestBed.inject(Router);
    guard = TestBed.inject(RecallReportFromVerifierGuard);
  });
