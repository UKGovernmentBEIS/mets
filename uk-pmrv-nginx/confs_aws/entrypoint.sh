...
sed -i "s/REPLACE_ME_WITH_COOKIES/$COOKIES/g" /etc/nginx/conf.d/ukpmrv.net.conf
sed -i "s/REPLACE_ME_WITH_DASHBOARD/$DASHBOARD/g" /etc/nginx/conf.d/ukpmrv.net.conf
