...
#This script updates the uk-pmrv realm in order to configure the password policy based on length(minimun 12 characters, max 128 and 100000 hashIterations).
