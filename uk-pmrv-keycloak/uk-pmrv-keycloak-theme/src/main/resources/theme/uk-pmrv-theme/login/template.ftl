...
<body class="govuk-template__body ">
      ...
      <header class="govuk-header " role="banner" data-module="govuk-header">
	        ...
	        <a href="${properties.govukUrl}" class="govuk-header__link govuk-header__link--homepage">
	          <span class="govuk-header__logotype">
	            <svg role="presentation" focusable="false" class="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 132 97" height="30" width="36">
	              ...
	              <image src="${url.resourcesPath}/img/govuk-logotype-crown.png" xlink:href="" class="govuk-header__logotype-crown-fallback-image" width="36" height="32"></image>
	            </svg>
        ...
        <div class="govuk-header__content">
          <a href="/" class="govuk-header__link govuk-header__link--service-name">
            Manage your UK Emissions Trading Scheme reporting
          </a>
        </div>
	    </div>
      </header>            
	  ...
	  <div class="govuk-width-container">
		    <main class="govuk-main-wrapper " id="main-content" role="main" style="min-height: calc(100vh - 60px - 310px);">
